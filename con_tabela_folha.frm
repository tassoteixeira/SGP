...
Begin VB.Form consulta_tabela_folha 
   Caption         =   "Consulta Tabela da Folha de Pagamento"
   ClientHeight    =   5355
   ClientLeft      =   1245
   ClientTop       =   2385
   ClientWidth     =   8655
   Icon            =   "con_tabela_folha.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form2"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   PaletteMode     =   1  'UseZOrder
   Picture         =   "con_tabela_folha.frx":0442
   ScaleHeight     =   5355
   ScaleWidth      =   8655
   ...
   Begin VB.CommandButton cmd_ok 
      ...
      Height          =   855
      Left            =   7020
      Picture         =   "con_tabela_folha.frx":0488
      Style           =   1  'Graphical
      TabIndex        =   7
   ...
   Begin VB.CommandButton cmd_sair 
      ...
      Height          =   855
      Left            =   7860
      Picture         =   "con_tabela_folha.frx":1A92
      Style           =   1  'Graphical
      TabIndex        =   8
   ...
   End
End
Attribute VB_Name = "consulta_tabela_folha"
...
Private Sub AtualizaGrid()
    ...
    If ValidaCampos Then
        'Prepara SQL
        lSQl = ""
        lSQl = lSQl & "SELECT [Mes Ano], [Salario Minimo], [Cesta Basica], [Salario Familia 1],"
        lSQl = lSQl & "       [Salario Familia Acima de], [Salario Familia 2], [Valor Inicial 1],"
        lSQl = lSQl & "       [Valor Final 1], [Percentual 1], [Valor Inicial 2], [Valor Final 2],"
        lSQl = lSQl & "       [Percentual 2], [Valor Inicial 3], [Valor Final 3], [Percentual 3],"
        lSQl = lSQl & "       [Valor Inicial 4], [Valor Final 4], [Percentual 4], [Observacao 1],"
        lSQl = lSQl & "       [Observacao 2], [Observacao 3]"
        lSQl = lSQl & "  FROM Tabela_Folha"
        If cbo_campo.ListIndex <> -1 Then
            lSQl = lSQl & " WHERE Tabela_Folha." & cbo_campo.Text & " " & xOperando & " " & xCondicao
        End If
...
Private Sub FormaGrid()
    ...
    MSFlexGrid.Rows = 1
    i = 0
    MSFlexGrid.TextMatrix(0, i) = "Ano-Mês"
    MSFlexGrid.ColAlignment(i) = flexAlignGeneral
    MSFlexGrid.ColWidth(i) = 800
    i = i + 1
    MSFlexGrid.TextMatrix(0, i) = "Salário Mínimo"
    MSFlexGrid.ColAlignment(i) = flexAlignGeneral
    MSFlexGrid.ColWidth(i) = 900
    i = i + 1
    MSFlexGrid.TextMatrix(0, i) = "Cesta Básica"
    MSFlexGrid.ColAlignment(i) = flexAlignGeneral
    MSFlexGrid.ColWidth(i) = 900
    i = i + 1
    MSFlexGrid.TextMatrix(0, i) = "Salário Família 1"
    MSFlexGrid.ColAlignment(i) = flexAlignGeneral
    MSFlexGrid.ColWidth(i) = 900
    i = i + 1
    MSFlexGrid.TextMatrix(0, i) = "Acima de"
    MSFlexGrid.ColAlignment(i) = flexAlignGeneral
    MSFlexGrid.ColWidth(i) = 900
    i = i + 1
    MSFlexGrid.TextMatrix(0, i) = "Salário Família 2"
    MSFlexGrid.ColAlignment(i) = flexAlignGeneral
    MSFlexGrid.ColWidth(i) = 900
    i = i + 1
    MSFlexGrid.TextMatrix(0, i) = "Valor Inicial 1"
    MSFlexGrid.ColAlignment(i) = flexAlignGeneral
    MSFlexGrid.ColWidth(i) = 900
    i = i + 1
    MSFlexGrid.TextMatrix(0, i) = "Valor Final 1"
    MSFlexGrid.ColAlignment(i) = flexAlignGeneral
    MSFlexGrid.ColWidth(i) = 900
    i = i + 1
    MSFlexGrid.TextMatrix(0, i) = "Percentual 1"
    MSFlexGrid.ColAlignment(i) = flexAlignGeneral
    MSFlexGrid.ColWidth(i) = 900
    i = i + 1
    MSFlexGrid.TextMatrix(0, i) = "Valor Inicial 2"
    MSFlexGrid.ColAlignment(i) = flexAlignGeneral
    MSFlexGrid.ColWidth(i) = 900
    i = i + 1
    MSFlexGrid.TextMatrix(0, i) = "Valor Final 2"
    MSFlexGrid.ColAlignment(i) = flexAlignGeneral
    MSFlexGrid.ColWidth(i) = 900
    i = i + 1
    MSFlexGrid.TextMatrix(0, i) = "Percentual 2"
    MSFlexGrid.ColAlignment(i) = flexAlignGeneral
    MSFlexGrid.ColWidth(i) = 900
    i = i + 1
    MSFlexGrid.TextMatrix(0, i) = "Valor Inicial 3"
    MSFlexGrid.ColAlignment(i) = flexAlignGeneral
    MSFlexGrid.ColWidth(i) = 900
    i = i + 1
    MSFlexGrid.TextMatrix(0, i) = "Valor Final 3"
    MSFlexGrid.ColAlignment(i) = flexAlignGeneral
    MSFlexGrid.ColWidth(i) = 900
    i = i + 1
    MSFlexGrid.TextMatrix(0, i) = "Percentual 3"
    MSFlexGrid.ColAlignment(i) = flexAlignGeneral
    MSFlexGrid.ColWidth(i) = 900
    i = i + 1
    MSFlexGrid.TextMatrix(0, i) = "Valor Inicial 4"
    MSFlexGrid.ColAlignment(i) = flexAlignGeneral
    MSFlexGrid.ColWidth(i) = 900
    i = i + 1
    MSFlexGrid.TextMatrix(0, i) = "Valor Final 4"
    MSFlexGrid.ColAlignment(i) = flexAlignGeneral
    MSFlexGrid.ColWidth(i) = 900
    i = i + 1
    MSFlexGrid.TextMatrix(0, i) = "Percentual 4"
    MSFlexGrid.ColAlignment(i) = flexAlignGeneral
    MSFlexGrid.ColWidth(i) = 900
    i = i + 1
    MSFlexGrid.TextMatrix(0, i) = "Observação 1"
    MSFlexGrid.ColAlignment(i) = flexAlignGeneral
    MSFlexGrid.ColWidth(i) = 3000
    i = i + 1
    MSFlexGrid.TextMatrix(0, i) = "Observação 2"
    MSFlexGrid.ColAlignment(i) = flexAlignGeneral
    MSFlexGrid.ColWidth(i) = 3000
    i = i + 1
    MSFlexGrid.TextMatrix(0, i) = "Observação 3"
    MSFlexGrid.ColAlignment(i) = flexAlignGeneral
    MSFlexGrid.ColWidth(i) = 3000
End Sub
        ...
        Do Until lRst.EOF
            ...
            For Each fld In lRst.Fields
                ...
                If fld.Name = "CODIGO" Then
                    MSFlexGrid.Text = fMascaraContaContabil(fld.Value)
                Else
...
Private Sub Inicializa()
    ...
    x_campo = "Mes Ano"
    x_operador = "Maior Igual"
    txt_condicao = Format(g_data_def, "yyyymm")
...
Private Sub Form_Load()
    ...
    CentraForm Me
    lSQl = "SELECT * FROM Tabela_Folha WHERE [Salario Minimo] = 0"
    Set lRst = New adodb.Recordset
    Set lRst = Conectar.RsConexao(lSQl)
    PreencheCampos
    lRst.Close
...
Private Sub txt_condicao_GotFocus()
    txt_condicao.SelStart = 4
    txt_condicao.SelLength = 2
End Sub
