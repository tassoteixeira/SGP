...
Begin VB.Form lst_contas_a_pagar_fornecedor 
   Caption         =   "Relação de Contas à Pagar por Fornecedor"
   ClientHeight    =   3135
   ClientLeft      =   1950
   ClientTop       =   1890
   ClientWidth     =   6795
   ...
   Begin VB.CommandButton cmd_visualizar 
      ...
      Style           =   1  'Graphical
      TabIndex        =   12
      ToolTipText     =   "Visualiza contas à pagar por fornecedor."
      Top             =   2160
      Width           =   795
   End
   Begin VB.CommandButton cmd_imprimir 
      ...
      Style           =   1  'Graphical
      TabIndex        =   13
      ToolTipText     =   "Imprime contas à pagar por fornecedor."
      Top             =   2160
      Width           =   795
   End
...
Function ValidaCampos() As Integer
    ...
    ElseIf CDate(msk_data_f) < CDate(msk_data_i) Then
        MsgBox "Data final deve ser maior ou igual a " & msk_data_i & ".", 64, "Atenção!"
        msk_data_f.SetFocus
    ElseIf cbo_fornecedor.ListIndex = -1 Then
        MsgBox "Selecione um fornecedor.", 64, "Atenção!"
        cbo_fornecedor.SetFocus
    Else
        ValidaCampos = True
    End If
