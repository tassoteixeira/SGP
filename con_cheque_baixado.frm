...
Begin VB.Form consulta_cheque_baixado 
   Caption         =   "Consulta de Cheques Baixados"
   ClientHeight    =   5355
   ClientLeft      =   1245
   ClientTop       =   2385
   ClientWidth     =   8655
   Icon            =   "con_cheque_baixado.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form2"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   PaletteMode     =   1  'UseZOrder
   Picture         =   "con_cheque_baixado.frx":0442
   ScaleHeight     =   5355
   ScaleWidth      =   8655
   ...
   Begin VB.CommandButton cmd_ok 
      ...
      Height          =   855
      Left            =   7020
      Picture         =   "con_cheque_baixado.frx":0488
      Style           =   1  'Graphical
      TabIndex        =   7
   ...
   Begin VB.CommandButton cmd_sair 
      ...
      Height          =   855
      Left            =   7860
      Picture         =   "con_cheque_baixado.frx":1A92
      Style           =   1  'Graphical
      TabIndex        =   8
   ...
   End
End
Attribute VB_Name = "consulta_cheque_baixado"
...
Private Sub AtualizaGrid()
    ...
    If ValidaCampos Then
        lSQl = ""
        lSQl = lSQl & "SELECT Baixa_Cheque.[Data de Emissao], Baixa_Cheque.[Numero da Conta], Baixa_Cheque.[Numero do Cheque], Baixa_Cheque.Periodo, Baixa_Cheque.[Tipo do Movimento], Baixa_Cheque.Agencia, Baixa_Cheque.Valor, Baixa_Cheque.[Data do Vencimento], Baixa_Cheque.Emitente, Baixa_Cheque.[Ordem da Digitacao], Baixa_Cheque.[Codigo de Barra 1], Baixa_Cheque.[Codigo de Barra 2], Baixa_Cheque.[Codigo de Barra 3], Baixa_Cheque.[Banco Agencia]"
...
Private Sub FormataGrid()
    ...
    i = i + 1
    MSFlexGrid1.TextMatrix(0, i) = "Agência"
    MSFlexGrid1.ColAlignment(i) = flexAlignCenterCenter
    MSFlexGrid1.ColWidth(i) = 800
    i = i + 1
    ...
    i = i + 1
    MSFlexGrid1.TextMatrix(0, i) = "Banco Agência"
    MSFlexGrid1.ColAlignment(i) = flexAlignLeftCenter
    MSFlexGrid1.ColWidth(i) = 800
End Sub
