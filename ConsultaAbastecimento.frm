...
Begin VB.Form ConsultaAbastecimento 
   Caption         =   "Consulta de Abastecimentos do dia"
   ClientHeight    =   5355
   ClientLeft      =   1245
   ClientTop       =   2385
   ClientWidth     =   8655
   Icon            =   "ConsultaAbastecimento.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form2"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   PaletteMode     =   1  'UseZOrder
   Picture         =   "ConsultaAbastecimento.frx":0442
   ScaleHeight     =   5355
   ScaleWidth      =   8655
   ...
   Begin VB.CommandButton cmd_ok 
      ...
      Height          =   855
      Left            =   7020
      Picture         =   "ConsultaAbastecimento.frx":0488
      Style           =   1  'Graphical
      TabIndex        =   7
   ...
   Begin VB.CommandButton cmd_sair 
      ...
      Height          =   855
      Left            =   7860
      Picture         =   "ConsultaAbastecimento.frx":1A92
      Style           =   1  'Graphical
      TabIndex        =   8
   ...
   End
End
Attribute VB_Name = "ConsultaAbastecimento"
...
Private Sub AtualizaGrid()
    ...
    If ValidaCampos Then
        lSQL = ""
        lSQL = lSQL & "SELECT  Bico , Data , Hora , [Valor Total], [Tipo de Combustivel], Empresa ,[Tempo de Abastecimento] , [Codigo do Produto] , [Valor Unitario] , Quantidade  , Acerto , [Numero do Cupom] , [Codigo da ECF] , [Numero do Abastecimento] , Encerrante , [String da Automacao] , [Documento Gerado] , [Complemento Documento Gerado] , [Valor do Desconto] , [Encerrante Inicial]  , [Codigo do Funcionario] , Periodo "
        lSQL = lSQL & "  FROM Movimento_Abastecimento"
        lSQL = lSQL & " WHERE 1=1 "
        If cbo_campo.ListIndex <> -1 Then
            lSQL = lSQL & "   AND Movimento_Abastecimento.Empresa = " & g_empresa
            lSQL = lSQL & "   AND Movimento_Abastecimento." & fConsultaPreparaCondicao(cbo_campo.Text, rsDados.Fields(cbo_campo.Text).Type, cbo_operador.Text, txt_condicao.Text)
        End If
        
        
        If lCodigoFuncionario > 0 Then
            lSQL = lSQL & " AND Movimento_Abastecimento.[Codigo do Funcionario] = " & lCodigoFuncionario 'SOMENTE ABASTECIMENTOS DO FUNCINÁRIO EM QUESTÃO
        End If
        
        lSQL = lSQL & " AND Movimento_Abastecimento.Data = " & preparaData(Now) 'SOMENTE DATA ATUAL
        lSQL = lSQL & " ORDER BY Data desc, Hora desc, [Tipo de Combustivel] asc, Bico asc"
...
Private Sub FormataGrid()
    ...
    MSFlexGrid1.Rows = 1
    i = 0
    MSFlexGrid1.TextMatrix(0, i) = "Bico"
    ...
    MSFlexGrid1.ColWidth(i) = 1000
    i = i + 1
    MSFlexGrid1.TextMatrix(0, i) = "Hora"
    ...
    MSFlexGrid1.ColWidth(i) = 1000
    i = i + 1
    MSFlexGrid1.TextMatrix(0, i) = "Tipo de Combustível"
    MSFlexGrid1.ColAlignment(i) = flexAlignRightCenter
    MSFlexGrid1.ColWidth(i) = 1000
    i = i + 1
    ...
    i = i + 1
    MSFlexGrid1.TextMatrix(0, i) = "Tempo de Abastecimento"
    MSFlexGrid1.ColAlignment(i) = flexAlignCenterCenter
    ...
    i = i + 1
    MSFlexGrid1.TextMatrix(0, i) = "Vlr. Unit"
    MSFlexGrid1.ColAlignment(i) = flexAlignRightCenter
    MSFlexGrid1.ColWidth(i) = 800
    i = i + 1
    MSFlexGrid1.TextMatrix(0, i) = "Quant."
    MSFlexGrid1.ColAlignment(i) = flexAlignRightCenter
    MSFlexGrid1.ColWidth(i) = 800
    i = i + 1
    MSFlexGrid1.TextMatrix(0, i) = "Acerto"
    MSFlexGrid1.ColAlignment(i) = flexAlignRightCenter
    MSFlexGrid1.ColWidth(i) = 1000
    i = i + 1
    MSFlexGrid1.TextMatrix(0, i) = "Nº NFCe"
    MSFlexGrid1.ColAlignment(i) = flexAlignRightCenter
    MSFlexGrid1.ColWidth(i) = 1200
    i = i + 1
    MSFlexGrid1.TextMatrix(0, i) = "Codigo da ECF"
    MSFlexGrid1.ColAlignment(i) = flexAlignRightCenter
    MSFlexGrid1.ColWidth(i) = 1200
    i = i + 1
    MSFlexGrid1.TextMatrix(0, i) = "Nº Abast."
    MSFlexGrid1.ColAlignment(i) = flexAlignRightCenter
    MSFlexGrid1.ColWidth(i) = 1200
    i = i + 1
    MSFlexGrid1.TextMatrix(0, i) = "Encer."
    MSFlexGrid1.ColAlignment(i) = flexAlignRightCenter
    MSFlexGrid1.ColWidth(i) = 1200
    i = i + 1
    MSFlexGrid1.TextMatrix(0, i) = "Str. Automacao"
    MSFlexGrid1.ColAlignment(i) = flexAlignRightCenter
    MSFlexGrid1.ColWidth(i) = 1200
    i = i + 1
    MSFlexGrid1.TextMatrix(0, i) = "Doc. Gerado"
    MSFlexGrid1.ColAlignment(i) = flexAlignRightCenter
    MSFlexGrid1.ColWidth(i) = 1200
    i = i + 1
    MSFlexGrid1.TextMatrix(0, i) = "Complemento"
    MSFlexGrid1.ColAlignment(i) = flexAlignRightCenter
    MSFlexGrid1.ColWidth(i) = 1200
    i = i + 1
    MSFlexGrid1.TextMatrix(0, i) = "Vlr Desc."
    MSFlexGrid1.ColAlignment(i) = flexAlignRightCenter
    MSFlexGrid1.ColWidth(i) = 1200
    i = i + 1
    MSFlexGrid1.TextMatrix(0, i) = "Encer. Inicial"
    MSFlexGrid1.ColAlignment(i) = flexAlignRightCenter
    MSFlexGrid1.ColWidth(i) = 1200
    i = i + 1
    MSFlexGrid1.TextMatrix(0, i) = "Funcionario"
    MSFlexGrid1.ColAlignment(i) = flexAlignRightCenter
    MSFlexGrid1.ColWidth(i) = 1200
    i = i + 1
...
' lBomba = RetiraGString(1)
'            lDataAbastecimento = RetiraGString(2)
'            lHoraAbastecimento = RetiraGString(3)
'            lValorAbastecimento = RetiraGString(4)
'            lTipoCombustivel = RetiraGString(5)

Private Sub MarcaCelulas()
    g_string = ""
    If MSFlexGrid1.TextMatrix(MSFlexGrid1.RowSel, 0) <> "" Then
        g_string = MSFlexGrid1.TextMatrix(MSFlexGrid1.RowSel, 0) & "|@|" 'Bico
        g_string = g_string & MSFlexGrid1.TextMatrix(MSFlexGrid1.RowSel, 1) & "|@|" 'Data
        g_string = g_string & MSFlexGrid1.TextMatrix(MSFlexGrid1.RowSel, 2) & "|@|" 'Hora
        g_string = g_string & MSFlexGrid1.TextMatrix(MSFlexGrid1.RowSel, 3) & "|@|" 'Valor
        g_string = g_string & MSFlexGrid1.TextMatrix(MSFlexGrid1.RowSel, 4) & "|@|" 'Tipo de Combustivel
        g_string = g_string & MSFlexGrid1.TextMatrix(MSFlexGrid1.RowSel, 8) & "|@|" 'Valor Unitário
        g_string = g_string & MSFlexGrid1.TextMatrix(MSFlexGrid1.RowSel, 9) & "|@|" 'Quantidade
        g_string = g_string & MSFlexGrid1.TextMatrix(MSFlexGrid1.RowSel, 21) & "|@|" 'Periodo
    End If
End Sub
                ...
                'Else
                    ...
                    Else
                        ...
                        ElseIf MSFlexGrid1.Col = 2 Then
                             MSFlexGrid1.Text = Format(fld.Value, "HH:mm:ss")
                        Else
...
Private Sub PreencheCampos()
    lSQL = "SELECT * FROM Movimento_Abastecimento WHERE Empresa = 0"
    Set rsDados = Conectar.RsConexao(lSQL)
    cbo_campo.Clear
    For Each fld In rsDados.Fields
        If Not fld.name Like "*Data*" Then
