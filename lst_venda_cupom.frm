...
Begin VB.Form lst_venda_cupom 
   Caption         =   "Emissão das Vendas de Cupom Fiscal"
   ClientHeight    =   7515
   ClientLeft      =   3990
   ClientTop       =   2010
   ClientWidth     =   6900
   Icon            =   "lst_venda_cupom.frx":0000
   LinkTopic       =   "Form2"
   LockControls    =   -1  'True
   PaletteMode     =   1  'UseZOrder
   Picture         =   "lst_venda_cupom.frx":030A
   ScaleHeight     =   7515
   ScaleWidth      =   6900
   ...
   Begin VB.CommandButton cmd_visualizar 
      ...
      Height          =   975
      Left            =   1140
      Picture         =   "lst_venda_cupom.frx":0350
      Style           =   1  'Graphical
      TabIndex        =   21
   ...
   Begin VB.CommandButton cmd_imprimir 
      ...
      Height          =   975
      Left            =   3000
      Picture         =   "lst_venda_cupom.frx":1A6A
      Style           =   1  'Graphical
      TabIndex        =   22
   ...
   Begin VB.CommandButton cmd_sair 
      ...
      Height          =   975
      Left            =   4860
      Picture         =   "lst_venda_cupom.frx":3074
      Style           =   1  'Graphical
      TabIndex        =   23
   ...
   Begin VB.Frame frm_dados 
      ...
      Top             =   120
      Width           =   6555
      Begin VB.CheckBox chkSomenteCancelado 
         Caption         =   "Buscar somente &Cancelados"
         Height          =   375
         Left            =   1680
         TabIndex        =   34
         Top             =   4680
         Width           =   3735
      End
      Begin VB.CheckBox chkDetalhadaData 
         Caption         =   "Imprime detalhada por &Data"
         Height          =   315
         Left            =   1680
         TabIndex        =   33
         Top             =   5160
         Width           =   3015
      End
      Begin VB.ComboBox cboTributacao 
         Height          =   315
         Left            =   1680
         Style           =   2  'Dropdown List
         TabIndex        =   31
      ...
      Begin VB.CheckBox chkImprimeDetalhe 
         Caption         =   "I&mprime detalhada por cupom"
         Height          =   315
         Left            =   1680
         TabIndex        =   20
         Top             =   5580
      ...
      Begin VB.CommandButton cmd_data_i 
         Height          =   315
         Left            =   2760
         Picture         =   "lst_venda_cupom.frx":4706
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      Begin VB.CommandButton cmd_data_f 
         Height          =   315
         Left            =   5940
         Picture         =   "lst_venda_cupom.frx":59E0
         Style           =   1  'Graphical
         TabIndex        =   9
         ToolTipText     =   "Selecione a data pelo calendário."
         Top             =   660
      ...
      Begin VB.CommandButton cmd_data 
         Height          =   315
         Left            =   2760
         Picture         =   "lst_venda_cupom.frx":6CBA
         Style           =   1  'Graphical
         TabIndex        =   3
         ToolTipText     =   "Selecione a data pelo calendário."
         Top             =   240
   ...
   End
End
Attribute VB_Name = "lst_venda_cupom"
...
'    If chkDetalhadaData.Value = 1 Then
'        lSQL = lSQL & " And MovimentoNFeCupom.[Numero do cupom]  = Movimento_Cupom_Fiscal.[Numero do cupom]"
'    End If
...
'    'Seleciona Produtos Vendidos dentro das condições
'    lSQL = ""
'    lSQL = lSQL & " SELECT Grupo.Nome AS NomeGrupo, Produto.Nome, Produto.Codigo, Produto.[Codigo do Grupo], Produto.Unidade"
...
'    lSQL = lSQL & "    AND Periodo >= " & preparaTexto(cbo_periodo_i.Text)
'    lSQL = lSQL & "    AND Periodo <= " & preparaTexto(cbo_periodo_f.Text)
''    lSQL = lSQL & "    AND ([Cupom Cancelado] = " & preparaBooleano(True)
''    lSQL = lSQL & "    OR [Item Cancelado] = " & preparaBooleano(True) & ")"
'    lSQL = lSQL & "    AND [Cupom Cancelado] = " & preparaBooleano(False)
'    lSQL = lSQL & "    AND [Item Cancelado] = " & preparaBooleano(False)
'    If cboFuncionario.ListIndex > 0 Then
'        lSQL = lSQL & "    AND Operador = " & Val(cboFuncionario.ItemData(cboFuncionario.ListIndex))
...
'        lSQL = lSQL & "    AND Produto.[Exclusivo Loja] = " & preparaBooleano(True)
'    End If
'    lSQL = lSQL & "  ORDER BY Grupo.Nome, Produto.Nome"
...
Private Sub ImpCab()
    ...
    If lImprimirECF = False Then
        ...
        BioImprime "@Printer.Print " & x_linha
        x_linha = "| FUNCIONARIO.............:                                                    |"
        Mid(x_linha, 29, 30) = cboFuncionario.Text
        BioImprime "@Printer.Print " & x_linha
