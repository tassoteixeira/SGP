...
Begin VB.Form MovEncerranteAtual 
   Caption         =   "Movimento do Encerrante Atual"
   ClientHeight    =   4080
   ClientLeft      =   2040
   ClientTop       =   1875
   ClientWidth     =   11505
   Icon            =   "MovEncerranteAtual.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form2"
   PaletteMode     =   1  'UseZOrder
   Picture         =   "MovEncerranteAtual.frx":030A
   ScaleHeight     =   4080
   ScaleWidth      =   11505
   Begin VB.CommandButton cmd_pesquisa 
      ...
      Height          =   855
      Left            =   2760
      Picture         =   "MovEncerranteAtual.frx":0750
      Style           =   1  'Graphical
      TabIndex        =   8
   ...
   Begin VB.CommandButton cmd_novo 
      ...
      Height          =   855
      Left            =   60
      Picture         =   "MovEncerranteAtual.frx":1BC2
      Style           =   1  'Graphical
      TabIndex        =   5
   ...
   Begin VB.CommandButton cmd_alterar 
      ...
      Height          =   855
      Left            =   960
      Picture         =   "MovEncerranteAtual.frx":3254
      Style           =   1  'Graphical
      TabIndex        =   6
   ...
   Begin VB.CommandButton cmd_excluir 
      ...
      Height          =   855
      Left            =   1860
      Picture         =   "MovEncerranteAtual.frx":474E
      Style           =   1  'Graphical
      TabIndex        =   7
   ...
   Begin VB.CommandButton cmd_sair 
      ...
      Height          =   855
      Left            =   3660
      Picture         =   "MovEncerranteAtual.frx":5DE0
      Style           =   1  'Graphical
      TabIndex        =   9
   ...
   Begin VB.Frame frm_dados 
      ...
      Begin VB.CommandButton cmd_transfere_dados_lmc 
         ...
         Height          =   735
         Left            =   9900
         Picture         =   "MovEncerranteAtual.frx":7472
         Style           =   1  'Graphical
         TabIndex        =   15
   ...
   Begin VB.Frame frm_move 
      ...
      Begin VB.CommandButton cmd_primeiro 
         Height          =   615
         Left            =   120
         Picture         =   "MovEncerranteAtual.frx":8864
         Style           =   1  'Graphical
         TabIndex        =   11
      ...
      Begin VB.CommandButton cmd_ultimo 
         Height          =   615
         Left            =   1680
         Picture         =   "MovEncerranteAtual.frx":9D5E
         Style           =   1  'Graphical
         TabIndex        =   14
      ...
      Begin VB.CommandButton cmd_anterior 
         Height          =   615
         Left            =   600
         Picture         =   "MovEncerranteAtual.frx":B258
         Style           =   1  'Graphical
         TabIndex        =   12
      ...
      Begin VB.CommandButton cmd_proximo 
         Height          =   615
         Left            =   1200
         Picture         =   "MovEncerranteAtual.frx":C6CA
         Style           =   1  'Graphical
         TabIndex        =   13
   ...
   Begin VB.CommandButton cmd_ok 
      ...
      Height          =   855
      Left            =   9840
      Picture         =   "MovEncerranteAtual.frx":DC4C
      Style           =   1  'Graphical
      TabIndex        =   3
   ...
   Begin VB.CommandButton cmd_cancelar 
      ...
      Height          =   855
      Left            =   10680
      Picture         =   "MovEncerranteAtual.frx":EF26
      Style           =   1  'Graphical
      TabIndex        =   4
   ...
   End
End
Attribute VB_Name = "MovEncerranteAtual"
...
Private MovimentoEncerranteAtual As New cMovimentoEncerranteAtual
...
Private Sub AtualizaGrid()
    ...
    xSQL = ""
    'xSQL = xSQL & "   SELECT Nome, [Numero do Tanque], [Tipo de Combustivel], Quantidade, [Observacao 1], [Observacao 2], [Observacao 3], [Desconto Dia Anterior]"
    ...
    xSQL = xSQL & "   SELECT Encerrante, " 'new
    xSQL = xSQL & "     FROM MovimentoEncerranteAtual" 'new
    xSQL = xSQL & "    WHERE Empresa = " & g_empresa 'new
    xSQL = xSQL & "      AND Data = " & preparaData(CDate(txtData.Text)) 'new
    xSQL = xSQL & " ORDER BY Data, Periodo" 'new
    ...
    If rsAuxiliar.RecordCount > 0 Then
        If Not rsAuxiliar.EOF Then
            Do Until rsAuxiliar.EOF
                ...
                fgd_dados.Row = i
                fgd_dados.Col = 0
                'fgd_dados.Text = rsAuxiliar("Numero do Tanque").Value 'old
                'fgd_dados.Col = 1 'old
                'fgd_dados.Text = rsAuxiliar("Nome").Value 'old
                'fgd_dados.Col = 2 'old
                'fgd_dados.Text = Format(rsAuxiliar("Quantidade").Value, "###,##0.00") 'old
                'fgd_dados.Col = 3 'old
                'fgd_dados.Text = Format(rsAuxiliar("Desconto Dia Anterior").Value, "###,##0.00") 'old
                'fgd_dados.Col = 4 'old
                'fgd_dados.Text = rsAuxiliar("Observacao 1").Value 'old
                'fgd_dados.Col = 5 'old
                'fgd_dados.Text = rsAuxiliar("Observacao 2").Value 'old
                'fgd_dados.Col = 6 'old
                'fgd_dados.Text = rsAuxiliar("Observacao 3").Value 'old
                'lTipoCombustivel = rsAuxiliar("Tipo de Combustivel").Value 'old
                'lNumeroTanque = rsAuxiliar("Numero do Tanque").Value 'old
                fgd_dados.Text = rsAuxiliar("Encerrante").Value 'new
                lData = rsAuxiliar("Data").Value 'new
                lPeriodo = rsAuxiliar("Periodo").Value 'new
                rsAuxiliar.MoveNext
            Loop
        End If
        fgd_dados.Row = 1
...
Private Sub AtualTabe()
    ...
    For i = 1 To (fgd_dados.Rows - 1)
        If fgd_dados.TextMatrix(i, 0) <> "" Then
            'If Combustivel.LocalizarNome(g_empresa, fgd_dados.TextMatrix(i, 1)) Then 'old
                'MedicaoCombustivel.Empresa = g_empresa 'old
                'MedicaoCombustivel.Data = Format(txtData.Text, "dd/mm/yyyy")  'old
                'MedicaoCombustivel.NumeroTanque = Val(fgd_dados.TextMatrix(i, 0)) 'old
                'MedicaoCombustivel.TipoCombustivel = Combustivel.Codigo 'old
                'MedicaoCombustivel.Quantidade = CCur(fgd_dados.TextMatrix(i, 2)) 'old
                'MedicaoCombustivel.Observacao1 = fgd_dados.TextMatrix(i, 4) 'old
                'MedicaoCombustivel.Observacao2 = fgd_dados.TextMatrix(i, 5) 'old
                'MedicaoCombustivel.Observacao3 = fgd_dados.TextMatrix(i, 6) 'old
                'MedicaoCombustivel.DescontoDiaAnterior = CCur(fgd_dados.TextMatrix(i, 3)) 'old
                'MedicaoCombustivel.MedidaRegua = 0  'old
                MovimentoEncerranteAtual.Empresa = g_empresa 'new
                MovimentoEncerranteAtual.Data = Format(txtData.Text, "dd/mm/yyyy") 'new
                MovimentoEncerranteAtual.Periodo = cbo_periodo.Text 'new
                MovimentoEncerranteAtual.Encerrante = Val(fgd_dados.TextMatrix(i, 0)) 'new
                xString = ""
                If lOpcao = 2 Then
                    xString = "Para: "
                End If
                ...
                End If
            'Else  'old
             '   MsgBox "Combustível não Cadastrado", vbInformation, "Erro de Integridade" 'old
            'End If  'old
        End If
    Next
End Sub
Private Sub AtualTela()
    'lData = MedicaoCombustivel.Data 'old
    'txtData.Text = Format(MedicaoCombustivel.Data, "dd/mm/yyyy") 'old
    lData = MovimentoEncerranteAtual.Data 'new
    txtData.Text = Format(MovimentoEncerranteAtual.Data, "dd/mm/yyyy") 'new
...
Private Sub LimpaGrid()
    ...
    i = 0
    'fgd_dados.Col = i 'old
    'fgd_dados.Text = "Tanque" 'old
    'fgd_dados.ColWidth(i) = 500 'old
    'fgd_dados.ColAlignment(i) = 7 'old
    'i = i + 1 'old
    fgd_dados.Col = i 'new
    fgd_dados.Text = "Encerrante" 'new
    fgd_dados.ColWidth(i) = 500 'new
    fgd_dados.ColAlignment(i) = 7 'new
    i = i + 1 'new
    'fgd_dados.Col = i 'old
    'fgd_dados.Text = "Combustível" 'old
    'fgd_dados.ColWidth(i) = 1500 'old
    'fgd_dados.ColAlignment(i) = 1 'old
    'i = i + 1 'old
    'fgd_dados.Col = i 'old
    'fgd_dados.Text = "Quantidade em Litros  " 'old
    'fgd_dados.ColWidth(i) = 900 'old
    'fgd_dados.ColAlignment(i) = 7 'old
    'i = i + 1 'old
    'fgd_dados.Col = i 'old
    'fgd_dados.Text = "Desconto do Dia Anterior" 'old
    'fgd_dados.ColWidth(i) = 1000 'old
    'fgd_dados.ColAlignment(i) = 7 'old
    'i = i + 1 'old
    'fgd_dados.Col = i 'old
    'fgd_dados.Text = "Observação Linha 1" 'old
    'fgd_dados.ColWidth(i) = 2900 'old
    'fgd_dados.ColAlignment(i) = 1 'old
    'i = i + 1 'old
    'fgd_dados.Col = i 'old
    'fgd_dados.Text = "Observação Linha 2" 'old
    'fgd_dados.ColWidth(i) = 2900 'old
    'fgd_dados.ColAlignment(i) = 1 'old
    'i = i + 1 'old
    'fgd_dados.Col = i 'old
    'fgd_dados.Text = "Observação Linha 3" 'old
    'fgd_dados.ColWidth(i) = 2900 'old
    'fgd_dados.ColAlignment(i) = 1 'old
End Sub
...
Private Sub ProximaCelula()
    If fgd_dados.Col < fgd_dados.Cols - 1 And fgd_dados.Col <> 3 Then
...
Private Sub cmd_primeiro_Click()
    ...
    'If MedicaoCombustivel.LocalizarPrimeiro Then 'old
    If MovimentoEncerranteAtual.LocalizarPrimeiro Then
        AtualTela
        AtualizaGrid
        cmd_proximo.SetFocus
    Else
...
Private Sub txt_celula_LostFocus()
    ...
    If LastCol = 2 Then
        If fValidaValor(txt_celula.Text) > 0 Then
            If fVerificaSomaSubtracao(txt_celula.Text) Then
                txt_celula.Text = fCalculaValores(txt_celula.Text)
            End If
    ...
    'End If
End Sub
Private Sub zzAdicionaDiaMedicao()
    Dim i As Integer
    Dim xData As Date
    
    Exit Sub
    xData = CDate("01/02/2010")
    For i = 1 To 100
        xData = xData + 1
        If MedicaoCombustivel.LocalizarCodigo(2, xData, 1) Then
            MedicaoCombustivel.Empresa = 1
            MedicaoCombustivel.Data = MedicaoCombustivel.Data + 1
            If Not MedicaoCombustivel.Alterar(2, xData, 1) Then
...
Private Sub zzClonaMedicao()
    ...
    Exit Sub
    For xTanque = 1 To 5
        If MedicaoCombustivel.LocalizarCodigo(g_empresa, CDate("01/07/2005"), xTanque) Then
            For xData = CDate("01/06/2006") To CDate("31/12/2007")
