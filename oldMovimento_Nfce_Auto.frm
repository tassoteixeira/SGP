...
Begin VB.Form Movimento_Nfce_Auto 
   ...
   Begin VB.Frame frmDados 
      ...
      Begin MSDataListLib.DataCombo dtcboCliente 
         Bindings        =   "Movimento_Nfce_Auto.frx":4CCA8
         Height          =   315
         Left            =   1020
         TabIndex        =   4
         Top             =   360
      ...
      Begin MSDataListLib.DataCombo dtcboProduto 
         Bindings        =   "Movimento_Nfce_Auto.frx":4CCC3
         Height          =   315
         Left            =   960
         TabIndex        =   75
         Top             =   6420
      ...
      End
   End
   Begin VB.CommandButton btnNFCe 
      Caption         =   "Gera NFCe (TESTE)"
      Height          =   495
      Left            =   7680
      TabIndex        =   152
      Top             =   7080
   ...
   Begin VB.Frame frm_ponto 
      ...
      Begin MSDataListLib.DataCombo dtcboFuncionario 
         Bindings        =   "Movimento_Nfce_Auto.frx":4CCDE
         Height          =   315
         Left            =   120
         TabIndex        =   90
         Top             =   3060
...
Private Function CasaDecimalZerada(ByVal pValor As String)
    ...
    End If
End Function
Private Function ChamaCartaoDesconto(ByVal pTipoDesconto As String, ByVal pNumeroAutorizacaoPostoAki As String) As Currency
    Dim xString As String
    ...
    'Tasso 16/11/2016
    lValorDescontoConcedido = CerradoTef.SolicitacaoDesconto("NFCe", gNumeroControleSolicitacao, lNumeroCupom, txt_valor_recebido.Text, gQtdViasTEF, xDadosProdutos, lLinhasEntreCV, xTextoParaComprovante, pTipoDesconto, pNumeroAutorizacaoPostoAki)
    lDescontoPostoAki = False
    If pTipoDesconto = "POSTOAKI" And lValorDescontoConcedido > 0 Then
...
Private Sub TestaEncerramentoCupomFiscal()
    ...
    If lExisteImpressora Then
        If lImpBematech Then
            ...
            BemaRetorno = 1 'Bematech_FI_FlagsFiscais(i) 'NFCE - ALEX
            ...
            If i >= 33 And i < 128 Then
                ...
                BemaRetorno = 1 'Bematech_FI_IniciaFechamentoCupom("D", "$", "00000000000000") ' NFCE - ALEX
                Call CriaLogCupom("Bematech_FI_IniciaFechamentoCupom - BemaRetorno=" & BemaRetorno)
                ...
                If ST2 = 0 Then
                    ...
                    BemaRetorno = 1 'Bematech_FI_SubTotal(xValor) 'NFCE - ALEX
                    ...
                    BemaRetorno = 1 'Bematech_FI_EfetuaFormaPagamento("Dinheiro        ", xValor) 'NFCE - ALEX
                    ...
                    BemaRetorno = 1 'Bematech_FI_TerminaFechamentoCupom("Cerrado Informatica - (062) 8436-4444           Sistemas para Automacao Comercial               ") 'NFCE-ALEX
            ...
            BemaRetorno = 1 'Bematech_FI_NumeroCupom(xString) 'NFCE - ALEX
...
'
        ...
        If lImpBematech Then
            ...
            BemaRetorno = 1 'ALEX - NFCE 'Bematech_FI_VendeItemDepartamento(CodigoProduto, NomeProduto, xAliquota, Valor, Quantidade, ValorAcrescimo, ValorDesconto, Departamento, Un)
            Call CriaLogCupom("Bematech_FI_VendeItemDepartamento - BemaRetorno=" & BemaRetorno)
            If BemaRetorno <> 1 Then
                Call AnalizaRetornoBematech(BemaRetorno)
            End If
            Call CriaLogCupom("Bematech_FI_RetornoImpressora(xACK, xST1, xST2)")
            BemaRetorno = 1 'ALEX - NFCE'Bematech_FI_RetornoImpressora(xACK, xST1, xST2)
            Call CriaLogCupom("Bematech_FI_RetornoImpressora(xACK, xST1, xST2) xACM=" & xACK & " - xST1=" & xST1 & " - xST2=" & xST2)
            If BemaRetorno = 1 Then
...
'            End If
        ...
        ElseIf lImpDaruma Then 'ALEX - NFCE
            ...
            ElseIf Aliquota.Aliquota > 0 And Aliquota.Aliquota <= 5 Then
                Departamento = Format(7, "00")
            End If
            BemaRetorno = 1 'ALEX - NFCE'Daruma_FI_VendeItem(CodigoProduto, NomeProduto, xAliquota, Un, Quantidade, 3, Valor, "$", ValorDesconto)
...
Private Sub AguardaProcessamentoNFCe(ByVal pNSU As Long)
    ...
    Call TelaAguarde("Aguarde! Processando NFCe... NSU(" & pNSU & ")", True)
    Call frmAguarde.IniciaContador(60)
    lbl_mensagem.Caption = "Aguarde... Processando NFCe."
    DoEvents
    TimerAutomacao.Enabled = False
    xProcessamentoConcluido = False
    
    'Aguarda 15 segundos pra poder ver layout da tela "Aguarde"
    'Call AguardaMS(15000)
    ...
    If xProcessamentoConcluido = True Then
        If MovSolicitacaoFuncaoNFe.HoraAprovacao_MovSolicitacaoFuncaoNFe <> CDate("00:00:00") Then
            ...
            'Dim rsDadosParaNFCe As adodb.Recordset
                        
            xMensagemNFCe = MovSolicitacaoFuncaoNFe.Mensagem_MovSolicitacaoFuncaoNFe
            'Set rsDadosParaNFCe = ObtenhaDadosSolicitacaoNFCeEmitida(MovSolicitacaoFuncaoNFe.NSU_MovSolicitacaoFuncaoNFe, MovSolicitacaoFuncaoNFe.CodigoEstabelecimento_MovSolicitacaoFuncaoNFe)
'            If rsDadosParaNFCe.RecordCount > 0 Then
'                rsDadosParaNFCe.MoveFirst
'                If Val(rsDadosParaNFCe("ChaveAcessoNFe_MovSolicitacaoFuncaoNFe").Value) <> 0 And rsDadosParaNFCe("CodigoRetorno_MovSolicitacaoFuncaoNFe").Value = 100 Then
'                    If (GeraSolicitacaoImpressaoNFCE(rsDadosParaNFCe("ChaveAcessoNFe_MovSolicitacaoFuncaoNFe").Value, rsDadosParaNFCe("NumeroNFe_MovSolicitacaoFuncaoNFe").Value, rsDadosParaNFCe("NumeroLote_MovSolicitacaoFuncaoNFe").Value)) Then
'                         gStringChamada = MovSolicitacaoFuncaoNFe.NSU_MovSolicitacaoFuncaoNFe & "|@|" & MovSolicitacaoFuncaoNFe.CodigoEstabelecimento_MovSolicitacaoFuncaoNFe & "|@|" & GERADOR_NFCE.OOBJ & "|@|" & MovSolicitacaoFuncaoNFe.NumeroLote_MovSolicitacaoFuncaoNFe & "|@|" '1-oobj 2-cerrado
'                         'Enquanto a Oobj estiver imprimindo o NFCe direto, a linha abaixo deve ser comentada
'                         'Senao, irá imprimir 2 vezes
'                         'Call menu_personalizado.GravaSgpNetCadastroIni("ImprimeNFCe")
'                    End If
'                End If
'            End If
...
Private Sub AtualizaPrecoTCS()
    ...
    If CerradoTef.SolicitacaoAlteraPrecoTCS() Then
    Else
        MsgBox "ERRO"
    End If
    Set CerradoTef = Nothing
...
'    BemaRetorno = 1 'Bematech_FI_DataMovimento(xString)'NFCE - ALEX
...
'    BemaRetorno = 1 'Bematech_FI_DataMovimentoUltimaReducaoMFD(xString) 'NFCE - ALEX
...
'            BemaRetorno = 1 'Bematech_FI_LeituraX() 'NFCE - ALEX
 ...
 '   MsgBox "EnviaDadosParaNFCe - ALEX TESTE 2"
  ...
  '  MsgBox "EnviaDadosParaNFCe - ALEX TESTE 3"
   ...
   '     MsgBox "EnviaDadosParaNFCe - ALEX TESTE 4"
        xTextoSolicitacao = MontaTextoCabecalhoSolicitacaoNFCE(rsDadosParaNFCe)
...
'           Mensagem = lProcessadorNFCE.ProcessaSolicitacaoFuncaoNFCe(SolicitacaoFuncaoNFe.NSU, SolicitacaoFuncaoNFe.CodigoEstabelecimento, GERADOR_NFCE_OOBJ)
            ...
            gStringChamada = MovSolicitacaoFuncaoNFe.NSU_MovSolicitacaoFuncaoNFe & "|@|" & MovSolicitacaoFuncaoNFe.CodigoEstabelecimento_MovSolicitacaoFuncaoNFe & "|@|" & "2" & "|@|" & "true" & "|@|" & gCNPJEmpresa & "|@|" '1-oobj 2-cerrado
...
'End Function
Private Sub ConsisteNFCePendentes()
    gStringChamada = ""
...
Private Sub GeraCat52(ByVal pDataAnterior As Date, ByVal pArqDestino As String, ByVal pNomeArquivo As String)
    ...
    'gStringChamada = lNumeroPDV & "|@|" & Format(pDataAnterior, "dd/MM/yyyy") & "|@|" & pArqDestino & "|@|"
    gStringChamada = lNumeroPDV & "|@|" & Format(pDataAnterior, "dd/MM/yyyy") & "|@|" & pNomeArquivo & "|@|"
    Call CriaLogCupom("String para grava_cat52 no banco =" & gStringChamada)
    Call menu_personalizado.GravaSgpNetCadastroIni("grava_cat52")
    gStringChamada = ""
...
Private Sub PreencheDadosDocumentoEletronicoCabecalho() 'ALEX - DOCELETRONICO
    ...
    MovDocEletronicoCabecalho.ValorBCICMSST = IIf(Aliquota.Aliquota > 0, fValidaValor2(txt_valor_total.Text), 0)  'fValidaValor2(txt_valor_total.Text)
...
Private Function MontaTextoInformacoesComplementaresNFCe() As String
    ...
    If l_codigo_cliente = 0 Then
        If Not Trim(txt_observacao.Text) = Empty Then
            xTextoInformacoesComplementares = xTextoInformacoesComplementares & txt_observacao.Text & "\n"
        End If
        
        If Not Trim(txt_observacao_2.Text) = Empty Then
            xTextoInformacoesComplementares = xTextoInformacoesComplementares & txt_observacao_2.Text & "\n"
        End If
    End If
    
    If Not Trim(txt_placa.Text) = Empty Then
        xTextoInformacoesComplementares = xTextoInformacoesComplementares & "PLACA: " & txt_placa.Text & "\n"
    End If
    ...
    xOrdem = 0
           ...
           Do Until pRsDadosParaNFCe.EOF
                ...
                xOrdem = xOrdem + 1
                    ...
                    xStringNfce = xStringNfce & "832-" & Format(xOrdem, "000") & " = Venda de Combustivel ou lubrificantes" & "|@|" & vbCrLf '& RetiraAcentos(Cfop.NaturezaOperacaoReduzida) & "|@|" & vbCrLf 'Descricao CFOP
                    'Abaixo ficou fixo como 52
                    xStringNfce = xStringNfce & "833-" & Format(xOrdem, "000") & " = 52" & "|@|" & vbCrLf '& xCodigoUfEmitente & "|@|" & vbCrLf 'CodEstadoIde
                    ...
                    If pRsDadosParaNFCe("CST ICMS").Value = 60 Then
...
Private Sub ImpTermicaDadosCliente()
    ...
    Call ImpTermicaImprimeProdutos
    Call ImpTermicaImprimeDados("------------------------------------------------", True)
    Call ImpTermicaImprimeDados("                                                ", True)
    ...
    Call ImpTermicaImprimeDados(" ", True)
End Sub
Private Sub ImpTermicaImprimeProdutos()
...
Private Function MontaTextoCabecalhoSolicitacaoNFCE(ByVal pRsDadosParaNFCe As adodb.Recordset) As String
    ...
    If Val(pRsDadosParaNFCe("IdClienteFornecedor_MovDECabecalho").Value) > 0 Then
        If Cliente.LocalizarCodigo(pRsDadosParaNFCe("IdClienteFornecedor_MovDECabecalho").Value) Then
            ...
            If Cliente.ImprimeDadosECF = True Then
                ...
                xInscricaoEstadualCliente = Trim(Cliente.InscricaoEstadual)
                If Cliente.CGC <> "" Then
        ...
        If lTEF Then
            If cbo_forma_pagamento.ItemData(cbo_forma_pagamento.ListIndex) = 4 Or cbo_forma_pagamento.ItemData(cbo_forma_pagamento.ListIndex) = 6 Or cbo_forma_pagamento.ItemData(cbo_forma_pagamento.ListIndex) = 7 Or cbo_forma_pagamento.ItemData(cbo_forma_pagamento.ListIndex) = 8 Or cbo_forma_pagamento.ItemData(cbo_forma_pagamento.ListIndex) = 9 Or cbo_forma_pagamento.ItemData(cbo_forma_pagamento.ListIndex) = 10 Or cbo_forma_pagamento.ItemData(cbo_forma_pagamento.ListIndex) = 11 Or cbo_forma_pagamento.ItemData(cbo_forma_pagamento.ListIndex) = 12 Or cbo_forma_pagamento.ItemData(cbo_forma_pagamento.ListIndex) = 13 Or cbo_forma_pagamento.ItemData(cbo_forma_pagamento.ListIndex) = 14 Or cbo_forma_pagamento.ItemData(cbo_forma_pagamento.ListIndex) = 15 Or cbo_forma_pagamento.ItemData(cbo_forma_pagamento.ListIndex) = 17 Then
                ...
                If cbo_forma_pagamento.ItemData(cbo_forma_pagamento.ListIndex) = 4 Then
                    lRespostaTEF = CerradoTef.SolicitacaoTEF("NFCe", gNumeroControleSolicitacao, lNumeroCupom, txt_valor_recebido.Text, txt_valor_desconto.Text, gQtdViasTEF, "Outras", False, txt_cpf.Text, txt_nome_cliente.Text, txt_observacao.Text, xObservacao2, lLinhasEntreCV, xTextoParaComprovante, xFechamentoIniciado)
                ElseIf cbo_forma_pagamento.ItemData(cbo_forma_pagamento.ListIndex) = 6 Then
                    lRespostaTEF = CerradoTef.SolicitacaoTEF("NFCe", gNumeroControleSolicitacao, lNumeroCupom, txt_valor_recebido.Text, txt_valor_desconto.Text, gQtdViasTEF, "TecBan", False, txt_cpf.Text, txt_nome_cliente.Text, txt_observacao.Text, xObservacao2, lLinhasEntreCV, xTextoParaComprovante, xFechamentoIniciado)
                ElseIf cbo_forma_pagamento.ItemData(cbo_forma_pagamento.ListIndex) = 7 Then
                    lRespostaTEF = CerradoTef.SolicitacaoTEF("NFCe", gNumeroControleSolicitacao, lNumeroCupom, txt_valor_recebido.Text, txt_valor_desconto.Text, gQtdViasTEF, "TecBan", True, txt_cpf.Text, txt_nome_cliente.Text, txt_observacao.Text, xObservacao2, lLinhasEntreCV, xTextoParaComprovante, xFechamentoIniciado)
                ElseIf cbo_forma_pagamento.ItemData(cbo_forma_pagamento.ListIndex) = 8 Then
                ...
                ElseIf cbo_forma_pagamento.ItemData(cbo_forma_pagamento.ListIndex) = 9 Then
                    lRespostaTEF = CerradoTef.SolicitacaoTEF("NFCe", gNumeroControleSolicitacao, lNumeroCupom, txt_valor_recebido.Text, txt_valor_desconto.Text, gQtdViasTEF, "SMARTEF", False, txt_cpf.Text, txt_nome_cliente.Text, txt_observacao.Text, xObservacao2, lLinhasEntreCV, xTextoParaComprovante, xFechamentoIniciado)
                ElseIf cbo_forma_pagamento.ItemData(cbo_forma_pagamento.ListIndex) = 10 Then
                    lRespostaTEF = CerradoTef.SolicitacaoTEF("NFCe", gNumeroControleSolicitacao, lNumeroCupom, txt_valor_recebido.Text, txt_valor_desconto.Text, gQtdViasTEF, "SUPERTEF", False, txt_cpf.Text, txt_nome_cliente.Text, txt_observacao.Text, xObservacao2, lLinhasEntreCV, xTextoParaComprovante, xFechamentoIniciado)
                ElseIf cbo_forma_pagamento.ItemData(cbo_forma_pagamento.ListIndex) = 11 Then
                    lRespostaTEF = CerradoTef.SolicitacaoTEF("NFCe", gNumeroControleSolicitacao, lNumeroCupom, txt_valor_recebido.Text, txt_valor_desconto.Text, gQtdViasTEF, "HIPERTEF", False, txt_cpf.Text, txt_nome_cliente.Text, txt_observacao.Text, xObservacao2, lLinhasEntreCV, xTextoParaComprovante, xFechamentoIniciado)
                ElseIf cbo_forma_pagamento.ItemData(cbo_forma_pagamento.ListIndex) = 12 Then
                    lRespostaTEF = CerradoTef.SolicitacaoTEF("NFCe", gNumeroControleSolicitacao, lNumeroCupom, txt_valor_recebido.Text, txt_valor_desconto.Text, gQtdViasTEF, "PAGCARD", False, txt_cpf.Text, txt_nome_cliente.Text, txt_observacao.Text, xObservacao2, lLinhasEntreCV, xTextoParaComprovante, xFechamentoIniciado)
                ElseIf cbo_forma_pagamento.ItemData(cbo_forma_pagamento.ListIndex) = 13 Then
                    lRespostaTEF = CerradoTef.SolicitacaoTEF("NFCe", gNumeroControleSolicitacao, lNumeroCupom, txt_valor_recebido.Text, txt_valor_desconto.Text, gQtdViasTEF, "CHEQUEREDECARD", True, txt_cpf.Text, txt_nome_cliente.Text, txt_observacao.Text, xObservacao2, lLinhasEntreCV, xTextoParaComprovante, xFechamentoIniciado)
                ElseIf cbo_forma_pagamento.ItemData(cbo_forma_pagamento.ListIndex) = 14 Then
                    lRespostaTEF = CerradoTef.SolicitacaoTEF("NFCe", gNumeroControleSolicitacao, lNumeroCupom, txt_valor_recebido.Text, txt_valor_desconto.Text, gQtdViasTEF, "TEFNEUS", False, txt_cpf.Text, txt_nome_cliente.Text, txt_observacao.Text, xObservacao2, lLinhasEntreCV, xTextoParaComprovante, xFechamentoIniciado)
                ElseIf cbo_forma_pagamento.ItemData(cbo_forma_pagamento.ListIndex) = 15 Then
                    lRespostaTEF = CerradoTef.SolicitacaoTEF("NFCe", gNumeroControleSolicitacao, lNumeroCupom, txt_valor_recebido.Text, txt_valor_desconto.Text, gQtdViasTEF, "GODCARD", False, txt_cpf.Text, txt_nome_cliente.Text, txt_observacao.Text, xObservacao2, lLinhasEntreCV, xTextoParaComprovante, xFechamentoIniciado)
                ElseIf cbo_forma_pagamento.ItemData(cbo_forma_pagamento.ListIndex) = 17 Then
                    ...
                    lRespostaTEF = CerradoTef.SolicitacaoTEF("NFCe", gNumeroControleSolicitacao, lNumeroCupom, txt_valor_recebido.Text, txt_valor_desconto.Text, gQtdViasTEF, "TEFCERRADO", False, txt_cpf.Text, txt_nome_cliente.Text, xObservacao2 & txt_observacao.Text, xDadosProdutos, lLinhasEntreCV, xTextoParaComprovante, xFechamentoIniciado)
                End If
                'PONTO B
...
'
        ...
        MovDocEletronicoCabecalho.ValorTotal = fValidaValor(lbl_valor_compra.Caption)
        MovDocEletronicoCabecalho.ValorDesconto = fValidaValor(txt_valor_desconto.Text)
        MovDocEletronicoCabecalho.ValorProdutos = fValidaValor(lbl_valor_compra.Caption)
    ...
    If ValidaCampos Then
        If VerificaLiberacaoDigitacao2 Then
            ...
            If lAutomacaoFlagVendaAutomatica = True Then
                ...
                'NFCE - ALEX
                If MovimentoAbastecimento.LocalizarCodigo(g_empresa, lAutomacaoData(lAutomacaoBicoEmAcerto), lAutomacaoHora(lAutomacaoBicoEmAcerto), lAutomacaoBico(lAutomacaoBicoEmAcerto)) Then
...
Private Function GravaDocumentoEletronicoItem() As Boolean 'ALEX - DOCELETRONICO
    ...
    Else
       MovDocEletronicoItem.ValorDesconto = 0 'lDescontoItemEmbutido depois criar campo especifico para desconto embutido
    End If
    MovDocEletronicoItem.ValorTotalLiquido = fValidaValor2(txt_valor_total.Text)
    MovDocEletronicoItem.CSTICMS = Produto.CSTICMS
    MovDocEletronicoItem.ValorBCICMS = IIf(Aliquota.Aliquota > 0, fValidaValor2(txt_valor_total.Text), 0)
    ...
    MovDocEletronicoItem.ValorBCICMSST = IIf(Aliquota.Aliquota > 0, fValidaValor2(txt_valor_total.Text), 0) 'VERIFICAR SE REALEMTE É ESSE
    ...
    MovDocEletronicoItem.ValorBcIpi = fValidaValor2(txt_valor_total.Text) ''VERIFICAR SE REALEMTE É ESSE
    ...
    MovDocEletronicoItem.ValorBcPis = fValidaValor2(txt_valor_total.Text) ''VERIFICAR SE REALEMTE É ESSE
    ...
    MovDocEletronicoItem.EncerranteFinal = Format(1000, "#######.00")
...
Private Sub GravaMapaResumo()
    ...
    End If
    If Not MovMapaResumo.LocalizarDataECF(g_empresa, Date - 1, lNumeroPDV) Then
        Call CriaLogCupom("")
        xString = ""
        For i = 1 To 63
        ...
        'End If
        Call CriaLogCupom("Reducao Z: " & xString)
        If Not MovMapaResumo.LocalizarDataECF(g_empresa, CDate(Mid(xString, 596, 2) & "/" & Mid(xString, 598, 2) & "/20" & Mid(xString, 600, 2)), lNumeroPDV) Then
            
            If MovMapaResumo.LocalizarDataECF(g_empresa, CDate(Mid(xString, 596, 2) & "/" & Mid(xString, 598, 2) & "/20" & Mid(xString, 600, 2)) - 1, lNumeroPDV) Then
            ...
            'MovMapaResumo.numero = 1
            MovMapaResumo.ECFNumero = lNumeroPDV
            'MovMapaResumo.ContagemOperacaoInicial = Mid(xString, 586, 6)
            'MovMapaResumo.ContagemOperacaoFinal = CLng(Mid(xString, 579, 6)) - 1
            If MovCupomFiscal.LocalizarPrimeiroData(g_empresa, lNumeroPDV, MovMapaResumo.Data) Then
                MovMapaResumo.ContagemOperacaoInicial = MovCupomFiscal.NumeroCupom
            End If
            If MovCupomFiscal.LocalizarUltimoData(g_empresa, lNumeroPDV, MovMapaResumo.Data) Then
...
Function ValidaCartaoPOS() As Boolean
    ...
    If cbo_forma_pagamento.ItemData(cbo_forma_pagamento.ListIndex) = 16 Then
        g_string = "Movimento_NFCe_Auto|@|Incluir|@|" & Format(lDataCupom, "dd/MM/yyyy") & "|@|" & lPeriodo & "|@|" & lTipoMovimento & "|@|" & lIlha & "|@|1|@|2|@|" & g_usuario & "|@|" & lbl_valor_compra.Caption & "|@|" & lNumeroCupom & "|@|"
...
'        End If
   ...
   ' AtivaReducaoZ
    ...
    If lImpBematech Then
        ...
        BemaRetorno = 1 'Bematech_FI_FlagsFiscais(xFlag) 'NFCE - ALEX
...
Private Sub mnuCancelaCartao_Click()
    ...
    g_string = ""
    lRespostaTEF = CerradoTef.SolicitacaoCNC("NFCe", gNumeroControleSolicitacao, gQtdViasTEF, xNomeCartao)
    Set CerradoTef = Nothing
    Call AtivaDesativaTimer(True)
    mnuSenha_Click
End Sub
...
Private Sub mnuFuncaoADM_Click()
    ...
    Select Case xString
        Case "1"
            lRespostaTEF = CerradoTef.SolicitacaoADM("NFCe", gNumeroControleSolicitacao, gQtdViasTEF, "TecBan", lLinhasEntreCV)
        Case "2"
            lRespostaTEF = CerradoTef.SolicitacaoADM("NFCe", gNumeroControleSolicitacao, gQtdViasTEF, "TCSMART", lLinhasEntreCV)
        Case "3"
            lRespostaTEF = CerradoTef.SolicitacaoADM("NFCe", gNumeroControleSolicitacao, gQtdViasTEF, "Outras", lLinhasEntreCV)
        Case "4"
            lRespostaTEF = CerradoTef.SolicitacaoADM("NFCe", gNumeroControleSolicitacao, gQtdViasTEF, "SMARTEF", lLinhasEntreCV)
        Case "5"
            lRespostaTEF = CerradoTef.SolicitacaoADM("NFCe", gNumeroControleSolicitacao, gQtdViasTEF, "SUPERTEF", lLinhasEntreCV)
        Case "6"
            lRespostaTEF = CerradoTef.SolicitacaoADM("NFCe", gNumeroControleSolicitacao, gQtdViasTEF, "HIPERTEF", lLinhasEntreCV)
        Case "7"
            lRespostaTEF = CerradoTef.SolicitacaoADM("NFCe", gNumeroControleSolicitacao, gQtdViasTEF, "PAGCARD", lLinhasEntreCV)
        Case "8"
            lRespostaTEF = CerradoTef.SolicitacaoADM("NFCe", gNumeroControleSolicitacao, gQtdViasTEF, "TEFNEUS", lLinhasEntreCV)
        Case "9"
            lRespostaTEF = CerradoTef.SolicitacaoADM("NFCe", gNumeroControleSolicitacao, gQtdViasTEF, "GODCARD", lLinhasEntreCV)
        Case "10"
            lRespostaTEF = CerradoTef.SolicitacaoADM("NFCe", gNumeroControleSolicitacao, gQtdViasTEF, "TEFCERRADO", lLinhasEntreCV)
...
'        End If
        xString = ConfiguracaoDiversa.BuscaProximoCodigo(g_empresa, "NFCe: Numero")
        If Len(xString) > 0 Then
