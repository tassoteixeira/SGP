...
Begin VB.Form lst_estoque_medio 
   Caption         =   "Emissão do Estoque Médio"
   ClientHeight    =   2715
   ClientLeft      =   3990
   ClientTop       =   2010
   ClientWidth     =   6795
   Icon            =   "lst_estoque_medio.frx":0000
   LinkTopic       =   "Form2"
   LockControls    =   -1  'True
   PaletteMode     =   1  'UseZOrder
   Picture         =   "lst_estoque_medio.frx":030A
   ScaleHeight     =   2715
   ScaleWidth      =   6795
   Begin VB.CommandButton cmd_visualizar 
      ...
      Height          =   855
      Left            =   1140
      Picture         =   "lst_estoque_medio.frx":0350
      Style           =   1  'Graphical
      TabIndex        =   8
      ToolTipText     =   "Visualiza o estoque médio."
      Top             =   1740
      Width           =   795
   End
   Begin VB.CommandButton cmd_imprimir 
      ...
      Height          =   855
      Left            =   3000
      Picture         =   "lst_estoque_medio.frx":1A6A
      Style           =   1  'Graphical
      TabIndex        =   9
      ToolTipText     =   "Imprime o estoque médio."
      Top             =   1740
      Width           =   795
   End
   Begin VB.CommandButton cmd_sair 
      ...
      Height          =   855
      Left            =   4860
      Picture         =   "lst_estoque_medio.frx":3074
      Style           =   1  'Graphical
      TabIndex        =   10
   ...
   Begin VB.Frame frm_dados 
      ...
      Begin VB.CommandButton cmd_data 
         Height          =   315
         Left            =   2760
         Picture         =   "lst_estoque_medio.frx":4706
         Style           =   1  'Graphical
         TabIndex        =   3
   ...
   End
End
Attribute VB_Name = "lst_estoque_medio"
...
Private Sub ImpDados()
    ...
    If lPagina > 0 Then
        ...
        BioFechaImprime
        g_string = lLocal & lNomeArquivo & "|@|Relatório do Estoque Médio|@|"
        frm_preview.Show 1
    End If
End Sub
...
Private Sub ImpDet()
    ...
    Mid(x_linha, 5 + 5 - i, i) = Format(tbl_produto!Codigo, "#,000")
    Mid(x_linha, 17, 40) = tbl_produto!Nome
...
Private Sub ImpCab()
    ...
    BioImprime "@Printer.Print " & x_linha
    BioImprime "@@Printer.FontBold = False"
    x_linha = "| ESTOQUE MEDIO                                            GRUPO.:                                                  Goiânia, __/__/____ |"
    ...
    x_linha = "+-----------+----------------------------------------------+---------+---------+---------+---------+---------+---------+----------------+"
    BioImprime "@Printer.Print " & x_linha
    x_linha = "| CODIGO DO | DESCRIMINAÇÃO DOS PRODUTOS                   |  SAIDAS |  SAIDAS |  SAIDAS |  TOTAL  |  MEDIA  | ESTOQUE |                |"
    BioImprime "@Printer.Print " & x_linha
    x_linha = "|  PRODUTO  |                                              | __/____ | __/____ | __/____ |  SAIDAS |  SAIDAS |  ATUAL  |                |"
