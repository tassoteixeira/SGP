...
Begin VB.Form movimento_desconto_personalizado 
   Caption         =   "Movimento de Desconto Personalizado"
   ClientHeight    =   5775
   ClientLeft      =   165
   ClientTop       =   285
   ClientWidth     =   7875
   Icon            =   "movimento_desconto_personalizado.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form2"
   LockControls    =   -1  'True
   PaletteMode     =   1  'UseZOrder
   Picture         =   "movimento_desconto_personalizado.frx":030A
   ScaleHeight     =   5775
   ScaleWidth      =   7875
   ...
   Begin VB.CommandButton cmd_novo 
      ...
      Height          =   855
      Left            =   120
      Picture         =   "movimento_desconto_personalizado.frx":0750
      Style           =   1  'Graphical
      TabIndex        =   21
   ...
   Begin VB.CommandButton cmd_alterar 
      ...
      Height          =   855
      Left            =   1020
      Picture         =   "movimento_desconto_personalizado.frx":1DE2
      Style           =   1  'Graphical
      TabIndex        =   22
   ...
   Begin VB.CommandButton cmd_excluir 
      ...
      Height          =   855
      Left            =   1920
      Picture         =   "movimento_desconto_personalizado.frx":32DC
      Style           =   1  'Graphical
      TabIndex        =   23
   ...
   Begin VB.CommandButton cmd_pesquisa 
      ...
      Height          =   855
      Left            =   2820
      Picture         =   "movimento_desconto_personalizado.frx":496E
      Style           =   1  'Graphical
      TabIndex        =   24
   ...
   Begin VB.CommandButton cmd_sair 
      ...
      Height          =   855
      Left            =   3720
      Picture         =   "movimento_desconto_personalizado.frx":5DE0
      Style           =   1  'Graphical
      TabIndex        =   25
   ...
   Begin VB.Frame frmDados 
      ...
      Begin MSDataListLib.DataCombo dtcboCliente 
         Bindings        =   "movimento_desconto_personalizado.frx":7472
         Height          =   315
         Left            =   2640
         TabIndex        =   3
         Top             =   180
      ...
      Begin MSDataListLib.DataCombo dtcboProduto 
         Bindings        =   "movimento_desconto_personalizado.frx":748D
         Height          =   315
         Left            =   2880
         TabIndex        =   6
         Top             =   660
   ...
   Begin VB.Frame frm_move 
      ...
      Begin VB.CommandButton cmd_primeiro 
         Height          =   615
         Left            =   120
         Picture         =   "movimento_desconto_personalizado.frx":74A8
         Style           =   1  'Graphical
         TabIndex        =   27
      ...
      Begin VB.CommandButton cmd_ultimo 
         Height          =   615
         Left            =   1680
         Picture         =   "movimento_desconto_personalizado.frx":89A2
         Style           =   1  'Graphical
         TabIndex        =   30
      ...
      Begin VB.CommandButton cmd_anterior 
         Height          =   615
         Left            =   600
         Picture         =   "movimento_desconto_personalizado.frx":9E9C
         Style           =   1  'Graphical
         TabIndex        =   28
      ...
      Begin VB.CommandButton cmd_proximo 
         Height          =   615
         Left            =   1200
         Picture         =   "movimento_desconto_personalizado.frx":B30E
         Style           =   1  'Graphical
         TabIndex        =   29
   ...
   Begin VB.CommandButton cmd_ok 
      ...
      Height          =   855
      Left            =   6060
      Picture         =   "movimento_desconto_personalizado.frx":C890
      Style           =   1  'Graphical
      TabIndex        =   19
   ...
   Begin VB.CommandButton cmd_cancelar 
      ...
      Height          =   855
      Left            =   6960
      Picture         =   "movimento_desconto_personalizado.frx":DE9A
      Style           =   1  'Graphical
      TabIndex        =   20
   ...
   End
End
Attribute VB_Name = "movimento_desconto_personalizado"
...
'    End If
    ...
    grid_dados.Col = 0
    grid_dados.Text = MovDescontoPersonalizado.CodigoCliente
    grid_dados.Col = 1
    If Cliente.LocalizarCodigo(MovDescontoPersonalizado.CodigoCliente) Then
        grid_dados.Text = Cliente.RazaoSocial
    Else
        grid_dados.Text = "** Não Cadastrado **"
    End If
    grid_dados.Col = 2
    grid_dados.Text = MovDescontoPersonalizado.CodigoProduto
    grid_dados.Col = 3
    If Produto.LocalizarCodigo(MovDescontoPersonalizado.CodigoProduto) Then
    ...
    grid_dados.Col = 4
    grid_dados.Text = Format(MovDescontoPersonalizado.PercentualaDescontar, "##0.00")
    grid_dados.Col = 5
    grid_dados.Text = Format(MovDescontoPersonalizado.ValoraDescontar, "###,##0.0000")
    grid_dados.Col = 6
    grid_dados.Text = Format(MovDescontoPersonalizado.PrecoFixo, "###,##0.0000")
    grid_dados.Col = 7
    If MovDescontoPersonalizado.Desconto = True Then
        grid_dados.Text = "Desconto"
    Else
        grid_dados.Text = "Acréscimo"
    End If
    grid_dados.Col = 8
    grid_dados.Text = Format(MovDescontoPersonalizado.PrecoParaECF, "###,##0.0000")
End Sub
Private Sub AlteraClientesDoMesmoGrupo(ByVal pCodigoGrupoCliente As Integer, ByVal pCodigoProduto As Integer)
    ...
    lSQL = lSQL & "   AND Codigo <> " & lCodigoCliente
    ...
    If rsClientes.RecordCount > 0 Then
        If (MsgBox("Existe " & rsClientes.RecordCount & " Cliente(s) no mesmo Grupo de Cliente." & vbCrLf & "Deseja alterar para este(s) outro(s) cliente(s)?", vbYesNo + vbQuestion + vbDefaultButton1, "Alteração de Preço Personalizado!")) = vbYes Then
            ...
            Do Until rsClientes.EOF
                If MovDescontoPersonalizado.LocalizarCodigo(rsClientes("Codigo").Value, pCodigoProduto) Then
                    AtualizaTabela2
                    If MovDescontoPersonalizado.Alterar(rsClientes("Codigo").Value, pCodigoProduto) Then
    ...
    If Not MovDescontoPersonalizado.LocalizarCodigo(lCodigoCliente, pCodigoProduto) Then
...
Private Sub AtualTabe()
    MovDescontoPersonalizado.CodigoCliente = CLng(dtcboCliente.BoundText)
    MovDescontoPersonalizado.CodigoProduto = CLng(dtcboProduto.BoundText)
    AtualizaTabela2
End Sub
Private Sub AtualizaTabela2()
    MovDescontoPersonalizado.PercentualaDescontar = fValidaValor(txt_percentual_descontar.Text)
    MovDescontoPersonalizado.ValoraDescontar = fValidaValor(txt_valor_descontar.Text)
    If chkAcrescimo.Value = 0 Then
        MovDescontoPersonalizado.Desconto = True
    Else
        MovDescontoPersonalizado.Desconto = False
    End If
    MovDescontoPersonalizado.PrecoFixo = fValidaValor(txtPrecoFixo.Text)
    MovDescontoPersonalizado.PrecoParaECF = fValidaValor(txtPrecoECF.Text)
End Sub
Private Sub AtualTela()
    lCodigoCliente = MovDescontoPersonalizado.CodigoCliente
    lCodigoProduto = MovDescontoPersonalizado.CodigoProduto
    
    txt_cliente.Text = MovDescontoPersonalizado.CodigoCliente
    txt_produto.Text = MovDescontoPersonalizado.CodigoProduto
    dtcboCliente.BoundText = MovDescontoPersonalizado.CodigoCliente
    dtcboProduto.BoundText = MovDescontoPersonalizado.CodigoProduto
    txt_percentual_descontar.Text = Format(MovDescontoPersonalizado.PercentualaDescontar, "##0.00")
    txt_valor_descontar.Text = Format(MovDescontoPersonalizado.ValoraDescontar, "###,##0.0000")
    If MovDescontoPersonalizado.Desconto = True Then
        chkAcrescimo.Value = 0
    Else
        chkAcrescimo.Value = 1
    End If
    txtPrecoFixo.Text = Format(MovDescontoPersonalizado.PrecoFixo, "###,##0.0000")
    txtPrecoECF.Text = Format(MovDescontoPersonalizado.PrecoParaECF, "###,##0.0000")
...
Private Sub PesquisaPrecoPersonalizado()
    Dim xCodigoCliente As Long
    Dim xCodigoProduto As Long
    lCodigoCliente = MovDescontoPersonalizado.CodigoCliente
    lCodigoProduto = MovDescontoPersonalizado.CodigoProduto
    MontaGrid
    xCodigoCliente = MovDescontoPersonalizado.CodigoCliente
    xCodigoProduto = 0
    Do Until MovDescontoPersonalizado.LocalizarCliente(xCodigoCliente, xCodigoProduto) = False
        AdcionaDadosGrid
        xCodigoProduto = MovDescontoPersonalizado.CodigoProduto
    Loop
    Call MovDescontoPersonalizado.LocalizarCodigo(lCodigoCliente, lCodigoProduto)
    grid_dados.Row = grid_dados.Rows - 1
    grid_dados.Col = 0
End Sub
Private Function PreparaLogTabela() As String
    ...
    xStringLog = "Cli:" & MovDescontoPersonalizado.CodigoCliente & " Prod:" & MovDescontoPersonalizado.CodigoProduto
    If MovDescontoPersonalizado.Desconto = True Then
        xStringLog = xStringLog & " Desc."
    Else
        xStringLog = xStringLog & " Acresc."
    End If
    If MovDescontoPersonalizado.PercentualaDescontar > 0 Then
        xStringLog = xStringLog & Format(MovDescontoPersonalizado.PercentualaDescontar, "##0.00") & "%"
    ElseIf MovDescontoPersonalizado.ValoraDescontar > 0 Then
        xStringLog = xStringLog & "R$ " & Format(MovDescontoPersonalizado.ValoraDescontar, "###,##0.0000")
    End If
    If MovDescontoPersonalizado.PrecoFixo > 0 Then
        xStringLog = xStringLog & " Fixo=" & Format(MovDescontoPersonalizado.PrecoFixo, "###,##0.0000")
    End If
    If MovDescontoPersonalizado.PrecoParaECF > 0 Then
        xStringLog = xStringLog & " ECF=" & Format(MovDescontoPersonalizado.PrecoParaECF, "###,##0.0000")
    End If
...
Private Sub cmd_anterior_Click()
    ...
    If MovDescontoPersonalizado.LocalizarAnterior Then
...
Private Sub cmd_cancelar_Click()
    ...
    LimpaTela
    If MovDescontoPersonalizado.LocalizarCodigo(lCodigoCliente, lCodigoProduto) Then
        AtivaBotoes
        PesquisaPrecoPersonalizado
        AtualTela
...
Private Sub cmd_excluir_Click()
    ...
    If txt_cliente > 0 Then
        If (MsgBox("Deseja excluir este registro?", 4 + 32 + 256, "Exclusão de Registro!")) = vbYes Then
            ...
            lOpcao = 3
            If MovDescontoPersonalizado.Excluir(CLng(dtcboCliente.BoundText), CLng(dtcboProduto.BoundText)) Then
                If Not MovDescontoPersonalizado.LocalizarUltimo() Then
                    DesativaBotoes
                    cmd_novo.Enabled = True
                    cmd_sair.Enabled = True
                    cmd_novo.SetFocus
...
Private Sub cmd_ok_Click()
    ...
    If ValidaCampos Then
        ...
        If lOpcao = 1 Then
            AtualTabe
            Call GravaAuditoria(1, Me.name, 10, PreparaLogTabela)
            If MovDescontoPersonalizado.Incluir Then
                lCodigoCliente = Val(dtcboCliente.BoundText)
        ...
        ElseIf lOpcao = 2 Then
            ...
            If MovDescontoPersonalizado.Alterar(lCodigoCliente, lCodigoProduto) Then
                If Cliente.CodigoGrupoCliente > 1 Then
                'fazer a pergunta
                    Call AlteraClientesDoMesmoGrupo(Cliente.CodigoGrupoCliente, lCodigoProduto)
                End If
            Else
                MsgBox "Não foi possível alterar este registro!", vbInformation, "Erro de Verificação!"
            End If
        End If
        If MovDescontoPersonalizado.LocalizarCodigo(CLng(dtcboCliente.BoundText), CLng(dtcboProduto.BoundText)) Then
            PesquisaPrecoPersonalizado
            AtualTela
        Else
            LimpaTela
...
Private Sub cmd_pesquisa_Click()
    ...
    consulta_movimento_desconto_personalizado.Show 1
...
Private Sub cmd_primeiro_Click()
    ...
    If MovDescontoPersonalizado.LocalizarPrimeiro Then
        PesquisaPrecoPersonalizado
        AtualTela
        cmd_proximo.SetFocus
    Else
...
Private Sub cmd_proximo_Click()
    ...
    If MovDescontoPersonalizado.LocalizarProximo Then
        AtualTela
        PesquisaPrecoPersonalizado
    Else
...
Private Sub cmd_ultimo_Click()
    ...
    If MovDescontoPersonalizado.LocalizarUltimo Then
        PesquisaPrecoPersonalizado
        AtualTela
        cmd_anterior.SetFocus
    Else
...
Private Sub dtcboCliente_LostFocus()
    If dtcboCliente.BoundText <> "" And lOpcao > 0 Then
        txt_cliente.Text = dtcboCliente.BoundText
        txt_cliente_LostFocus
        txt_produto.SetFocus
    End If
End Sub
...
Private Sub MarcaCelulaGrid()
    ...
    If grid_dados.Text <> "" Then
        grid_dados.Col = 0
        lCodigoCliente = grid_dados.Text
        grid_dados.Col = 2
...
Private Sub txt_cliente_LostFocus()
    If Val(txt_cliente.Text) > 0 And lOpcao > 0 Then
        If Cliente.LocalizarCodigo(Val(txt_cliente.Text)) Then
            If Cliente.Inativo Then
                ...
                Exit Sub
            Else
                dtcboCliente.BoundText = Cliente.Codigo
                txt_produto.SetFocus
            End If
        Else
