...
Begin VB.Form consulta_cheque_devolvido 
   Caption         =   "Consulta de Cheque Devolvido"
   ClientHeight    =   5355
   ClientLeft      =   1245
   ClientTop       =   2385
   ClientWidth     =   8655
   Icon            =   "con_cheque_devolvido.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form2"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   PaletteMode     =   1  'UseZOrder
   Picture         =   "con_cheque_devolvido.frx":0442
   ScaleHeight     =   5355
   ScaleWidth      =   8655
   ...
   Begin VB.CommandButton cmd_ok 
      ...
      Height          =   855
      Left            =   7020
      Picture         =   "con_cheque_devolvido.frx":0488
      Style           =   1  'Graphical
      TabIndex        =   7
   ...
   Begin VB.CommandButton cmd_sair 
      ...
      Height          =   855
      Left            =   7860
      Picture         =   "con_cheque_devolvido.frx":1A92
      Style           =   1  'Graphical
      TabIndex        =   8
   ...
   End
End
Attribute VB_Name = "consulta_cheque_devolvido"
...
Private Sub AtualizaGrid()
    ...
    If ValidaCampos Then
        lSQl = ""
        lSQl = lSQl & "SELECT [Data de Emissao], Periodo, [Tipo do Movimento], "
        lSQl = lSQl & "       Valor, [Data do Vencimento], [Codigo do Banco], "
        lSQl = lSQl & "       [Numero da Conta], [Numero do Cheque], Emitente, "
        lSQl = lSQl & "       [Data da Devolucao], [Motivo da Devolucao], Situacao"
    ...
    If Not rsDados.EOF Then
        ...
        Do Until rsDados.EOF
            ...
            For Each fld In rsDados.Fields
                i2 = i2 + 1
                MSFlexGrid1.Col = i2
                If fld.name = "Tipo do Movimento" Then
                    If fld.Value = 1 Then
                        MSFlexGrid1.Text = "Caixa de Combustíveis"
                    ElseIf fld.Value = 2 Then
                        MSFlexGrid1.Text = "Caixa de Óleos/Diversos"
                    ElseIf fld.Value = 3 Then
                        MSFlexGrid1.Text = "Cheque Inclusão"
                    Else
                        MSFlexGrid1.Text = "** Não Identificado **"
                    End If
                Else
...
Private Sub Form_Load()
    ...
    lNomeTabela = "Movimento_Cheque_Devolvido"
    PreencheCampos
