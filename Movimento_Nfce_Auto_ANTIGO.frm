...
Begin VB.Form Movimento_Nfce_Auto_ANTIGO 
   Caption         =   "Nota Fiscal ao Consumidor Eletrônica"
   ClientHeight    =   8235
   ClientLeft      =   165
   ClientTop       =   585
   ClientWidth     =   13530
   Icon            =   "Movimento_Nfce_Auto_ANTIGO.frx":0000
   LinkTopic       =   "Form2"
   PaletteMode     =   1  'UseZOrder
   Picture         =   "Movimento_Nfce_Auto_ANTIGO.frx":27A2
   ScaleHeight     =   8235
   ScaleWidth      =   13530
   Begin VB.Frame frm_ponto 
      ...
      Begin MSDataListLib.DataCombo dtcboFuncionario 
         Bindings        =   "Movimento_Nfce_Auto_ANTIGO.frx":2BE8
         Height          =   315
         Left            =   120
         TabIndex        =   90
         Top             =   3060
   ...
   Begin RichTextLib.RichTextBox txt_cupom_fiscal 
      ...
      ReadOnly        =   -1  'True
      ScrollBars      =   3
      TextRTF         =   $"Movimento_Nfce_Auto_ANTIGO.frx":2C07
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Courier New"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.Frame frmDados 
      ...
      Begin VB.CommandButton cmd_bico 
         ...
         Index           =   31
         Left            =   6540
         Picture         =   "Movimento_Nfce_Auto_ANTIGO.frx":2C87
         Style           =   1  'Graphical
         TabIndex        =   67
      ...
      Begin VB.CommandButton cmd_bico 
         ...
         Index           =   30
         Left            =   5640
         Picture         =   "Movimento_Nfce_Auto_ANTIGO.frx":5189
         Style           =   1  'Graphical
         TabIndex        =   65
         ToolTipText     =   "Bico Livre para Abastecimento."
         Top             =   4250
      ...
      Begin VB.CommandButton cmd_bico 
         ...
         Index           =   29
         Left            =   4740
         Picture         =   "Movimento_Nfce_Auto_ANTIGO.frx":768B
         Style           =   1  'Graphical
         TabIndex        =   63
         ToolTipText     =   "Bico Livre para Abastecimento."
         Top             =   4250
      ...
      Begin VB.CommandButton cmd_bico 
         ...
         Index           =   28
         Left            =   3840
         Picture         =   "Movimento_Nfce_Auto_ANTIGO.frx":9B8D
         Style           =   1  'Graphical
         TabIndex        =   61
         ToolTipText     =   "Bico Livre para Abastecimento."
         Top             =   4250
      ...
      Begin VB.CommandButton cmd_bico 
         ...
         Index           =   27
         Left            =   2940
         Picture         =   "Movimento_Nfce_Auto_ANTIGO.frx":C08F
         Style           =   1  'Graphical
         TabIndex        =   59
         ToolTipText     =   "Bico Livre para Abastecimento."
         Top             =   4250
      ...
      Begin VB.CommandButton cmd_bico 
         ...
         Index           =   26
         Left            =   2040
         Picture         =   "Movimento_Nfce_Auto_ANTIGO.frx":E591
         Style           =   1  'Graphical
         TabIndex        =   57
         ToolTipText     =   "Bico Livre para Abastecimento."
         Top             =   4250
      ...
      Begin VB.CommandButton cmd_bico 
         ...
         Index           =   25
         Left            =   1140
         Picture         =   "Movimento_Nfce_Auto_ANTIGO.frx":10A93
         Style           =   1  'Graphical
         TabIndex        =   55
         ToolTipText     =   "Bico Livre para Abastecimento."
         Top             =   4250
      ...
      Begin VB.CommandButton cmd_bico 
         ...
         Index           =   24
         Left            =   240
         Picture         =   "Movimento_Nfce_Auto_ANTIGO.frx":12F95
         Style           =   1  'Graphical
         TabIndex        =   53
         ToolTipText     =   "Bico Livre para Abastecimento."
         Top             =   4250
      ...
      Begin VB.CommandButton cmd_bico 
         ...
         Index           =   23
         Left            =   6540
         Picture         =   "Movimento_Nfce_Auto_ANTIGO.frx":15497
         Style           =   1  'Graphical
         TabIndex        =   51
         ToolTipText     =   "Bico Livre para Abastecimento."
         Top             =   3120
      ...
      Begin VB.CommandButton cmd_bico 
         ...
         Index           =   22
         Left            =   5640
         Picture         =   "Movimento_Nfce_Auto_ANTIGO.frx":17999
         Style           =   1  'Graphical
         TabIndex        =   49
         ToolTipText     =   "Bico Livre para Abastecimento."
         Top             =   3120
      ...
      Begin VB.CommandButton cmd_bico 
         ...
         Index           =   21
         Left            =   4740
         Picture         =   "Movimento_Nfce_Auto_ANTIGO.frx":19E9B
         Style           =   1  'Graphical
         TabIndex        =   47
         ToolTipText     =   "Bico Livre para Abastecimento."
         Top             =   3120
      ...
      Begin VB.CommandButton cmd_bico 
         ...
         Index           =   20
         Left            =   3840
         Picture         =   "Movimento_Nfce_Auto_ANTIGO.frx":1C39D
         Style           =   1  'Graphical
         TabIndex        =   45
         ToolTipText     =   "Bico Livre para Abastecimento."
         Top             =   3120
      ...
      Begin VB.CommandButton cmd_bico 
         ...
         Index           =   19
         Left            =   2940
         Picture         =   "Movimento_Nfce_Auto_ANTIGO.frx":1E89F
         Style           =   1  'Graphical
         TabIndex        =   43
         ToolTipText     =   "Bico Livre para Abastecimento."
         Top             =   3120
      ...
      Begin VB.CommandButton cmd_bico 
         ...
         Index           =   18
         Left            =   2040
         Picture         =   "Movimento_Nfce_Auto_ANTIGO.frx":20DA1
         Style           =   1  'Graphical
         TabIndex        =   41
         ToolTipText     =   "Bico Livre para Abastecimento."
         Top             =   3120
      ...
      Begin VB.CommandButton cmd_bico 
         ...
         Index           =   17
         Left            =   1140
         Picture         =   "Movimento_Nfce_Auto_ANTIGO.frx":232A3
         Style           =   1  'Graphical
         TabIndex        =   39
         ToolTipText     =   "Bico Livre para Abastecimento."
         Top             =   3120
      ...
      Begin VB.CommandButton cmd_bico 
         ...
         Index           =   16
         Left            =   240
         Picture         =   "Movimento_Nfce_Auto_ANTIGO.frx":257A5
         Style           =   1  'Graphical
         TabIndex        =   37
         ToolTipText     =   "Bico Livre para Abastecimento."
         Top             =   3120
      ...
      Begin VB.CommandButton cmd_bico 
         ...
         Index           =   15
         Left            =   6540
         Picture         =   "Movimento_Nfce_Auto_ANTIGO.frx":27CA7
         Style           =   1  'Graphical
         TabIndex        =   35
         ToolTipText     =   "Bico Livre para Abastecimento."
         Top             =   1980
      ...
      Begin VB.CommandButton cmd_bico 
         ...
         Index           =   14
         Left            =   5640
         Picture         =   "Movimento_Nfce_Auto_ANTIGO.frx":2A1A9
         Style           =   1  'Graphical
         TabIndex        =   33
         ToolTipText     =   "Bico Livre para Abastecimento."
         Top             =   1980
      ...
      Begin VB.CommandButton cmd_bico 
         ...
         Index           =   13
         Left            =   4740
         Picture         =   "Movimento_Nfce_Auto_ANTIGO.frx":2C6AB
         Style           =   1  'Graphical
         TabIndex        =   31
         ToolTipText     =   "Bico Livre para Abastecimento."
         Top             =   1980
      ...
      Begin VB.CommandButton cmd_bico 
         ...
         Index           =   12
         Left            =   3840
         Picture         =   "Movimento_Nfce_Auto_ANTIGO.frx":2EBAD
         Style           =   1  'Graphical
         TabIndex        =   29
         ToolTipText     =   "Bico Livre para Abastecimento."
         Top             =   1980
      ...
      Begin VB.CommandButton cmd_bico 
         ...
         Index           =   11
         Left            =   2940
         Picture         =   "Movimento_Nfce_Auto_ANTIGO.frx":310AF
         Style           =   1  'Graphical
         TabIndex        =   27
         ToolTipText     =   "Bico Livre para Abastecimento."
         Top             =   1980
      ...
      Begin VB.CommandButton cmd_bico 
         ...
         Index           =   10
         Left            =   2040
         Picture         =   "Movimento_Nfce_Auto_ANTIGO.frx":335B1
         Style           =   1  'Graphical
         TabIndex        =   25
         ToolTipText     =   "Bico Livre para Abastecimento."
         Top             =   1980
      ...
      Begin VB.CommandButton cmd_bico 
         ...
         Index           =   9
         Left            =   1140
         Picture         =   "Movimento_Nfce_Auto_ANTIGO.frx":35AB3
         Style           =   1  'Graphical
         TabIndex        =   23
         ToolTipText     =   "Bico Livre para Abastecimento."
         Top             =   1980
      ...
      Begin VB.CommandButton cmd_bico 
         ...
         Index           =   8
         Left            =   240
         Picture         =   "Movimento_Nfce_Auto_ANTIGO.frx":37FB5
         Style           =   1  'Graphical
         TabIndex        =   21
         ToolTipText     =   "Bico Livre para Abastecimento."
         Top             =   1980
      ...
      Begin VB.CommandButton cmd_bico 
         ...
         Index           =   7
         Left            =   6540
         Picture         =   "Movimento_Nfce_Auto_ANTIGO.frx":3A4B7
         Style           =   1  'Graphical
         TabIndex        =   19
         ToolTipText     =   "Bico Livre para Abastecimento."
         Top             =   840
      ...
      Begin VB.CommandButton cmd_bico 
         ...
         Index           =   6
         Left            =   5640
         Picture         =   "Movimento_Nfce_Auto_ANTIGO.frx":3C9B9
         Style           =   1  'Graphical
         TabIndex        =   17
         ToolTipText     =   "Bico Livre para Abastecimento."
         Top             =   840
      ...
      Begin VB.CommandButton cmd_bico 
         ...
         Index           =   5
         Left            =   4740
         Picture         =   "Movimento_Nfce_Auto_ANTIGO.frx":3EEBB
         Style           =   1  'Graphical
         TabIndex        =   15
         ToolTipText     =   "Bico Livre para Abastecimento."
         Top             =   840
      ...
      Begin VB.CommandButton cmd_bico 
         ...
         Index           =   3
         Left            =   2940
         Picture         =   "Movimento_Nfce_Auto_ANTIGO.frx":413BD
         Style           =   1  'Graphical
         TabIndex        =   11
         ToolTipText     =   "Bico Livre para Abastecimento."
         Top             =   840
      ...
      Begin VB.CommandButton cmd_bico 
         ...
         Index           =   4
         Left            =   3840
         Picture         =   "Movimento_Nfce_Auto_ANTIGO.frx":438BF
         Style           =   1  'Graphical
         TabIndex        =   13
         ToolTipText     =   "Bico Livre para Abastecimento."
         Top             =   840
      ...
      Begin VB.CommandButton cmd_bico 
         ...
         Index           =   2
         Left            =   2040
         Picture         =   "Movimento_Nfce_Auto_ANTIGO.frx":45DC1
         Style           =   1  'Graphical
         TabIndex        =   9
         ToolTipText     =   "Bico Livre para Abastecimento."
         Top             =   840
      ...
      Begin VB.CommandButton cmd_bico 
         ...
         Index           =   1
         Left            =   1140
         Picture         =   "Movimento_Nfce_Auto_ANTIGO.frx":482C3
         Style           =   1  'Graphical
         TabIndex        =   7
         ToolTipText     =   "Bico Livre para Abastecimento."
         Top             =   840
      ...
      Begin VB.CommandButton cmd_bico 
         ...
         Index           =   0
         Left            =   240
         Picture         =   "Movimento_Nfce_Auto_ANTIGO.frx":4A7C5
         Style           =   1  'Graphical
         TabIndex        =   5
         ToolTipText     =   "Bico Livre para Abastecimento."
         Top             =   840
      ...
      Begin MSDataListLib.DataCombo dtcboCliente 
         Bindings        =   "Movimento_Nfce_Auto_ANTIGO.frx":4CCC7
         Height          =   315
         Left            =   1020
         TabIndex        =   4
         Top             =   360
      ...
      Begin MSDataListLib.DataCombo dtcboProduto 
         Bindings        =   "Movimento_Nfce_Auto_ANTIGO.frx":4CCE2
         Height          =   315
         Left            =   960
         TabIndex        =   75
         Top             =   6420
   ...
   End
End
Attribute VB_Name = "Movimento_Nfce_Auto_ANTIGO"
...
Private Sub AutomacaoAlteraTabeAbastecimento(ByVal pIndiceBico As Integer, ByVal pNumeroCupom As Long)
    ...
    Call CriaLogAutomacao("Movimento_Nfce_Auto_ANTIGO.[AutomacaoAlteraTabeAbastecimento] Rotina Iniciada - pIndiceBico=" & pIndiceBico & " - pNumeroCupom=" & pNumeroCupom)
    ...
    If MovimentoAbastecimento.LocalizarCodigo(g_empresa, lAutomacaoData(pIndiceBico), lAutomacaoHora(pIndiceBico), lAutomacaoBico(pIndiceBico)) Then
        ...
        Call CriaLogAutomacao("Movimento_Nfce_Auto_ANTIGO.[AutomacaoAlteraTabeAbastecimento] ABASTECIMENTO LOCALIZADO - lAutomacaoData(pIndiceBico)=" & lAutomacaoData(pIndiceBico) & " - lAutomacaoHora(pIndiceBico)=" & lAutomacaoHora(pIndiceBico) & " - lAutomacaoBico(pIndiceBico)=" & lAutomacaoBico(pIndiceBico))
        ...
        If Not MovimentoAbastecimento.Alterar(g_empresa, lAutomacaoData(pIndiceBico), lAutomacaoHora(pIndiceBico), lAutomacaoBico(pIndiceBico)) Then
            Call CriaLogAutomacao("Movimento_Nfce_Auto_ANTIGO.[AutomacaoAlteraTabeAbastecimento] NÃO FOI POSSÍVEL BAIXAR O ABASTECIMENTO - lAutomacaoData(pIndiceBico)=" & lAutomacaoData(pIndiceBico) & " - lAutomacaoHora(pIndiceBico)=" & lAutomacaoHora(pIndiceBico) & " - lAutomacaoBico(pIndiceBico)=" & lAutomacaoBico(pIndiceBico))
            MsgBox "Não foi possível alterar o abastecimento!", vbInformation, "Erro de Integridade!"
        Else
            Call CriaLogAutomacao("Movimento_Nfce_Auto_ANTIGO.[AutomacaoAlteraTabeAbastecimento] Abastecimento Baixado com Sucesso - lAutomacaoData(pIndiceBico)=" & lAutomacaoData(pIndiceBico) & " - lAutomacaoHora(pIndiceBico)=" & lAutomacaoHora(pIndiceBico) & " - lAutomacaoBico(pIndiceBico)=" & lAutomacaoBico(pIndiceBico))
        End If
    Else
        Call CriaLogAutomacao("Movimento_Nfce_Auto_ANTIGO.[AutomacaoAlteraTabeAbastecimento] ABASTECIMENTO NÃO LOCALIZADO - lAutomacaoData(pIndiceBico)=" & lAutomacaoData(pIndiceBico) & " - lAutomacaoHora(pIndiceBico)=" & lAutomacaoHora(pIndiceBico) & " - lAutomacaoBico(pIndiceBico)=" & lAutomacaoBico(pIndiceBico))
        MsgBox "Não foi possível localizar abastecimento!", vbInformation, "Erro de Integridade!"
    End If
    Exit Sub
...
Private Sub DespreparaDadosAdicionaisFechamento()
    ...
    cmdDescontoAppPostoAki.Top = 6680
    ...
    btnDescontoCartaoEspecial.Top = 6680
...
Private Sub VerificaDescontoPersonalizado()
    ...
    Call CriaLogMonitoraBug("Monitora Desconto Personalizado", "Movimento_NFce_Auto_ANTIGO", "VerificaDescontoPersonalizado -> As variáveis lDescontoItemEmbutido e lAcrescimoItemEmbutido foram zeradas")
    If Val(l_codigo_cliente) > 0 Then
        Call CriaLogMonitoraBug("Monitora Desconto Personalizado", "Movimento_NFce_Auto_ANTIGO", "Código do Cliente: " & l_codigo_cliente)
        If MovDescontoPersonalizado.LocalizarCodigo(l_codigo_cliente, CLng(dtcboProduto.BoundText)) Then
            Call CriaLogMonitoraBug("Monitora Desconto Personalizado", "Movimento_NFce_Auto_ANTIGO", "Cliente tem preço personalizado. Produto: " & dtcboProduto.BoundText)
            ...
            If MovDescontoPersonalizado.PrecoFixo > 0 Then
                Call CriaLogMonitoraBug("Monitora Desconto Personalizado", "Movimento_NFce_Auto_ANTIGO", "PrecoFixo: " & MovDescontoPersonalizado.PrecoFixo)
                'Valor Fixo
            ...
            ElseIf MovDescontoPersonalizado.Desconto = True Then
                Call CriaLogMonitoraBug("Monitora Desconto Personalizado", "Movimento_Nfce_Auto_ANTIGO", "Desconto = True")
                'Calcula Desconto
                If MovDescontoPersonalizado.ValoraDescontar > 0 Then
                    Call CriaLogMonitoraBug("Monitora Desconto Personalizado", "Movimento_Nfce_Auto_ANTIGO", "ValoraDescontar: " & MovDescontoPersonalizado.ValoraDescontar)
                ...
                Else
                    Call CriaLogMonitoraBug("Monitora Desconto Personalizado", "Movimento_Nfce_Auto_ANTIGO", "PercentualaDescontar: " & MovDescontoPersonalizado.PercentualaDescontar)
                ...
                End If
            Else
                Call CriaLogMonitoraBug("Monitora Desconto Personalizado", "Movimento_Nfce_Auto_ANTIGO", "Desconto = False")
                'Calcula Acréscimo
                If MovDescontoPersonalizado.ValoraDescontar > 0 Then
                    Call CriaLogMonitoraBug("Monitora Desconto Personalizado", "Movimento_Nfce_Auto_ANTIGO", "Valor a acrescentar: " & MovDescontoPersonalizado.ValoraDescontar)
                    txt_valor_unitario.Text = Format(fValidaValor4(txt_valor_unitario.Text) + MovDescontoPersonalizado.ValoraDescontar, "###,###,##0.0000")
                ...
                Else
                    Call CriaLogMonitoraBug("Monitora Desconto Personalizado", "Movimento_Nfce_Auto_ANTIGO", "Percentual a acrescentar: " & MovDescontoPersonalizado.PercentualaDescontar)
                    txt_valor_unitario.Text = Format(fValidaValor4(txt_valor_unitario.Text) + Format((fValidaValor4(txt_valor_unitario.Text) * MovDescontoPersonalizado.PercentualaDescontar / 100), "00000000.0000"), "###,###,##0.0000")
                    lAcrescimoItemEmbutido = fValidaValor(txt_valor_total.Text)
                    txt_valor_total.Text = Format(fValidaValor4(txt_valor_unitario.Text) * fValidaValor(txt_quantidade.Text), "###,##0.00")
                    lAcrescimoItemEmbutido = fValidaValor(txt_valor_total.Text) - lAcrescimoItemEmbutido
        ...
        Else
            ...
            If MovDescontoGrupoCliente.LocalizarCodigo(Cliente.CodigoGrupoCliente, CLng(dtcboProduto.BoundText)) Then
                Call CriaLogMonitoraBug("Monitora Desconto Personalizado", "Movimento_Nfce_Auto_ANTIGO", "Cliente tem Gruo de preço personalizado. Produto: " & dtcboProduto.BoundText + " - Grupo: " + MovDescontoGrupoCliente.CodigoGrupoCliente)
                ...
                If MovDescontoGrupoCliente.PrecoFixo > 0 Then
                    Call CriaLogMonitoraBug("Monitora Desconto Personalizado", "Movimento_Nfce_Auto_ANTIGO", "Grupo PrecoFixo: " & MovDescontoGrupoCliente.PrecoFixo)
                    'Valor Fixo
                ...
                ElseIf MovDescontoGrupoCliente.Desconto = True Then
                    Call CriaLogMonitoraBug("Monitora Desconto Personalizado", "Movimento_Nfce_Auto_ANTIGO", "Grupo Desconto = True")
                    'Calcula Desconto
                    ...
                    End If
                Else
                    Call CriaLogMonitoraBug("Monitora Desconto Personalizado", "Movimento_Nfce_Auto_ANTIGO", "Grupo Desconto = False")
                    'Calcula Acréscimo
                    If MovDescontoGrupoCliente.ValoraDescontar > 0 Then
                        txt_valor_unitario.Text = Format(fValidaValor4(txt_valor_unitario.Text) + MovDescontoGrupoCliente.ValoraDescontar, "###,###,##0.0000")
                        lAcrescimoItemEmbutido = fValidaValor(txt_valor_total.Text)
...
trata_erro:
    Call CriaLogMonitoraBug("Monitora Desconto Personalizado", "Movimento_Nfce_Auto_ANTIGO", "VerificaDescontoPersonalizado -> Erro=" & Err.Number & " - " & Err.Description)
...
Private Function DescontoPersonalizado(ByVal pCodigoCliente As Long, ByVal pCodigoGrupoCliente As Long, ByVal pCodigoProduto As Long, ByVal pValorUnitario As Currency) As Currency
    ...
    Call CriaLogMonitoraBug("Monitora Desconto Personalizado", "Movimento_Nfce_Auto_ANTIGO", "DescontoPersonalizado -> DescontoPersonalizado = 0")
    If Estoque.LocalizarCodigo(g_empresa, pCodigoProduto) Then
        pValorUnitario = Estoque.PrecoVenda
        Call CriaLogMonitoraBug("Monitora Desconto Personalizado", "Movimento_Nfce_Auto_ANTIGO", "pValorUnitario: " & pValorUnitario)
    Else
        Call CriaLogMonitoraBug("Monitora Desconto Personalizado", "Movimento_Nfce_Auto_ANTIGO", "Estoque.LocalizarCodigo = FALSE")
    End If
    If MovDescontoPersonalizado.LocalizarCodigo(pCodigoCliente, pCodigoProduto) Then
        Call CriaLogMonitoraBug("Monitora Desconto Personalizado", "Movimento_Nfce_Auto_ANTIGO", "Encontrado desconto personalizado pro pCodigoCliente: " & pCodigoCliente & " pCodigoProduto: " & pCodigoProduto)
        If MovDescontoPersonalizado.PrecoFixo > 0 Then
            'Valor Fixo
            Call CriaLogMonitoraBug("Monitora Desconto Personalizado", "Movimento_Nfce_Auto_ANTIGO", "MovDescontoPersonalizado.PrecoFixo: " & MovDescontoPersonalizado.PrecoFixo)
        ...
        ElseIf MovDescontoPersonalizado.Desconto = True Then
            'Calcula Desconto
            Call CriaLogMonitoraBug("Monitora Desconto Personalizado", "Movimento_Nfce_Auto_ANTIGO", "MovDescontoPersonalizado.Desconto = TRUE")
            If MovDescontoPersonalizado.ValoraDescontar > 0 Then
                Call CriaLogMonitoraBug("Monitora Desconto Personalizado", "Movimento_Nfce_Auto_ANTIGO", "MovDescontoPersonalizado.ValoraDescontar: " & MovDescontoPersonalizado.ValoraDescontar)
                DescontoPersonalizado = MovDescontoPersonalizado.ValoraDescontar
            Else
                Call CriaLogMonitoraBug("Monitora Desconto Personalizado", "Movimento_Nfce_Auto_ANTIGO", "MovDescontoPersonalizado.PercentualaDescontar: " & MovDescontoPersonalizado.PercentualaDescontar)
                DescontoPersonalizado = Format(pValorUnitario * MovDescontoPersonalizado.PercentualaDescontar / 100, "00000000.0000")
            End If
        Else
            'Calcula Acréscimo
            Call CriaLogMonitoraBug("Monitora Desconto Personalizado", "Movimento_Nfce_Auto_ANTIGO", "MovDescontoPersonalizado.Desconto = FALSE")
            If MovDescontoPersonalizado.ValoraDescontar > 0 Then
                Call CriaLogMonitoraBug("Monitora Desconto Personalizado", "Movimento_Nfce_Auto_ANTIGO", "ACRESCENTAR MovDescontoPersonalizado.ValoraDescontar: " & MovDescontoPersonalizado.ValoraDescontar)
                DescontoPersonalizado = -MovDescontoPersonalizado.ValoraDescontar
            Else
                Call CriaLogMonitoraBug("Monitora Desconto Personalizado", "Movimento_Nfce_Auto_ANTIGO", "ACRESCENTAR MovDescontoPersonalizado.PercentualaDescontar: " & MovDescontoPersonalizado.PercentualaDescontar)
                DescontoPersonalizado = -(Format(pValorUnitario * MovDescontoPersonalizado.PercentualaDescontar / 100, "00000000.0000"))
            End If
        End If
    Else
    'Desconto Por Grupo de Cliente
        If MovDescontoGrupoCliente.LocalizarCodigo(pCodigoGrupoCliente, pCodigoProduto) Then
            Call CriaLogMonitoraBug("Monitora Desconto Personalizado", "Movimento_Nfce_Auto_ANTIGO", "Encontrado desconto MovDescontoGrupoCliente pro pCodigoGrupoCliente: " & pCodigoGrupoCliente & " pCodigoProduto: " & pCodigoProduto)
            If MovDescontoGrupoCliente.PrecoFixo > 0 Then
                'Valor Fixo
                Call CriaLogMonitoraBug("Monitora Desconto Personalizado", "Movimento_Nfce_Auto_ANTIGO", "MovDescontoGrupoCliente.PrecoFixo: " & MovDescontoGrupoCliente.PrecoFixo)
            ...
            ElseIf MovDescontoGrupoCliente.Desconto = True Then
                'Calcula Desconto
                Call CriaLogMonitoraBug("Monitora Desconto Personalizado", "Movimento_Nfce_Auto_ANTIGO", "MovDescontoGrupoCliente.Desconto = TRUE")
                If MovDescontoGrupoCliente.ValoraDescontar > 0 Then
                    Call CriaLogMonitoraBug("Monitora Desconto Personalizado", "Movimento_Nfce_Auto_ANTIGO", "MovDescontoGrupoCliente.ValoraDescontar: " & MovDescontoGrupoCliente.ValoraDescontar)
                    DescontoPersonalizado = MovDescontoGrupoCliente.ValoraDescontar
                Else
                    Call CriaLogMonitoraBug("Monitora Desconto Personalizado", "Movimento_Nfce_Auto_ANTIGO", "MovDescontoGrupoCliente.PercentualaDescontar: " & MovDescontoGrupoCliente.PercentualaDescontar)
                    DescontoPersonalizado = Format(pValorUnitario * MovDescontoGrupoCliente.PercentualaDescontar / 100, "00000000.0000")
                End If
            Else
                'Calcula Acréscimo
                Call CriaLogMonitoraBug("Monitora Desconto Personalizado", "Movimento_Nfce_Auto_ANTIGO", "MovDescontoGrupoCliente.Desconto = FALSE")
                If MovDescontoGrupoCliente.ValoraDescontar > 0 Then
                    Call CriaLogMonitoraBug("Monitora Desconto Personalizado", "Movimento_Nfce_Auto_ANTIGO", "ACRESCENTAR MovDescontoGrupoCliente.ValoraDescontar: " & MovDescontoGrupoCliente.ValoraDescontar)
                    DescontoPersonalizado = -MovDescontoGrupoCliente.ValoraDescontar
                Else
                    Call CriaLogMonitoraBug("Monitora Desconto Personalizado", "Movimento_Nfce_Auto_ANTIGO", "ACRESCENTAR MovDescontoGrupoCliente.PercentualaDescontar: " & MovDescontoGrupoCliente.PercentualaDescontar)
                    DescontoPersonalizado = -(Format(pValorUnitario * MovDescontoGrupoCliente.PercentualaDescontar / 100, "00000000.0000"))
                End If
            End If
        End If
...
trata_erro:
    Call CriaLogMonitoraBug("Monitora Desconto Personalizado", "Movimento_Nfce_Auto_ANTIGO", "DescontoPersonalizado -> Erro=" & Err.Number & " - " & Err.Description)
