...
Begin VB.Form EmissaoNFCeComplementar 
   Caption         =   "Emissão de NFCe Complementar"
   ClientHeight    =   3270
   ClientLeft      =   3990
   ClientTop       =   2010
   ClientWidth     =   6795
   Icon            =   "EmissaoNFCeComplementar.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form2"
   PaletteMode     =   1  'UseZOrder
   Picture         =   "EmissaoNFCeComplementar.frx":030A
   ScaleHeight     =   3270
   ScaleWidth      =   6795
   ...
   Begin VB.CommandButton cmd_visualizar 
      ...
      Height          =   855
      Left            =   1140
      Picture         =   "EmissaoNFCeComplementar.frx":0350
      Style           =   1  'Graphical
      TabIndex        =   10
   ...
   Begin VB.CommandButton cmd_imprimir 
      ...
      Height          =   855
      Left            =   3240
      Picture         =   "EmissaoNFCeComplementar.frx":1A6A
      Style           =   1  'Graphical
      TabIndex        =   11
   ...
   Begin VB.CommandButton cmd_sair 
      ...
      Height          =   855
      Left            =   5160
      Picture         =   "EmissaoNFCeComplementar.frx":3074
      Style           =   1  'Graphical
      TabIndex        =   12
   ...
   Begin VB.Frame frm_dados 
      ...
      Begin VB.CommandButton cmd_data_f 
         Height          =   315
         Left            =   5940
         Picture         =   "EmissaoNFCeComplementar.frx":4706
         Style           =   1  'Graphical
         TabIndex        =   9
      ...
      Begin VB.CommandButton cmd_data_i 
         Height          =   315
         Left            =   2760
         Picture         =   "EmissaoNFCeComplementar.frx":59E0
         Style           =   1  'Graphical
         TabIndex        =   6
         ToolTipText     =   "Selecione a data pelo calendário."
         Top             =   660
      ...
      Begin VB.CommandButton cmd_data 
         Height          =   315
         Left            =   2760
         Picture         =   "EmissaoNFCeComplementar.frx":6CBA
         Style           =   1  'Graphical
         TabIndex        =   3
         ToolTipText     =   "Selecione a data pelo calendário."
         Top             =   240
   ...
   End
End
Attribute VB_Name = "EmissaoNFCeComplementar"
...
Const PROGRAMA_ORIGEM As String = "COMPLEMENTAR"

'Dim xQtdLimite As Currency
Dim lQtdDiferenca As Currency
Dim lTotalDiferenca As Currency
...
Private Sub AtualizaTabelaCupomFiscal(ByVal pNumeroCupom As Long, ByVal pOrdem As Integer, ByVal pData As Date, ByVal pHora As Date, ByVal pCodigoProduto As Long, ByVal pValorUnitario As Currency, ByVal pQuantidade As Currency, ByVal pValorTotal As Currency, ByVal pCodigoAliquota As Integer, ByVal pLinhaArquivo As String)
    ...
    MovimentoCupomFiscal.Telefone = "0"
    ...
    If Not MovimentoCupomFiscal.Incluir Then
        Call CriaLogCupom(Time & " - ERRO Emissão de NFCe Complementar: Erro na Rotina: AtualizaTabelaCupomFiscal - pLinhaArquivo:" & pLinhaArquivo)
...
FileError:
    Call CriaLogCupom(Time & " - Emissão de NFCe Complementar: Erro na Rotina: AtualizaTabelaCupomFiscal - pLinhaArquivo:" & pLinhaArquivo)
...
Private Sub AtualizaTabelaCupomFiscalItem(ByVal pCodigoAliquota As Integer)
    ...
    If Not MovimentoCupomFiscalItem.Incluir Then
        Call CriaLogCupom(Time & " - ERRO Emissão de NFCe Complementar: Erro na Rotina: AtualizaTabelaCupomFiscalItem - ECF:" & MovimentoCupomFiscalItem.NumeroCupom)
        MsgBox "Não foi possível incluir registro de item", vbInformation, "Erro de Integridade!"
    End If
    Exit Sub
    
FileError:
    Call CriaLogCupom(Time & " - Emissão de NFCe Complementar: Erro na Rotina: AtualizaTabelaCupomFiscalItem - ECF:" & MovimentoCupomFiscalItem.NumeroCupom)
    MsgBox "Erro Gravando Cupom: " & Error
    Exit Sub
End Sub
Private Sub AtualizaTabelaDocumentoEletronicoCabecalho(ByVal pNumeroCupom As Long, ByVal pData As Date, ByVal pHora As Date, ByVal pValorTotal As Currency)
    ...
    If Not MovDocEletronicoCabecalho.Incluir Then
        ...
        MsgBox "Não foi possível incluir registro NFCe Cabecalho", vbInformation, "Erro de Integridade!"
    End If
    Exit Sub
...
End Sub
Private Sub AtualizaTabelaDocumentoEletronicoItem(ByVal pNumeroCupom As Long, ByVal pOrdem As Integer, ByVal pData As Date, ByVal pHora As Date, ByVal pCodigoProduto As Long, ByVal pValorUnitario As Currency, ByVal pQuantidade As Currency, ByVal pValorTotal As Currency, ByVal pCodigoAliquota As Integer, ByVal pLinhaArquivo As String)
    'Dim i As Integer
    On Error GoTo trata_erro
    ...
    MovDocEletronicoItem.NumeroTanque = 1
    MovDocEletronicoItem.Cancelado = False
    MovDocEletronicoItem.DataEntradaSaida = pData
    MovDocEletronicoItem.EncerranteFinal = 10000
    MovDocEletronicoItem.NumeroBomba = 1
    MovDocEletronicoItem.NumeroBico = 1
    If Produto.LocalizarCodigo(pCodigoProduto) Then
        MovDocEletronicoItem.TipoCombustivel = Produto.TipoCombustivel
    Else
        MovDocEletronicoItem.TipoCombustivel = "cc"
    End If
...
Private Function AtualizaTabelaSolicitacaoNFCe(ByVal pTipoOperacao As String, ByVal pChaveAcessoNFe As String, ByVal pTexto As String, ByVal pNumeroDaNota As Long) As Boolean
    ...
    MovSolicitacaoFuncaoNFe.SerieNFe_MovSolicitacaoFuncaoNFe = "01" 'Verficar se pode ser utilizado este número
...
Private Sub EnviaDadosParaNFCe(pNumeroCupom As Long, pDataCupom As Date, ByVal pValorTotalNFCe As Currency)
...
'                    AguardaMS (100)
'                Else
'                    gStringChamada = MovSolicitacaoFuncaoNFe.NSU_MovSolicitacaoFuncaoNFe & "|@|" & MovSolicitacaoFuncaoNFe.CodigoEstabelecimento_MovSolicitacaoFuncaoNFe & "|@|" & "2" & "|@|" & "false" & "|@|" & gCNPJEmpresa & "|@|" & "true" & "|@|" & lNumeroCupom & "|@|" & MovDocEletronicoCabecalho.Serie & "|@|" & MovDocEletronicoCabecalho.DataEmissao & "|@|" & MovDocEletronicoCabecalho.Modelo & "|@|"   '1-Oobj TXT, 2-Oobj XML, 3-cerrado
...
'
'            Else
'                gStringChamada = MovSolicitacaoFuncaoNFe.NSU_MovSolicitacaoFuncaoNFe & "|@|" & MovSolicitacaoFuncaoNFe.CodigoEstabelecimento_MovSolicitacaoFuncaoNFe & "|@|" & "1" & "|@|" & "false" & "|@|" & gCNPJEmpresa & "|@|" & "true" & "|@|" & lNumeroCupom & "|@|" & MovDocEletronicoCabecalho.Serie & "|@|" & MovDocEletronicoCabecalho.DataEmissao & "|@|" & MovDocEletronicoCabecalho.Modelo & "|@|"   '1-Oobj TXT, 2-Oobj XML, 3-cerrado
'                'gStringChamada = MovSolicitacaoFuncaoNFe.NSU_MovSolicitacaoFuncaoNFe & "|@|" & MovSolicitacaoFuncaoNFe.CodigoEstabelecimento_MovSolicitacaoFuncaoNFe & "|@|" & "1" & "|@|" & "false" & "|@|" & gCNPJEmpresa & "|@|" '1-Oobj TXT, 2-Oobj XML, 3-cerrado
'                Call menu_personalizado.GravaSgpNetCadastroIni("ProcessaNFCe")
'            End If
            
            
            If lNFCeComplementarSemRetorno = True Then
                'gStringChamada = MovSolicitacaoFuncaoNFe.NSU_MovSolicitacaoFuncaoNFe & "|@|" & MovSolicitacaoFuncaoNFe.CodigoEstabelecimento_MovSolicitacaoFuncaoNFe & "|@|" & "1" & "|@|" & "false" & "|@|" & gCNPJEmpresa & "|@|" & "false" & "|@|" & lNumeroCupom & "|@|" & MovDocEletronicoCabecalho.Serie & "|@|" & MovDocEletronicoCabecalho.DataEmissao & "|@|" & MovDocEletronicoCabecalho.Modelo & "|@|"   '1-Oobj TXT, 2-Oobj XML, 3-cerrado
                gStringChamada = MovSolicitacaoFuncaoNFe.NSU_MovSolicitacaoFuncaoNFe & "|@|" & MovSolicitacaoFuncaoNFe.CodigoEstabelecimento_MovSolicitacaoFuncaoNFe & "|@|" & "2" & "|@|" & "false" & "|@|" & gCNPJEmpresa & "|@|" & "false" & "|@|" & lNumeroCupom & "|@|" & MovDocEletronicoCabecalho.Serie & "|@|" & MovDocEletronicoCabecalho.DataEmissao & "|@|" & MovDocEletronicoCabecalho.Modelo & "|@|"   '1-Oobj TXT, 2-Oobj XML, 3-cerrado
            Else
                'gStringChamada = MovSolicitacaoFuncaoNFe.NSU_MovSolicitacaoFuncaoNFe & "|@|" & MovSolicitacaoFuncaoNFe.CodigoEstabelecimento_MovSolicitacaoFuncaoNFe & "|@|" & "1" & "|@|" & "false" & "|@|" & gCNPJEmpresa & "|@|" & "true" & "|@|" & lNumeroCupom & "|@|" & MovDocEletronicoCabecalho.Serie & "|@|" & MovDocEletronicoCabecalho.DataEmissao & "|@|" & MovDocEletronicoCabecalho.Modelo & "|@|"   '1-Oobj TXT, 2-Oobj XML, 3-cerrado
                gStringChamada = MovSolicitacaoFuncaoNFe.NSU_MovSolicitacaoFuncaoNFe & "|@|" & MovSolicitacaoFuncaoNFe.CodigoEstabelecimento_MovSolicitacaoFuncaoNFe & "|@|" & "2" & "|@|" & "false" & "|@|" & gCNPJEmpresa & "|@|" & "true" & "|@|" & lNumeroCupom & "|@|" & MovDocEletronicoCabecalho.Serie & "|@|" & MovDocEletronicoCabecalho.DataEmissao & "|@|" & MovDocEletronicoCabecalho.Modelo & "|@|"   '1-Oobj TXT, 2-Oobj XML, 3-cerrado
            ...
            Call CriaLogCupom("[EnviaDadosParaNFCe] - NFCE Complementar: gStringChamada=" & gStringChamada)
            
            If lPetromovelAutorizaNFCe = True Then
                Call CriaLogCupom("[EnviaDadosParaNFCe] - NFCE Complementar: PETROMOVELAUTO AUTORIZA NFCE - ConfiguracaoDiversa.Verdadeiro=True")
                If Not GravaSolicitacaoProcessamentoNFCe(MovSolicitacaoFuncaoNFe.NumeroNFe_MovSolicitacaoFuncaoNFe, gStringChamada) Then
                    Call CriaLogCupom("[EnviaDadosParaNFCe] - NFCE Complementar: Não foi possível gravar a Solicitação do processamento para NFC-e!")
                    MsgBox "Não foi possível gravar a Solicitação do processamento para NFC-e!", vbCritical, "Erro de Integridade"
                End If
                gStringChamada = ""
            Else
                Call CriaLogCupom("[EnviaDadosParaNFCe] - NFCE Complementar: PETROMOVELAUTO AUTORIZA NFCE - ConfiguracaoDiversa.Verdadeiro=False")
                Call menu_personalizado.GravaSgpNetCadastroIni("ProcessaNFCe")
            End If
...
'---- DADOS DO PAGAMENTO -----
    ...
    xMensagem = CalculaImpostos(lNumeroCupom, lDataCupom) & "\n"
...
Private Function MontaTextoCabecalhoSolicitacaoNFCE_OLD(ByVal pRsDadosParaNFCe As adodb.Recordset, ByVal pValorTotalNFCe As Currency) As String

    MontaTextoCabecalhoSolicitacaoNFCE_OLD = Empty
...
'    If Val(pRsDadosParaNFCe("Codigo do Cliente").Value) > 0 Then
'        If Cliente.LocalizarCodigo(pRsDadosParaNFCe("Codigo do Cliente").Value) Then
...
'    End If
    ...
    'NÃO NECESSÁRIO PARA NFCE MANTIDO APENAS PARA CONSERVAR PADRÃO
    xStringNfce = xStringNfce & "001-000 = " & Format(gNumeroControleSolicitacao, "0000000000") & "|@|" & vbCrLf 'OBTER DADOS REAIS - MÉTODO PARA GERA CONTROLE DE SOLICITAÇÃO
    xStringNfce = xStringNfce & "002-000 = " & gVersaoSGP & "|@|" & vbCrLf
    xStringNfce = xStringNfce & "040-000 = " & g_empresa & "|@|" & vbCrLf 'OBTER DADOS REAIS
    xStringNfce = xStringNfce & "041-000 = " & "TEIXEIRA E PINHEIRO LTDA" & "|@|" & vbCrLf 'OBTER DADOS REAIS
    xStringNfce = xStringNfce & "042-000 = " & "3" & "|@|" & vbCrLf 'CRT 1-SIMPLES NACIONAL, 3-REGIME NORMAL
    ...
    xStringNfce = xStringNfce & "112-000 = " & xSerie & "|@|" & vbCrLf

'---- DADOS DO PAGAMENTO -----
    'xStringNfce = xStringNfce & "113-001 = " & pRsDadosParaNFCe("Forma de Pagamento").Value & "|@|" & vbCrLf 'Forma de Pagamento 1=vista 2=prazo
    xStringNfce = xStringNfce & "113-001 = " & "01" & "|@|" & vbCrLf 'Forma de Pagamento: 01-Diheiro
...
'---- DADOS DA EMPRESA EMITENTE ----
    ...
    MontaTextoCabecalhoSolicitacaoNFCE_OLD = xStringNfce
...
Private Function MontaTextoInformacoesComplementaresNFCe() As String
    ...
    xLinhaImpostos = CalculaImpostos(lNumeroCupom, lDataCupom) & "\n"
    
    xLinhaImpostos = xLinhaImpostos & "Cerrado Tecnologia - Soluções Inteligentes\n"
    xLinhaImpostos = xLinhaImpostos & "Fone: (62) 3277-1017\n"

    
    If Not Trim(xLinhaImpostos) = Empty Then
        xTextoInformacoesComplementares = xTextoInformacoesComplementares & xLinhaImpostos & "\n"
    End If
End Function
...
Private Function CalculaImpostos(x_numero_cupom As Long, x_data As Date) As String
    ...
    Do Until MovimentoCupomFiscal.LocalizarNumeroProximaOrdem(g_empresa, lNumeroPDV, x_numero_cupom, x_data, xOrdem) = False
        If MovimentoCupomFiscal.ItemCancelado = False And MovimentoCupomFiscal.CupomCancelado = False Then
            'Call CriaLogCupom("CalculaImpostos: Fase 2 a - MovCupomFiscal.CodigoProduto=" & MovCupomFiscal.CodigoProduto)
            If Produto.LocalizarCodigo(MovimentoCupomFiscal.CodigoProduto) Then
                If LocalizarNCM(0, Produto.CodigoNCM) Then
                    xBaseCalculo = MovimentoCupomFiscal.ValorTotal
            ...
            End If
        End If
        xOrdem = MovimentoCupomFiscal.Ordem
    Loop
...
Private Function MontaTextoItensSolicitacaoNFCE(ByVal pRsDadosParaNFCe As adodb.Recordset) As String
    ...
    Do Until pRsDadosParaNFCe.EOF
        ...
        'xEncerranteFinal = 10000 + pRsDadosParaNFCe("IdProduto_MovDEItem").Value
...
Private Function MontaTextoItensSolicitacaoNFCE_OLD(ByVal pRsDadosParaNFCe As adodb.Recordset) As String

    MontaTextoItensSolicitacaoNFCE_OLD = Empty
    Dim xOrdem As Integer
    Dim xStringNfce As String
    ...
    Do Until pRsDadosParaNFCe.EOF
        ...
        xStringNfce = xStringNfce & "831-" & Format(xOrdem, "000") & " = 5656" & "|@|" & vbCrLf '& dvItensNF(i)("CFOP") & "|@|" & vbCrLf 'CFOP
        xStringNfce = xStringNfce & "832-" & Format(xOrdem, "000") & " = 0" & "|@|" & vbCrLf
        'Aliquota Cofins
        xStringNfce = xStringNfce & "833-" & Format(xOrdem, "000") & " = 0" & "|@|" & vbCrLf '& xCodigoUfEmitente & "|@|" & vbCrLf 'CodEstadoIde
        xStringNfce = xStringNfce & "834-" & Format(xOrdem, "000") & " = 0" & "|@|" & vbCrLf '& "0" & "|@|" & vbCrLf 'ValorIPIProd
        ...
        xStringNfce = xStringNfce & "836-" & Format(xOrdem, "000") & " = 0" & "|@|" & vbCrLf '& lPisPercentual & "|@|" & vbCrLf 'ValorPISProd
        xStringNfce = xStringNfce & "837-" & Format(xOrdem, "000") & " = " & RetornaValorImpostoProdutoNFCE(pRsDadosParaNFCe("ValorTotalLiquido_MovDEItem").Value, pRsDadosParaNFCe("Aliquota do Imposto").Value) & "|@|" & vbCrLf '& FormatNumber(lIcmsValor, 4) & "|@|" & vbCrLf 'ValorIcmsProd
        xStringNfce = xStringNfce & "838-" & Format(xOrdem, "000") & " = 0" & "|@|" & vbCrLf  'ValorBCICMSProd
        xStringNfce = xStringNfce & "839-" & Format(xOrdem, "000") & " = " & "0" & "|@|" & vbCrLf 'AliquotaIPIProd
        xStringNfce = xStringNfce & "840-" & Format(xOrdem, "000") & " = 0" & FormatNumber(pRsDadosParaNFCe("Aliquota do Imposto").Value, 4) & "|@|" & vbCrLf 'AliquotaICMSProd
        ...
        'Bomba ESTÁ SENDO GRAVADO NO CAMPO DE NUMERO DO CHEQUE (POSIÇÕES 1 e 2) DA TABELA MOVIMENTO_CUPOOM_FISCAL
        xStringNfce = xStringNfce & "860-" & Format(xOrdem, "000") & " = " & pRsDadosParaNFCe("NumeroBomba_MovDEItem").Value & "|@|" & vbCrLf
        
        'Bico ESTÁ SENDO GRAVADO NO CAMPO DE NUMERO DO CHEQUE (POSIÇÕES 3 e 4) DA TABELA MOVIMENTO_CUPOOM_FISCAL
        xStringNfce = xStringNfce & "861-" & Format(xOrdem, "000") & " = " & pRsDadosParaNFCe("NumeroBico_MovDEItem").Value & "|@|" & vbCrLf
        
        'tanque ESTÁ SENDO GRAVADO NO CAMPO DE NUMERO DO CHEQUE (POSIÇÕES 5 e 6) DA TABELA MOVIMENTO_CUPOOM_FISCAL
        xStringNfce = xStringNfce & "862-" & Format(xOrdem, "000") & " = " & pRsDadosParaNFCe("NumeroTanque_MovDEItem").Value & "|@|" & vbCrLf
     ...
     MontaTextoItensSolicitacaoNFCE_OLD = xStringNfce
...
Private Sub Relatorio()
    ...
    If lCaixaIndividual And chbPorFuncionario.Value = 1 Then
        ...
        Else
            Call CriaLogCupom(Time & " - Emissão de NFCe Complementar: Foi Informado ao Usuário que Não Existia abastecimento deste funcionário no Período.")
    ...
    Else
        ...
        Else
            Call CriaLogCupom(Time & " - Emissão de NFCe Complementar: Foi Informado ao Usuário que Não Existia Movimento de Bomba Digitado no Período.")
...
Private Sub ImpDados()
    ...
    For i = 1 To 7
        ...
        'aquiaqui
        Call TotalizaMovimentoDocFiscais(lTipoCombustivel(i))
        ...
        If Not rst.EOF Then
            ...
            If Not rst2.EOF Then
                ...
                Else
                    ...
                    Call CriaLogCupom(Time & " - Emissão de NFCe Complementar: Erro ao localizar preço de venda do produto: " & rst2!Codigo)
                ...
                'lQtdDiferenca = Qtd Venda Bomba - Qtd Venda Cupom
                lQtdDiferenca = lQtdBombaV(i) - lQtdCupomV(i)
                lTotalDiferenca = lQtdDiferenca * xPrecoUsado
                ...
                xStrLogAuditoria = "Qtd Bomba: " & lQtdBombaV(i) & " - Qtd Cupom: " & lQtdCupomV(i) & " - Qtd Diferença: " & lQtdDiferenca
                xStrLogAuditoria = "Total Bomba: " & lTotalBombaV(i) & " - Total Cupom: " & lTotalCupomV(i) & " - Total Diferença: " & lTotalDiferenca
                Call CriaLogCupom(xStrLogAuditoria)
                Call GravaAuditoria(1, Me.name, 33, xStrLogAuditoria)
                
                ' Busca Quantidade de Limite para Impressão de NFCe Complementar
...
'                    If xQtdLimite < lQtdDiferenca Then
'
'                        xQtdNaoImpressa = lQtdDiferenca - xQtdLimite
'
'                        xStrLogAuditoria = "Qtd Diferença passou de: " & lQtdDiferenca
'                        lQtdDiferenca = xQtdLimite
'                        xStrLogAuditoria = xStrLogAuditoria & " para: " & lQtdDiferenca & " que é o limite configurado. "
...
'                        Call GravaAuditoria(1, Me.name, 33, xStrLogAuditoria)
'                    Else
'                        xStrLogAuditoria = "O limite: " & xQtdLimite & " está acima da Diferença: " & lQtdDiferenca
'                        Call CriaLogCupom(xStrLogAuditoria)
'                        Call GravaAuditoria(1, Me.name, 33, xStrLogAuditoria)
'                    End If
                    'Tasso em 23/08/2016
                    If xQtdLimite < lQtdDiferenca Then
                        ...
                        'Move o limite para as variaveis abaixo
                        'lQtdBombaV(i) = xQtdLimite
                        'lQtdCupomV(i) = 0
                        'lTotalBombaV(i) = lTotalDiferenca
                        'lTotalCupomV(i) = 0
                        xQtdCupomAImprimir = xQtdLimite
                        xValorCupomAImprimir = lTotalDiferenca
...
'                If PrevisaoVendaPrazo.GravaVendaPrazoDia(g_empresa, lTipoCombustivel(i), CDate(msk_data_i.Text), lQtdDiferenca, lQtdBombaV(i)) Then
'                    Call CriaLogCupom(Time & " - Emissão de NFCe Complementar: GravaVendaPrazoDia OK: ")
'                Else
'                    Call CriaLogCupom(Time & " - Emissão de NFCe Complementar: ERRO GravaVendaPrazoDia : TipoCombustivel:" & lTipoCombustivel(i) & " - Data:" & msk_data_i.Text & " - Qtd.Diferença:" & lQtdDiferenca & " - Qtd.BombaV:" & lQtdBombaV(i))
'                End If
...
'                Else
'                    Call CriaLogCupom(Time & " - Emissão de NFCe Complementar: xQTD = 0  TipoCombustivel:" & lTipoCombustivel(i) & " - Data:" & msk_data_i.Text & " - Qtd.Diferença:" & lQtdDiferenca & " - Qtd.BombaV:" & lQtdBombaV(i))
'                End If
...
'                    If lQtdDiferenca >= 10000 Then 'new 10/08/2016
'
'                        Dim xDiferencaQtdTotal As Currency
'                        Dim xDiferencaValorTotal As Currency
'                        Dim xQtdCupomAImprimir As Currency
...
'                    End If
                    'Tasso em 23/08/2016
                    If lTotalDiferenca >= 10000 Then
                            
                        xDiferencaQtdTotal = lQtdBombaV(i) - lQtdCupomV(i)
                        xDiferencaValorTotal = lTotalBombaV(i) - lTotalCupomV(i)
                            
                        Do Until xDiferencaValorTotal < 9500
                            xValorCupomAImprimir = 9500
                            xQtdCupomAImprimir = Round(xValorCupomAImprimir / xPrecoUsado, 2)
                                
                            xDiferencaQtdTotal = xDiferencaQtdTotal - xQtdCupomAImprimir
                            xDiferencaValorTotal = xDiferencaValorTotal - xValorCupomAImprimir
                            Call ImpDet(rst![Codigo do Produto], rst2!Nome, rst2!Unidade, 0, 0, xQtdCupomAImprimir, xValorCupomAImprimir, xQtdCupomAImprimir, xValorCupomAImprimir, rst2![Codigo da Aliquota], xPrecoUsado)
                        Loop
                        Call ImpDet(rst![Codigo do Produto], rst2!Nome, rst2!Unidade, 0, 0, xDiferencaQtdTotal, xDiferencaValorTotal, xDiferencaQtdTotal, xDiferencaValorTotal, rst2![Codigo da Aliquota], xPrecoUsado)
                    Else
                        'Aqui imprime quando a diferença for menor que R$ 10.000,00
                        Call ImpDet(rst![Codigo do Produto], rst2!Nome, rst2!Unidade, lQtdCupomV(i), lTotalCupomV(i), lQtdBombaV(i), lTotalBombaV(i), lQtdBombaV(i) - lQtdCupomV(i), lTotalBombaV(i) - lTotalCupomV(i), rst2![Codigo da Aliquota], xPrecoUsado)
                    End If
                        
                    
                Else
                    'Aqui é somente quando pede pra visualizar
                    Call ImpDet(rst![Codigo do Produto], rst2!Nome, rst2!Unidade, lQtdCupomV(i), lTotalCupomV(i), lQtdBombaV(i), lTotalBombaV(i), xQtdCupomAImprimir, xValorCupomAImprimir, rst2![Codigo da Aliquota], xPrecoUsado)
                End If
...
'        rst.Close
    ...
    If lPagina > 0 Then
        ...
        BioFechaImprime
        If lLocal = 1 Then
            'If (MsgBox("Após a emissão de NFCe complementar será impresso a REDUÇÃO Z." & Chr(13) & "E não será mais aceito a emissão de cupom fiscal nesta data." & Chr(13) & Chr(13) & "Deseja realmente imprimir o cupom complementar?", vbQuestion + vbYesNo + vbDefaultButton2, "Emissão de NFCe Complementar")) = 6 Then
            If lImprimeCupomComplementar Then
                ImpCupomComplementar
                Call CriaLogCupom(Time & " - Emissão de NFCe Complementar: O Usuário foi Informado da Conclusão da Impressão")
                MsgBox "Impressão de NFCe complementar concluída", vbInformation, "Impressão Concluída!"
            End If
            'End If
        Else
            g_string = lLocal & lNomeArquivo & "|@|Emissão de NFCe Complementar|@|"
            frm_preview.Show 1
        End If
    End If
End Sub
Private Sub ImpDet(pCodigo As Long, pNome As String, pUnidade As String, pQtdCupom As Currency, pValorCupom As Currency, pQtdBomba As Currency, pValorBomba As Currency, pQtdAImprimir As Currency, pValorAImprimir As Currency, pCodigoAliquota As Integer, pPrecoVenda As Currency)
    ...
    If lLinha >= 60 Then
        x_linha = "+------+-------------------------------------------+---+----------+---------------+----------+---------------+----------+---------------+"
        Mid(x_linha, 12, 21) = " Cerrado Tecnologia. "
    ...
    Mid(x_linha, 57 + 10 - i, i) = Format(pQtdCupom, "###,##0.00")
    i = Len(Format(pValorCupom, "###,###,##0.00"))
    Mid(x_linha, 69 + 14 - i, i) = Format(pValorCupom, "###,###,##0.00")
    i = Len(Format(pQtdBomba, "###,###,##0.00"))
    Mid(x_linha, 80 + 14 - i, i) = Format(pQtdBomba, "###,###,##0.00")
    i = Len(Format(pValorBomba, "###,###,##0.00"))
    Mid(x_linha, 96 + 14 - i, i) = Format(pValorBomba, "###,###,##0.00")
    
    'ao inves de imprimir a quantidade que esta na bomba - a quantidade de cupom
    'irá imprimir o valor da variavel lQtdDiferenca (que é o valor que foi configurado como limite)

    'xQtd = Format(xQtdBomba - xQtdCupom, "000,000,000.000") 'old 10/08/2016
    xQtd = Format(lQtdDiferenca, "000,000,000.000") 'new 10/08/2016
    ...
    BioImprime "@Printer.Print " & x_linha
    lLinha = lLinha + 1
    If lLocal = 1 And pQtdAImprimir > 0 Then
        'If (xQtdBomba - xQtdCupom) > 0 Then
            i = Len(Trim(pNome))
            Mid(xNome_produto, 1, i) = Trim(pNome)
            x_linha = Format(pCodigo, "00000")
            x_linha = x_linha & xNome_produto
            x_linha = x_linha & Mid(pUnidade, 1, 2)
            x_linha = x_linha & Format(pCodigoAliquota, "00")
            x_linha = x_linha & Format(pQtdAImprimir, "000000000.000")
            x_linha = x_linha & Format(pPrecoVenda, "0000000000.0000")
            x_linha = x_linha & Format(pValorAImprimir, "0000000000.00")
            'Print #3, x_linha
...
Private Sub LoopImprimeEncerrante()
    ...
    Call CriaLogCupom(Time & " - Emissão de NFCe Complementar: Início da Impressão dos Encerrantes")
    xValor = 0
    xQuantidade = 0
    xUltimoPeriodo = 0
    ...
    If Not rstMovimentoBomba.EOF Then
        ...
        If IsNull(rstMovimentoBomba("Periodo")) Then
            xUltimoPeriodo = 1
        Else
    ...
    Call CriaLogCupom(Time & " - Emissão de NFCe Complementar: lSQL=" & lSQL)
    Set rstMovimentoBomba = Conectar.RsConexao(lSQL)
    If Not rstMovimentoBomba.EOF Then
        rstMovimentoBomba.MoveFirst
        For i = 1 To lQtdBico
    ...
    Call CriaLogSGP(Time & " - Emissão de NFCe Complementar: TOTAL=" & xLinha, "", "")
    Call ImpTermicaFechaRelatorio(lNomeRelatorio)
    Call CriaLogSGP(Time & " - Emissão de NFCe Complementar: Foi Concluído a Impressão dos Encerrantes", "", "")
End Sub
Private Sub ImprimeEncerranteAutomacaoAtual()
    'Relatório Gerencial
    Dim i As Integer
    Dim i2 As Integer
    Dim xString As String
    ...
    lNomeRelatorio = "Relatório de Encerrantes ATUAL"
    ImpTermicaAbreRelatorio
    Call ImpTermicaCabecalhoPosto
...
'                xQuantidade = xQuantidade + rstMovimentoBomba("Quantidade da Saida").Value
    ...
    'xString = xString & xLinha
    Call ImpTermicaImprimeDados("------------------------------------------------", True)
    Call CriaLogCupom(Time & " - Emissão de NFCe Complementar: TOTAL=" & xLinha)
    Call ImpTermicaFechaRelatorio(lNomeRelatorio)
    Call CriaLogCupom(Time & " - Emissão de NFCe Complementar: Foi Concluído a Impressão dos Encerrantes")
End Sub
...
'    i = Len(Format(lQtdBombaV(1) - lQtdCupomV(1), "##,##0.000")) 'old 10/08/2016
'    Mid(x_linha, 111 + 10 - i, i) = Format(lQtdBombaV(1) - lQtdCupomV(1), "##,##0.000") 'old 10/08/2016
    
    i = Len(Format(lQtdDiferenca, "##,##0.000"))  'new 10/08/2016
    Mid(x_linha, 111 + 10 - i, i) = Format(lQtdDiferenca, "##,##0.000") 'new 10/08/2016
...
'    Printer.Print x_linha
    ...
    x_linha = "+------------------------------------------------------+----------+---------------+----------+---------------+----------+---------------+"
    Mid(x_linha, 5, 21) = " Cerrado Tecnologia. "
    BioImprime "@Printer.Print " & x_linha
...
Private Sub ImpCupomComplementar()
    ...
    Do Until gArquivoTXT.AtEndOfStream
        ...
        If Mid(x_linha, 1, 3) = "FIM" Then
            Exit Do
        End If
        Call CriaLogCupom(Time & " - Emissão de NFCe Complementar: Foi Acionado a Emissão do C.F. de " & Format(Mid(x_linha, 51, 13), "0000.000") & " " & Mid(x_linha, 46, 3) & " de " & Mid(x_linha, 6, 40))
        ...
        Call AtualizaTabelaDocumentoEletronicoCabecalho(lNumeroCupom, lDataCupom, lHoraCupom, xValorTotal)
        Call GravaDocumentoEletronicoEvento(MovDocEletronicoCabecalho, EVENTO_NFCE.ABERTA_COMPLEMENTAR)

        Call AtualizaTabelaDocumentoEletronicoItem(lNumeroCupom, lOrdemCupom, lDataCupom, lHoraCupom, xCodigoProduto, xValorUnitario2, xQuantidade2, xValorTotal, xCodigoAliquota, x_linha)
        ...
        Call EnviaDadosParaNFCe(lNumeroCupom, lDataCupom, xValorTotal)
        Call CriaLogCupom(Time & " - Emissão de NFCe Complementar: Foi enviado os dados para NFCe - Nº " & lNumeroCupom & " Dt. " & lDataCupom & "  Valor: " & xValorTotal)
        'MsgBox "Aguarde o Retorno e Tecle Enter", vbInformation, "Aguarde"
        
        
        Call CriaLogCupom(Time & " - Emissão de NFCe Complementar: Foi Impresso o C.F. de " & Format(Mid(x_linha, 51, 13), "0000.000") & " " & Mid(x_linha, 46, 3) & " de " & Mid(x_linha, 6, 40))
...
ErroImpCupomComplementar:
    Call CriaLogCupom(Time & " - Emissão de NFCe Complementar: Erro ImpCupomComplementar - " & x_linha & " ERRO: " & Err.Description)
    Exit Sub
End Sub
Private Sub AguardaProcessamentoNFCe(ByVal pNSU As Long, ByVal pTipoCombustivel As String)
    ...
    On Error GoTo ErroAguardaProcessamentoNFCe
    
    Call TelaAguarde("Aguarde! Processando NFCe... NSU(" & pNSU & ")", True, pTipoCombustivel)
    Call frmAguarde.IniciaContador(120, 250)
    DoEvents
    xProcessamentoConcluido = False
    
    
    xHoraInicial = Time
    'Fica até 120 segundos
    Do Until DateDiff("s", xHoraInicial, Time) >= 120
        Call AguardaMS(1000)
        If MovSolicitacaoFuncaoNFe.LocalizarNSU(g_empresa, pNSU) Then
            If MovSolicitacaoFuncaoNFe.HoraAprovacao_MovSolicitacaoFuncaoNFe <> CDate("00:00:00") Or MovSolicitacaoFuncaoNFe.HoraCancelamentoHost_MovSolicitacaoFuncaoNFe <> CDate("00:00:00") Then
                ...
                Call CriaLogCupom(Time & " - Emissão de NFCe Complementar: AguardaProcessamentoNFCe - Processamento Concluído NSu: " & pNSU & " Comb. " & pTipoCombustivel)
                Exit Do
            End If
        End If
        DoEvents
    ...
    If xProcessamentoConcluido = True Then
        If MovSolicitacaoFuncaoNFe.HoraAprovacao_MovSolicitacaoFuncaoNFe <> CDate("00:00:00") Then
            ...
            Call CriaLogCupom(Time & " - Emissão de NFCe Complementar: AguardaProcessamentoNFCe - NFCe Complementar AUTORIZADA NSU: " & pNSU & " Comb. " & pTipoCombustivel)
        ...
        ElseIf MovSolicitacaoFuncaoNFe.HoraCancelamentoHost_MovSolicitacaoFuncaoNFe <> CDate("00:00:00") Then
            Call CriaLogCupom(Time & " - Emissão de NFCe Complementar: AguardaProcessamentoNFCe - NFCe NÃO foi Autorizada NSU: " & pNSU & " Comb. " & pTipoCombustivel)
            MsgBox "NFCe NÃO foi Autorizada!" & vbCrLf & "Mensagem: " & MovSolicitacaoFuncaoNFe.Mensagem_MovSolicitacaoFuncaoNFe, vbCritical, "ERRO ao Processar NFCe Complementar!"
        Else
            Call CriaLogCupom(Time & " - Emissão de NFCe Complementar: AguardaProcessamentoNFCe - Não será possível definir o processamento da NFCe Complementar NSU: " & pNSU & " Comb. " & pTipoCombustivel)
            MsgBox "Não será possível definir o processamento da NFCe Complementar.", vbCritical, "Erro de Integridade!"
        End If
    Else
        Call CriaLogCupom(Time & " - Emissão de NFCe Complementar: AguardaProcessamentoNFCe - Tempo de solicitação de Processamento de NFCe Complementar excedido NSU: " & pNSU & " Comb. " & pTipoCombustivel)
...
ErroAguardaProcessamentoNFCe:
    Call CriaLogCupom(Time & " - Emissão de NFCe Complementar: Erro ErroAguardaProcessamentoNFCe - " & pNSU & "ERRO: " & Err.Description)
    Exit Sub
End Sub
...
Private Sub TelaAguarde(ByVal pMensagem As String, ByVal pMostraAguarde As Boolean, ByVal pTipoCombustivel As String)
    If pMostraAguarde Then
        frmAguarde.Show
        Call frmAguarde.MostraMensagens(pMensagem, Me.Caption & " - " & pTipoCombustivel, Me.Top, Me.Left, Me.Width, Me.Height)
        DoEvents
    Else
...
Private Sub cmd_imprimir_Click()
    ...
    Call CriaLogCupom(Time & " - Emissão de NFCe Complementar: Foi Pedido a Impressão do Período de: " & msk_data_i.Text & " a " & msk_data_f.Text)
    ...
    If ValidaCampos Then
        ...
        g_string = "imprimiu|@|"
        Relatorio
        Call CriaLogCupom(Time & " - Emissão de NFCe Complementar: Foi Impresso")
    End If
    If ValidaCampos Then
        'Sleep 10000
    ...
    Exit Sub
ErroImprimir:
    Call CriaLogCupom(Time & " - Emissão de NFCe Complementar: Erro ao abrir o arquivo CUPOM_COMPLEMENTAR.TXT")
    Call AtivaBotoes(True)
    Exit Sub
End Sub
...
Private Sub TotalizaAcertoVendaECF()
    ...
    For i = 1 To 7
        If AcertoVendaECF.LocalizarCodigo(g_empresa, CDate(msk_data_i.Text), lTipoCombustivel(i)) Then
            Call CriaLogCupom(Time & " - Emissão de NFCe Complementar: AcertoVendaECF:" & msk_data_i.Text & " Comb:" & lTipoCombustivel(i) & " " & AcertoVendaECF.Operacao & " Qtd:" & AcertoVendaECF.Quantidade)
...
Private Sub TotalizaMovimentoAfericao()
    ...
    For i = 1 To 7
        If lQtdAfericaoV(i) > 0 Then
            ...
            Call CriaLogCupom(Time & " - [Emissão de NFCe Complementar - AFERICAO ] À Vista - Combustivel:" & lTipoCombustivel(i) & " - Lts.Aferição:" & lQtdAfericaoV(i))
        End If
    Next
End Sub
...
Private Sub TotalizaMovimentoBombaCupom()
    ...
    End With
End Sub
Private Sub TotalizaMovimentoDocFiscais(ByVal pTipoCombustivel As String)
    Dim i As Integer
    lSQL = ""
    lSQL = lSQL & "SELECT SUM(ValorTotalLiquido_MovDEItem) AS TotalNFCe, SUM(Quantidade_MovDEItem) AS QtdNFCe"
    ...
    lSQL = lSQL & "   AND Modelo_MovDEItem = " & preparaTexto(MODELO_NFCE)
    lSQL = lSQL & "   AND DataEmissao_MovDEItem >= " & preparaData(CDate(msk_data_i.Text))
    lSQL = lSQL & "   AND DataEmissao_MovDEItem <= " & preparaData(CDate(msk_data_f.Text))
    lSQL = lSQL & "   AND Cancelado_MovDEItem = " & preparaBooleano(False)
    'lSQL = lSQL & "   AND EtapaConcluida_MovDEItem = 9"
    ' Se colocar = 9, entao qualquer NFCe pendente irá imprimir novamente se tiver Autorizada na Sefaz
    ' e no cliente ainda não estiver Autorizada
    lSQL = lSQL & "   AND TipoCombustivel_MovDEItem = " & preparaTexto(pTipoCombustivel)
    Set rst = Conectar.RsConexao(lSQL)
    If Not rst.EOF Then
        For i = 1 To 7
            If lTipoCombustivel(i) = pTipoCombustivel Then
                If Not IsNull(rst!QtdNFCe) Then
                    lQtdCupomV(i) = rst!QtdNFCe
                    lTotalCupomV(i) = rst!TotalNFCe
                End If
                Exit For
            End If
        Next
        ...
        For i = 1 To 7
            If lTipoCombustivel(i) = pTipoCombustivel Then
                If Not IsNull(rst!QtdCupom) Then
                    lQtdCupomV(i) = lQtdCupomV(i) + rst!QtdCupom
                    lTotalCupomV(i) = lTotalCupomV(i) + rst!TotalCupom
                End If
                Exit For
            End If
        Next
...
Private Sub cmd_visualizar_Click()
    Call CriaLogCupom(Time & " - Emissão de NFCE Complementar: Foi Pedido a Visualização do Período de: " & msk_data_i.Text & " a " & msk_data_f.Text)
    DefineImpressoraTermicaComoPadrao
    lLocal = 0
    If ValidaCampos Then
        ...
        Call AtivaBotoes(False)
        Relatorio
        Call CriaLogCupom(Time & " - Emissão de NFCE Complementar: Foi Visualizado")
        If TestaImprimeEncerrante Then
...
Private Sub cmdImprimiEncerranteAtual_Click()
    ...
    lLocal = 1
    If ValidaCampos Then
        ImprimeEncerranteAutomacaoAtual
    End If
End Sub
...
Dim i As Integer
    ...
    Call CriaLogCupom(Time & " - Emissão de NFCe Complementar (5): A Emissão de NFCe Complementar Foi Aberta")
    If Not IsDate(msk_data.Text) Then
...
Private Sub Form_Load()
    Call CriaLogCupom(Time & " - Emissão de NFCe Complementar: A Emissão de NFCe Complementar Foi Aberta")
    CentraForm Me
