...
Begin VB.Form consulta_movimento_entrada_produto 
   Caption         =   "Consulta Movimento de Entrada de Produtos"
   ClientHeight    =   5355
   ClientLeft      =   1455
   ClientTop       =   1785
   ClientWidth     =   8655
   ...
   Picture         =   "con_movimento_entrada_produto.frx":0000
   ScaleHeight     =   5355
   ScaleWidth      =   8655
   ...
   Begin VB.CommandButton cmd_ok 
      ...
      Height          =   855
      Left            =   7020
      Picture         =   "con_movimento_entrada_produto.frx":0046
      Style           =   1  'Graphical
      TabIndex        =   7
   ...
   Begin VB.CommandButton cmd_sair 
      ...
      Height          =   855
      Left            =   7860
      Picture         =   "con_movimento_entrada_produto.frx":1650
      Style           =   1  'Graphical
      TabIndex        =   8
   ...
   End
End
Attribute VB_Name = "consulta_movimento_entrada_produto"
...
Private Sub AtualizaGrid()
    ...
    If ValidaCampos Then
        lSQl = ""
        lSQl = lSQl & "SELECT Entrada_Produto.[Data da Entrada], Entrada_Produto.[Numero do Documento], Produto.Nome, Entrada_Produto.[Preco de Custo], Entrada_Produto.Quantidade, Entrada_Produto.[Tipo da Entrada], Entrada_Produto.[Data da Digitacao], Entrada_Produto.Observacao, Entrada_Produto.[Codigo do Produto]"
        lSQl = lSQl & "  FROM " & lNomeTabela & ", Produto"
        If cbo_campo.ListIndex <> -1 Then
            lSQl = lSQl & " WHERE " & lNomeTabela & ".Empresa = " & g_empresa
            lSQl = lSQl & "   AND Produto.Codigo = " & lNomeTabela & ".[Codigo do Produto]"
...
Private Sub FormataGrid()
    ...
    MSFlexGrid1.Rows = 1
    i = 0
    MSFlexGrid1.TextMatrix(0, i) = "Data da Entrada"
    ...
    i = i + 1
    MSFlexGrid1.TextMatrix(0, i) = "Preço de Custo"
    MSFlexGrid1.ColAlignment(i) = flexAlignRightCenter
    MSFlexGrid1.ColWidth(i) = 1000
    i = i + 1
    ...
    MSFlexGrid1.ColWidth(i) = 1000
    i = i + 1
    MSFlexGrid1.TextMatrix(0, i) = "Tipo Ent."
    MSFlexGrid1.ColAlignment(i) = flexAlignCenterCenter
    MSFlexGrid1.ColWidth(i) = 400
    i = i + 1
    MSFlexGrid1.TextMatrix(0, i) = "Data da Digitação"
    MSFlexGrid1.ColAlignment(i) = flexAlignCenterCenter
    MSFlexGrid1.ColWidth(i) = 1000
    i = i + 1
    ...
    MSFlexGrid1.ColWidth(i) = 2000
    i = i + 1
    MSFlexGrid1.TextMatrix(0, i) = "Código do Produto"
    MSFlexGrid1.ColAlignment(i) = flexAlignLeftCenter
