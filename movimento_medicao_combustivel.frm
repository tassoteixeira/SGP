...
Begin VB.Form movimento_medicao_combustivel 
   ...
   ClientTop       =   1875
   ClientWidth     =   11565
   Icon            =   "movimento_medicao_combustivel.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form2"
   PaletteMode     =   1  'UseZOrder
   Picture         =   "movimento_medicao_combustivel.frx":030A
   ScaleHeight     =   7620
   ScaleWidth      =   11565
   Begin VB.CommandButton cmd_pesquisa 
      ...
      Height          =   855
      Left            =   2760
      Picture         =   "movimento_medicao_combustivel.frx":0750
      Style           =   1  'Graphical
      TabIndex        =   8
   ...
   Begin VB.CommandButton cmd_novo 
      ...
      Height          =   855
      Left            =   60
      Picture         =   "movimento_medicao_combustivel.frx":1BC2
      Style           =   1  'Graphical
      TabIndex        =   5
   ...
   Begin VB.CommandButton cmd_alterar 
      ...
      Height          =   855
      Left            =   960
      Picture         =   "movimento_medicao_combustivel.frx":3254
      Style           =   1  'Graphical
      TabIndex        =   6
   ...
   Begin VB.CommandButton cmd_excluir 
      ...
      Height          =   855
      Left            =   1860
      Picture         =   "movimento_medicao_combustivel.frx":474E
      Style           =   1  'Graphical
      TabIndex        =   7
   ...
   Begin VB.CommandButton cmd_sair 
      ...
      Height          =   855
      Left            =   3660
      Picture         =   "movimento_medicao_combustivel.frx":5DE0
      Style           =   1  'Graphical
      TabIndex        =   9
   ...
   Begin VB.Frame frm_dados 
      ...
      Begin VB.CommandButton cmd_transfere_dados_lmc 
         ...
         Height          =   735
         Left            =   9900
         Picture         =   "movimento_medicao_combustivel.frx":7472
         Style           =   1  'Graphical
         TabIndex        =   15
   ...
   Begin VB.Frame frm_move 
      ...
      Begin VB.CommandButton cmd_primeiro 
         Height          =   615
         Left            =   120
         Picture         =   "movimento_medicao_combustivel.frx":8864
         Style           =   1  'Graphical
         TabIndex        =   11
      ...
      Begin VB.CommandButton cmd_ultimo 
         Height          =   615
         Left            =   1680
         Picture         =   "movimento_medicao_combustivel.frx":9D5E
         Style           =   1  'Graphical
         TabIndex        =   14
      ...
      Begin VB.CommandButton cmd_anterior 
         Height          =   615
         Left            =   600
         Picture         =   "movimento_medicao_combustivel.frx":B258
         Style           =   1  'Graphical
         TabIndex        =   12
      ...
      Begin VB.CommandButton cmd_proximo 
         Height          =   615
         Left            =   1200
         Picture         =   "movimento_medicao_combustivel.frx":C6CA
         Style           =   1  'Graphical
         TabIndex        =   13
   ...
   Begin VB.CommandButton cmd_ok 
      ...
      Height          =   855
      Left            =   9840
      Picture         =   "movimento_medicao_combustivel.frx":DC4C
      Style           =   1  'Graphical
      TabIndex        =   3
   ...
   Begin VB.CommandButton cmd_cancelar 
      ...
      Height          =   855
      Left            =   10680
      Picture         =   "movimento_medicao_combustivel.frx":EF26
      Style           =   1  'Graphical
      TabIndex        =   4
   ...
   End
End
Attribute VB_Name = "movimento_medicao_combustivel"
    ...
    For i = 1 To (fgd_dados.Rows - 1)
        If fgd_dados.TextMatrix(i, 0) <> "" Then
            If Combustivel.LocalizarNome(g_empresa, fgd_dados.TextMatrix(i, 1)) Then
                ...
                MedicaoCombustivel.Quantidade = CCur(fgd_dados.TextMatrix(i, 2))
                MedicaoCombustivel.Observacao1 = fgd_dados.TextMatrix(i, 4)
                MedicaoCombustivel.Observacao2 = fgd_dados.TextMatrix(i, 5)
                MedicaoCombustivel.Observacao3 = fgd_dados.TextMatrix(i, 6)
                MedicaoCombustivel.DescontoDiaAnterior = CCur(fgd_dados.TextMatrix(i, 3))
                MedicaoCombustivel.MedidaRegua = 0
                xString = ""
                If lOpcao = 2 Then
                    xString = "Para: "
                End If
