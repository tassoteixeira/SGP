...
Begin VB.Form consulta_movimento_falta_caixa 
   Caption         =   "Consulta Movimento de Falta de Caixa"
   ClientHeight    =   5355
   ClientLeft      =   1455
   ClientTop       =   1785
   ClientWidth     =   8655
   ...
   Picture         =   "con_movimento_falta_caixa.frx":0000
   ScaleHeight     =   5355
   ScaleWidth      =   8655
   ...
   Begin VB.CommandButton cmd_ok 
      ...
      Height          =   855
      Left            =   7020
      Picture         =   "con_movimento_falta_caixa.frx":0046
      Style           =   1  'Graphical
      TabIndex        =   7
   ...
   Begin VB.CommandButton cmd_sair 
      ...
      Height          =   855
      Left            =   7860
      Picture         =   "con_movimento_falta_caixa.frx":1650
      Style           =   1  'Graphical
      TabIndex        =   8
   ...
   End
End
Attribute VB_Name = "consulta_movimento_falta_caixa"
...
Private Sub AtualizaGrid()
    ...
    If ValidaCampos Then
        lSQL = ""
        lSQL = lSQL & "SELECT Movimento_Falta_Caixa.Data, Movimento_Falta_Caixa.Periodo, Movimento_Falta_Caixa.[Codigo do Funcionario], Funcionario.Nome, Movimento_Falta_Caixa.Valor, Movimento_Falta_Caixa.Observacao, Movimento_Falta_Caixa.[Tipo de Movimento]"
        ...
        If cbo_campo.ListIndex <> -1 Then
            ...
            lSQL = lSQL & "   AND Funcionario.Codigo = Movimento_Falta_Caixa.[Codigo do Funcionario]"
            lSQL = lSQL & "   AND Movimento_Falta_Caixa." & fConsultaPreparaCondicao(cbo_campo.Text, rsDados.Fields(cbo_campo.Text).Type, cbo_operador.Text, txt_condicao.Text)
        End If
        lSQL = lSQL & " ORDER BY Movimento_Falta_Caixa.Data, Movimento_Falta_Caixa.Periodo, Funcionario.Nome"
...
Private Sub FormataGrid()
    ...
    i = i + 1
    MSFlexGrid1.TextMatrix(0, i) = "Nome do Funcionario"
    ...
    i = i + 1
    MSFlexGrid1.TextMatrix(0, i) = "Observação"
    MSFlexGrid1.ColAlignment(i) = flexAlignLeftCenter
    MSFlexGrid1.ColWidth(i) = 2300
    i = i + 1
    MSFlexGrid1.TextMatrix(0, i) = "Topo Mov."
    MSFlexGrid1.ColAlignment(i) = flexAlignCenterCenter
    MSFlexGrid1.ColWidth(i) = 850
End Sub
    ...
    If Not rsDados.EOF Then
        ...
        Do Until rsDados.EOF
            ...
            For Each fld In rsDados.Fields
                If fld.name <> "nome_fornecedor" Then
                    i2 = i2 + 1
                    MSFlexGrid1.Col = i2
...
Private Sub PreencheCampos()
    lSQL = "SELECT * FROM Movimento_Falta_Caixa WHERE Empresa = 0"
    Set rsDados = Conectar.RsConexao(lSQL)
    cbo_campo.Clear
    For Each fld In rsDados.Fields
