...
Begin VB.Form emissao_analise_venda_produto 
   Caption         =   "Emissão da Análise da Venda de Produtos"
   ClientHeight    =   3075
   ClientLeft      =   1350
   ClientTop       =   1680
   ClientWidth     =   6915
...
Private Sub Relatorio()
    ...
    If rstTabela.RecordCount > 0 Then
        ...
        If lPagina > 0 Then
            ...
            BioFechaImprime
            g_string = lLocal & lNomeArquivo & "|@|Análise da Venda dos Produto|@|"
            frm_preview.Show 1
        End If
    End If
...
Private Sub ImpCab()
    ...
    BioImprime "@Printer.Print " & xLinha
    BioImprime "@@Printer.FontBold = False"
    xLinha = "| ANÁLISE DA VENDA DE PRODUTOS                                    , __/__/____ |"
    ...
    BioImprime "@@Printer.FontBold = False"
    BioImprime "@Printer.Print " & "+------+-------------------------------+---+--------+-------+-----------+-------+-------+-------+-----------+-------+-------+-----------+"
    BioImprime "@Printer.Print " & "|      |                               |   | QUANT. | PREÇO |   TOTAL   |% CUSTO|% SOBRE| PREÇO |   TOTAL   |% VENDA|% SOBRE|   VALOR   |"
    BioImprime "@Printer.Print " & "|CÓDIGO|  DISCRIMINAÇÃO DOS PRODUTOS   |UN.|        |  DE   |     DO    |  PARA | TOTAL |  DE   |     DA    |  PARA | TOTAL |     DO    |"
