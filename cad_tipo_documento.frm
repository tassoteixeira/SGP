...
Function ValidaCampos() As Integer
    ...
    If Not Val(txt_codigo.Text) > 0 Then
        MsgBox "Informe o código do Tipo de Documento.", vbInformation, "Atenção!"
        txt_codigo.SetFocus
    ElseIf Not txt_nome.Text > "" Then
        MsgBox "Informe o nome do Tipo de Documento.", vbInformation, "Atenção!"
        txt_nome.SetFocus
    Else
        ValidaCampos = True
    End If
...
Private Sub txt_codigo_LostFocus()
    If lOpcao = 1 And txt_codigo.Text <> "" Then
        If TipoDocumento.LocalizarCodigo(Val(txt_codigo.Text)) Then
            MsgBox "Já existe Tipo de Documento cadastrado com este código." & Chr(10) & Chr(10) & "Mude o código informado.", vbInformation, "Duplicidade de Registro!"
            txt_codigo.SetFocus
            Exit Sub
        End If
    End If
