...
Begin VB.Form consulta_movimento_cupom_fiscal 
   Caption         =   "Consulta Movimento de Cupom Fiscal"
   ClientHeight    =   5355
   ClientLeft      =   1455
   ClientTop       =   1785
   ClientWidth     =   8655
   ...
   Picture         =   "con_movimento_cupom_fiscal.frx":0000
   ScaleHeight     =   5355
   ScaleWidth      =   8655
   Begin VB.CommandButton cmd_ok 
      ...
      Height          =   855
      Left            =   7020
      Picture         =   "con_movimento_cupom_fiscal.frx":0046
      Style           =   1  'Graphical
      TabIndex        =   7
   ...
   Begin VB.CommandButton cmd_sair 
      ...
      Height          =   855
      Left            =   7860
      Picture         =   "con_movimento_cupom_fiscal.frx":1650
      Style           =   1  'Graphical
      TabIndex        =   8
   ...
   Begin TrueDBGrid.TDBGrid TDBGrid1 
      Bindings        =   "con_movimento_cupom_fiscal.frx":2CE2
      Height          =   4035
      Left            =   60
      OleObjectBlob   =   "con_movimento_cupom_fiscal.frx":2CFB
      TabIndex        =   9
      Top             =   1260
      Width           =   8535
   End
End
Attribute VB_Name = "consulta_movimento_cupom_fiscal"
...
Private Sub AtualizaGrid()
    ...
    If ValidaCampos Then
        l_campo = "Select Movimento_Cupom_Fiscal.[Data do Cupom], Movimento_Cupom_Fiscal.[Numero do Cupom], Movimento_Cupom_Fiscal.Hora, Movimento_Cupom_Fiscal.Ordem, Movimento_Cupom_Fiscal.Periodo, Movimento_Cupom_Fiscal.[Tipo do SubEstoque], Movimento_Cupom_Fiscal.[Codigo do Cliente], Cliente.[Razao Social], Movimento_Cupom_Fiscal.[Codigo do Produto], Produto.Nome, Movimento_Cupom_Fiscal.[Valor Unitario], Movimento_Cupom_Fiscal.Quantidade, Movimento_Cupom_Fiscal.[Valor Total], Movimento_Cupom_Fiscal.Operador, Funcionario.Nome as NomeFuncionario"
        l_arquivo = " From " & tbl_tabela.name & ", Cliente, Produto, Funcionario"
        If cbo_campo.ListIndex <> -1 Then
            l_condicao = ""
            l_condicao = " Where " & tbl_tabela.name & ".Empresa = " & g_empresa
            l_condicao = l_condicao & " And Cliente.Codigo = Movimento_Cupom_Fiscal.[Codigo do Cliente]"
            l_condicao = l_condicao & " And Produto.Codigo = Movimento_Cupom_Fiscal.[Codigo do Produto]"
            l_condicao = l_condicao & " And Funcionario.Empresa = " & g_empresa
            l_condicao = l_condicao & " And Funcionario.Codigo = Movimento_Cupom_Fiscal.Operador"
            l_condicao = l_condicao & " And " & tbl_tabela.name & "." & cbo_campo.Text & " " & x_operando & " " & x_condicao
        Else
            l_condicao = ""
        End If
        l_ordem = " order by [Data do Cupom], [Numero do Cupom], Ordem"
...
Private Sub FormaGrid()
    ...
    Next
    TDBGrid1.Columns(0).DataField = "Data do Cupom"
    TDBGrid1.Columns(0).NumberFormat = "General Date"
    TDBGrid1.Columns(0).Caption = "Data do Cupom"
    TDBGrid1.Columns(0).Alignment = dbgCenter
    TDBGrid1.Columns(0).HeadAlignment = dbgCenter
    TDBGrid1.Columns(0).Width = 1000
    TDBGrid1.Columns(1).DataField = "Numero do Cupom"
    TDBGrid1.Columns(1).Caption = "Número do Cupom"
    TDBGrid1.Columns(1).Alignment = dbgRight
    TDBGrid1.Columns(1).HeadAlignment = dbgCenter
    TDBGrid1.Columns(1).Width = 700
    TDBGrid1.Columns(2).DataField = "Hora"
    TDBGrid1.Columns(2).Caption = "Hora do Cupom"
    TDBGrid1.Columns(2).Alignment = dbgCenter
    TDBGrid1.Columns(2).HeadAlignment = dbgCenter
    TDBGrid1.Columns(2).Width = 700
    TDBGrid1.Columns(3).DataField = "Ordem"
    TDBGrid1.Columns(3).Caption = "Ordem"
    TDBGrid1.Columns(3).Alignment = dbgCenter
    TDBGrid1.Columns(3).HeadAlignment = dbgCenter
    TDBGrid1.Columns(3).Width = 550
    TDBGrid1.Columns(4).DataField = "Periodo"
    TDBGrid1.Columns(4).Caption = "Per."
    TDBGrid1.Columns(4).Alignment = dbgCenter
    TDBGrid1.Columns(4).HeadAlignment = dbgCenter
    TDBGrid1.Columns(4).Width = 400
    TDBGrid1.Columns(5).DataField = "Tipo do SubEstoque"
    TDBGrid1.Columns(5).Caption = "SubEstoq"
    TDBGrid1.Columns(5).Alignment = dbgCenter
    TDBGrid1.Columns(5).HeadAlignment = dbgCenter
    TDBGrid1.Columns(5).Width = 400
    TDBGrid1.Columns(6).DataField = "Codigo do Cliente"
    TDBGrid1.Columns(6).Caption = "Cliente"
    TDBGrid1.Columns(6).Alignment = dbgRight
    TDBGrid1.Columns(6).HeadAlignment = dbgCenter
    TDBGrid1.Columns(6).Width = 600
    TDBGrid1.Columns(7).DataField = "Razao Social"
    TDBGrid1.Columns(7).Caption = "Razão social"
    TDBGrid1.Columns(7).Alignment = dbgLeft
    TDBGrid1.Columns(7).HeadAlignment = dbgCenter
    TDBGrid1.Columns(7).Width = 2000
    TDBGrid1.Columns(8).DataField = "Codigo do Produto"
    ...
    TDBGrid1.Columns(9).DataField = "Nome"
    TDBGrid1.Columns(9).Caption = "Produto"
    TDBGrid1.Columns(9).Alignment = dbgLeft
    TDBGrid1.Columns(9).HeadAlignment = dbgCenter
    TDBGrid1.Columns(9).Width = 2000
    TDBGrid1.Columns(10).DataField = "Valor Unitario"
    TDBGrid1.Columns(10).NumberFormat = "Currency"
    TDBGrid1.Columns(10).Caption = "Valor Unitário"
    TDBGrid1.Columns(10).Alignment = dbgRight
    TDBGrid1.Columns(10).HeadAlignment = dbgCenter
    TDBGrid1.Columns(10).Width = 700
    TDBGrid1.Columns(11).DataField = "Quantidade"
    TDBGrid1.Columns(11).NumberFormat = "Currency"
    TDBGrid1.Columns(11).Caption = "Quant."
    TDBGrid1.Columns(11).Alignment = dbgRight
    TDBGrid1.Columns(11).HeadAlignment = dbgCenter
    TDBGrid1.Columns(11).Width = 700
    TDBGrid1.Columns(12).DataField = "Valor Total"
    TDBGrid1.Columns(12).NumberFormat = "Currency"
    TDBGrid1.Columns(12).Caption = "Valor Total"
    TDBGrid1.Columns(12).Alignment = dbgRight
    TDBGrid1.Columns(12).HeadAlignment = dbgCenter
    TDBGrid1.Columns(12).Width = 700
    TDBGrid1.Columns(13).DataField = "Operador"
    TDBGrid1.Columns(13).Caption = "Código do Func."
    TDBGrid1.Columns(13).Alignment = dbgRight
    TDBGrid1.Columns(13).HeadAlignment = dbgCenter
    TDBGrid1.Columns(13).Width = 650
    TDBGrid1.Columns(14).DataField = "NomeFuncionario"
    TDBGrid1.Columns(14).Caption = "Funcionário"
    TDBGrid1.Columns(14).Alignment = dbgLeft
    TDBGrid1.Columns(14).HeadAlignment = dbgCenter
    TDBGrid1.Columns(14).Width = 2000
End Sub
...
Private Sub Inicializa()
    ...
    For i = 0 To cbo_campo.ListCount - 1
        ...
        If cbo_campo = "[Data do Cupom]" Then
            Exit For
        End If
    Next
...
Private Sub Form_Load()
    ...
    CentraForm Me
    Set tbl_tabela = bd_sgp.OpenTable("Movimento_Cupom_Fiscal")
