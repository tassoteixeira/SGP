...
Begin VB.Form Movimento_Nfce_Conveniencia 
   Caption         =   "Pedido de Compra - Nota Fiscal ao Consumidor EletrÙnica"
   ClientHeight    =   6315
   ClientLeft      =   165
   ClientTop       =   585
   ClientWidth     =   11445
   ...
   Begin VB.Frame frm_botoes 
      ...
      Begin VB.CommandButton cmdCaixa 
         ...
         Style           =   1  'Graphical
         TabIndex        =   55
         ToolTipText     =   "Lan√ßamentos do Caixa de Conveni√™ncia."
         Top             =   120
         Visible         =   0   'False
         Width           =   975
      End
   ...
   Begin VB.Frame frm_ponto 
      Caption         =   "IdentificaÁ„o de Funcion·rio"
      Height          =   1395
      Left            =   120
      TabIndex        =   42
      Top             =   420
      ...
      Begin VB.CommandButton cmd_ok_ponto 
         ...
         Left            =   4800
         TabIndex        =   49
         ToolTipText     =   "Confirma este registro de ponto de funcion√°rio."
         Top             =   900
         Width           =   855
      End
      Begin VB.CommandButton cmd_cancelar_ponto 
         ...
         Left            =   3840
         TabIndex        =   48
         ToolTipText     =   "Cancela este registro de ponto de funcion√°rio."
         Top             =   900
         Width           =   855
      End
      ...
      Begin MSDataListLib.DataCombo dtcboFuncionario 
         Bindings        =   "Movimento_Nfce_Conveniencia.frx":2C68
   ...
   Begin VB.Frame frmFechamentoCupom 
      ...
      Begin MSDataListLib.DataCombo dtcboCliente 
         Bindings        =   "Movimento_Nfce_Conveniencia.frx":2C87
         Height          =   315
         Left            =   960
         TabIndex        =   29
         Top             =   420
   ...
   Begin VB.Frame frmDados 
      ...
      Begin MSDataListLib.DataCombo dtcboProduto 
         Bindings        =   "Movimento_Nfce_Conveniencia.frx":2CA2
         Height          =   315
         Left            =   960
         TabIndex        =   16
         Top             =   2880
...
Const TIPO_MOVIMENTO_CAIXA_CONVENIENCIA As Integer = 1 'CÛDIGO DO TIPO DE MOVIMENTO CONVENIENCIA NA TABELA DE MOVIMENTOCAIXAPISTA, MOVIMENTO_LUBRIFICANTE,MOVIMENTO_VENDA_CONVENIENCIA
Const TIPO_MOVIMENTO_LIBERACAO_CONVENIENCIA As Integer = 3 'CÛDIGO DO TIPO DE MOVIMENTO CONVENIENCIA NA TABELA DE LIBERA«AO
Const TIPO_MOVIMENTO_LIBERACAO_PISTA As Integer = 2 'CÛDIGO DO TIPO DE MOVIMENTO PISTA NA TABELA DE LIBERA«AO
...
Dim lGeraCaixaChequeAVista As Boolean 'SÛ pra compilar ainda n„o sei se È necess·rio
Dim lTotaNFCe As Currency 'SÛ pra compilar ainda n„o sei se È necess·rio
...
Private Function CancelamentoCupomFiscal() As Boolean
    ...
    If MovimentoVendaConveniencia.LocalizarUltimo(g_empresa, lIlha, lOrigemVenda) Then
        If MovimentoVendaConveniencia.CupomCancelado = True Then
            Call GravaAuditoria(1, Me.name, 25, "Cancelamento abortado. J· est· cancelado o Pedido:" & MovimentoVendaConveniencia.NumeroCupom)
            MsgBox "N„o ser· possÌvel continuar o cancelamento!" & Chr(10) & "Este pedido j· encontra-se cancelado.", vbInformation, "Cancelamento Negado!"
            Exit Function
        End If
    Else
        Call GravaAuditoria(1, Me.name, 25, "N„o foi possÌvel localizar ultimo Pedido Ilha:" & lIlha & " Origem:" & lOrigemVenda)
        MsgBox "N„o foi possÌvel localizar o ˙ltimo pedido para cancelar!", vbCritical, "Erro de Integridade!"
        Exit Function
    End If
    ...
    If rs.RecordCount > 0 Then
        ...
        If MovimentoVendaConveniencia.CancelaCupom(g_empresa, rs("Numero do Cupom").Value, rs("Data").Value, rs("Ilha").Value, rs("Origem da Venda").Value) Then
            Do Until rs.EOF
                ...
                If MovimentoVendaConveniencia.LocalizarCodigo(g_empresa, rs("Numero do Cupom").Value, rs("Data").Value, rs("Ilha").Value, rs("Origem da Venda").Value, rs("Ordem").Value) Then
                    If Produto.LocalizarCodigo(rs("Codigo do Produto").Value) Then
                        ...
                        End If
                    Else
                        MsgBox "N„o foi possÌvel localizar o produto:" & rs("Codigo do Produto").Value, vbCritical, "Erro de Integridade!"
                        Call GravaAuditoria(1, Me.name, 25, "Erro ao localizar o produto:" & rs("Codigo do Produto").Value)
                    End If
                Else
                    MsgBox "N„o foi possÌvel localizar o pedido.", vbCritical, "Erro de Integridade!"
            ...
            Loop
        Else
            MsgBox "N„o foi possÌvel cancelar o pedido.", vbCritical, "Erro de Integridade!"
            Call GravaAuditoria(1, Me.name, 25, "Erro ao cancelar no sistema o Pedido:" & rs("Numero do Cupom").Value)
        End If
    Else
        MsgBox "√öltimo pedido encontra-se totalmente cancelado!", vbCritical, "OperaÁ„o Negada!"
        Call GravaAuditoria(1, Me.name, 25, "O Pedido:" & MovimentoVendaConveniencia.NumeroCupom & " encontra-se totalmente cancelado.")
    End If
    Exit Function
    
FileError:
    MsgBox "N„o foi possÌvel cancelar o pedido de compra.", vbCritical, "Erro de Integridade!"
...
Private Function CancelamentoCupomFiscalItem() As Boolean
    ...
    If MovimentoVendaConveniencia.CancelaItemCupom(g_empresa, l_numero_cupom, l_data, lIlha, lOrigemVenda, l_ordem) Then
        If MovimentoVendaConveniencia.CupomCancelado = True Then
            Call GravaAuditoria(1, Me.name, 25, "Cancelamento abortado. J· est· cancelado o Pedido:" & l_numero_cupom)
            MsgBox "N„o ser· possÌvel continuar o cancelamento!" & Chr(10) & "Este pedido j· encontra-se cancelado.", vbInformation, "Cancelamento Negado!"
            Exit Function
        ElseIf MovimentoVendaConveniencia.ItemCancelado = True Then
            Call GravaAuditoria(1, Me.name, 25, "Cancelamento abortado. J· est· cancelado o Pedido:" & l_numero_cupom & " Õçtem:" & l_ordem)
            MsgBox "N„o ser· possÌvel continuar o cancelamento!" & Chr(10) & "Este Ìtem de pedido j· encontra-se cancelado.", vbInformation, "Cancelamento Negado!"
            Exit Function
        End If
        If Produto.LocalizarCodigo(MovimentoVendaConveniencia.CodigoProduto) Then
            ...
            End If
        Else
            MsgBox "N„o foi possÌvel localizar o produto:" & MovimentoVendaConveniencia.CodigoProduto, vbCritical, "Erro de Integridade!"
            Call GravaAuditoria(1, Me.name, 25, "Erro ao localizar o produto:" & MovimentoVendaConveniencia.CodigoProduto)
        End If
    Else
        Call GravaAuditoria(1, Me.name, 25, "N„o foi possÌvel localizar o Pedido:" & l_numero_cupom & " Õçtem:" & l_ordem)
        MsgBox "N„o foi possÌvel localizar o pedido para cancelar!", vbCritical, "Erro de Integridade!"
        Exit Function
    End If
    Exit Function

FileError:
    MsgBox "N„o foi possÌvel cancelar o Ìtem anterior do pedido de compra.", vbCritical, "Erro de Integridade!"
...
Private Function CriaAberturaCaixa(ByVal pPeriodo As Integer) As Boolean
    ...
    AberturaCaixa.TipoMovimento = TIPO_MOVIMENTO_CAIXA_CONVENIENCIA 'ConveniÍncia
    ...
    If AberturaCaixa.Incluir = False Then
        MsgBox "N„o foi possÌvel abrir o caixa!", vbCritical, "Erro de Integridade!"
    Else
...
Private Sub ImprimeCupomFiscal()
    ...
    If lExisteImpressora Then
        ...
        'Verifica se h· diferenÁa do total
    ...
    Exit Sub
FileError:
    MsgBox "N„o foi possÌvel imprimir o novo pedido de compra.", vbCritical, "Erro Grave!"
    Exit Sub
End Sub
...
Private Sub AtualizaConstantes()
    ...
    Else
        ...
        If ECF.LocalizarIpPdv(g_empresa, xIP) Then
            ...
            lIlha = ECF.Ilha
        Else
            MsgBox "N„o tem ECF configurada para o IP deste computador!", vbCritical, "Tabela: ECF"
...
Private Sub AtualizaTabelaNotaAbastecimento()
    ...
    If Not IntegracaoCaixa.LocalizarNome(g_empresa, "NOTA ABASTECIMENTO") Then
        MsgBox "N„o ser· possÌvel integrar com o caixa!", vbInformation, "Erro de Integridade"
    Else
        ...
        Else
            MsgBox "N„o foi possÌvel incluir Nota de Abastecimento", vbInformation, "Erro de Integridade!"
        End If
    End If
End Sub
Private Sub AtualizaTabelaVendaProduto()
    If Not IntegracaoCaixa.LocalizarNome(g_empresa, "VENDA DE LUBRIFICANTES") Then
        MsgBox "N„o ser· possÌvel integrar com o caixa!", vbCritical, "Erro de Integridade!"
    Else
        If IncluiMovimentoCaixa("VENDA DE LUBRIFICANTES") Then
            If MovimentoLubrificante.LocalizarCodigo(g_empresa, MovimentoVendaConveniencia.Data, MovimentoVendaConveniencia.Periodo, MovimentoVendaConveniencia.Ilha, 1, 2, MovimentoVendaConveniencia.CodigoProduto, MovimentoVendaConveniencia.operador) Then
                ...
                Else
                    MsgBox "N„o foi possÌvel alterar o registro Venda Produto!", vbCritical, "Erro de Integridade!"
                End If
            Else
                ...
                Else
                    MsgBox "N„o foi possÌvel incluir Venda de Produtos", vbCritical, "Erro de Integridade!"
                End If
            End If
        Else
            MsgBox "N„o foi possÌvel integrar no caixa!", vbCritical, "Erro de Integridade!"
        End If
    End If
End Sub
Function BuscaRegistro(ByVal pNumeroCupom As Long, ByVal pData As Date, ByVal pOrdem As Integer) As Boolean
    ...
    If MovimentoVendaConveniencia.LocalizarCodigo(g_empresa, pNumeroCupom, pData, lIlha, lOrigemVenda, pOrdem) Then
        BuscaRegistro = True
    Else
        MsgBox "N„o foi possÌvel localizar o pedido de compra.", vbInformation, "Erro de Integridade!"
    End If
End Function
...
Function ExcluiMovimentoCaixa(ByVal pTipoLancamentoPadrao As String) As Boolean
    ...
    If pTipoLancamentoPadrao = "VENDA DE LUBRIFICANTES" Then
        If Not IntegracaoCaixa.LocalizarNome(g_empresa, pTipoLancamentoPadrao) Then
            MsgBox "N„o foi possÌvel localiar a integracao:" & "VENDA DE LUBRIFICANTES", vbCritical, "Erro de Integridade!"
            Call GravaAuditoria(1, Me.name, 25, "N„o ser· integrado no caixa o extorno de produto no caixa.")
            Exit Function
        End If
        ...
        If MovCaixaPista.LocalizarRegistroEspecial(g_empresa, MovimentoVendaConveniencia.Data, Val(MovimentoVendaConveniencia.Periodo), lIlha, xComplemento, IntegracaoCaixa.ContaCredito, "C") Then
            ...
            If xValor = 0 Then
                ...
                Else
                    MsgBox "N„o foi possÌvel excluir registro especial no caixa.", vbCritical, "Erro de Integridade!"
                    Call GravaAuditoria(1, Me.name, 25, "N„o foi possÌvel excluir registro especial no caixa.")
            ...
            Else
                ...
                If MovCaixaPista.Alterar(g_empresa, MovimentoVendaConveniencia.Data, MovCaixaPista.NumeroMovimento) Then
                    ExcluiMovimentoCaixa = True
                Else
                    MsgBox "N„o foi possÌvel alterar registro especial no caixa.", vbCritical, "Erro de Integridade!"
                    Call GravaAuditoria(1, Me.name, 25, "N„o foi possÌvel alterar registro especial no caixa.")
                    Call GravaAuditoria(1, Me.name, 25, "Data:" & MovimentoVendaConveniencia.Data & " Numero Mov:" & MovCaixaPista.NumeroMovimento)
                End If
            End If
        Else
            MsgBox "N„o foi possÌvel localiar registro especial no caixa.", vbCritical, "Erro de Integridade!"
            Call GravaAuditoria(1, Me.name, 25, "N„o foi possÌvel localizar registro especial no caixa.")
...
Private Function ExcluiSaidaProduto(ByVal pCodigoProduto As Long, ByVal pQuantidade As Currency) As Boolean
    ...
    If Estoque.LocalizarCodigo(g_empresa, pCodigoProduto) Then
        ...
        If Estoque.Alterar(g_empresa, pCodigoProduto) Then
            ...
            Else
                MsgBox "N„o foi possÌvel alterar o Sub-Estoque!", vbInformation, "Erro de Integridade!"
            End If
        Else
            MsgBox "N„o foi possÌvel alterar o estoque!", vbInformation, "Erro de Integridade!"
        End If
    Else
        MsgBox "Estoque n„o cadastrado.", vbInformation, "Erro de VerificaÁ„o!"
    End If
End Function
...
Private Sub VerificaSeExisteCupom()
    If MovimentoVendaConveniencia.LocalizarCodigo(g_empresa, CLng(txt_numero_cupom.Text), l_data, lIlha, lOrigemVenda, Val(txt_ordem.Text)) Then
        ...
        If Not MovimentoVendaConveniencia.Excluir(g_empresa, CLng(txt_numero_cupom.Text), l_data, lIlha, lOrigemVenda, Val(txt_ordem.Text)) Then
            MsgBox "N„o foi possÌvel excluir o pedido de compra.", vbInformation, "Erro de Integridade!"
        End If
    End If
End Sub
...
'key = CST | Item = se È tributado
    ...
    Call lDicFormaPagamentoCartao.Add(2, False) 'Cheque ‡† Vista
    Call lDicFormaPagamentoCartao.Add(3, False) 'Cheque PrÈ-Datado
    Call lDicFormaPagamentoCartao.Add(4, True)  'Cart„o de crÈdito
    Call lDicFormaPagamentoCartao.Add(5, False) 'Nota Vinculada
    Call lDicFormaPagamentoCartao.Add(6, True)  'Cart„o TecBan
    Call lDicFormaPagamentoCartao.Add(7, True)  'Cheque TecBan
    Call lDicFormaPagamentoCartao.Add(8, False) 'Cart„o pelo POS
...
'CART’ES QUE N√O COINCIDEM COM POSTO
...
'    cbo_forma_pagamento.AddItem "16 - Cart„o pelo POS"
...
'    cbo_forma_pagamento.ItemData(cbo_forma_pagamento.NewIndex) = 17
    ...
    cbo_forma_pagamento.AddItem "2 - Cheque ‡† Vista"
    cbo_forma_pagamento.ItemData(cbo_forma_pagamento.NewIndex) = 2
    cbo_forma_pagamento.AddItem "3 - Cheque PrÈ-Datado"
    cbo_forma_pagamento.ItemData(cbo_forma_pagamento.NewIndex) = 3
    cbo_forma_pagamento.AddItem "4 - Cart„o de CrÈdito"
    ...
    cbo_forma_pagamento.AddItem "6 - Cart„o TecBan    "
    ...
    cbo_forma_pagamento.AddItem "8 - Cart„o pelo POS    "
    cbo_forma_pagamento.ItemData(cbo_forma_pagamento.NewIndex) = 8
End Sub
...
'    cbo_tipo_movimento.AddItem "1 Caixa de combustÌveis"
'    cbo_tipo_movimento.ItemData(cbo_tipo_movimento.NewIndex) = 1
'    cbo_tipo_movimento.AddItem "2 Caixa de Ûleo/diversos"
'    cbo_tipo_movimento.ItemData(cbo_tipo_movimento.NewIndex) = 2
'    cbo_tipo_movimento.AddItem "3 Caixa de Troca de Ûleo"
...
'Foi visto que todo sistema utiliza como padr„o tipo de movimento 1 para conveniencia
'Como esta tela È exclusiva para conveniencia preenchi a combo somente com um valor para manter compatibilidade
...
Function VerificaLiberacaoDigitacao2() As Boolean
    ...
    If lCaixaIndividual Then
        If Not AberturaCaixa.LocalizarUltAbertoDataFunc(g_empresa, CDate(msk_data.Text), "NF", 1, xTipoMovimento, l_codigo_funcionario) Then
            If (MsgBox("O Caixa n„o encontra-se aberto!" & Chr(10) & "Deseja abrir agora?", vbQuestion + vbYesNo + vbDefaultButton1, "Abertura de Caixa!")) = vbYes Then
    ...
    If msk_data.Text < g_cfg_data_i Or msk_data.Text > g_cfg_data_f Then
        MsgBox "A data deve estar entre " & Format(g_cfg_data_i, "dd/mm/yyyy") & " a " & Format(g_cfg_data_f, "dd/mm/yyyy") & ".", vbInformation, "DigitaÁ„o N„o Autorizada!"
        msk_data.SetFocus
    ElseIf cbo_periodo.Text < g_cfg_periodo_i Or cbo_periodo.Text > g_cfg_periodo_f Then
        MsgBox "O perÌodo deve estar entre " & g_cfg_periodo_i & " ao " & g_cfg_periodo_f & ".", vbInformation, "DigitaÁ„o N„o Autorizada!"
        cbo_periodo.SetFocus
    ElseIf Produto.CodigoGrupo = 4 And fValidaValor(txt_valor_total.Text) > 1000 Then
        MsgBox "O valor nao pode ser maior que R$ 1.000,00.", vbInformation, "DigitaÁ„o N„o Autorizada!"
...
Private Sub cbo_periodo_GotFocus()
    l_mensagem = Space(165) & "Selecione o perÌodo do movimento."
...
Private Sub cmd_fecha_caixa_Click()
    ...
    If Not FechamentoCaixa.Incluir Then
        MsgBox "N„o foi possÌvel incluir registro de Fechamento de Caixa.", vbInformation, "Erro de Integridade!"
    End If
            ...
            If LiberacaoDigitacao.Alterar(g_empresa, TIPO_MOVIMENTO_LIBERACAO_CONVENIENCIA) Then
                If LiberacaoDigitacao.LocalizarCodigo(g_empresa, TIPO_MOVIMENTO_LIBERACAO_PISTA) Then
                    ...
                    If Not LiberacaoDigitacao.Alterar(g_empresa, TIPO_MOVIMENTO_LIBERACAO_PISTA) Then
                        MsgBox "Erro ao alterar a LiberaÁ„o de DigitaÁ„o!", vbInformation, "Registro n„o Alterado!"
                    End If
                End If
            Else
                MsgBox "Erro ao alterar a LiberaÁ„o de DigitaÁ„o!", vbInformation, "Registro n„o Alterado!"
...
Private Sub cmd_ok_ponto_Click()
    If ValidaCamposPonto Then
        If txt_senha_ponto.Text <> "" Then
            ...
            Else
                MsgBox "Senha informada n„o confere." & Chr(10) & "Informe pela " & 2 & "a vez.", vbInformation, "Senha Inv·lida!"
                txt_senha_ponto = ""
...
Private Sub FinalizaVendaConveniencia(ByVal pVendaComNFCe As Boolean)
    ...
    If ValidaCamposFechamento Then
        ...
        If Not MovimentoVendaConveniencia.AlterarFormaPagamento(g_empresa, l_numero_cupom, l_data, lIlha, lOrigemVenda) Then
            MsgBox "N„o foi possÌvel alterar a forma de pagamento.", vbInformation, "Erro de Integridade!"
        End If
'        aqui aqui aqui aqui
        If fValidaValor2(txt_valor_desconto.Text) > 0 Then
            If Not MovimentoVendaConveniencia.GravaDesconto(g_empresa, l_numero_cupom, l_data, lIlha, lOrigemVenda, fValidaValor2(txt_valor_desconto.Text)) Then
                MsgBox "N„o foi possÌvel alterar o desconto.", vbInformation, "Erro de Integridade!"
            End If
        End If
...
'                    lRespostaTEF = CerradoTef.SolicitacaoTEF("NFCe", gNumeroControleSolicitacao, lNumeroNFCe, txt_valor_recebido.Text, txt_valor_desconto.Text, gQtdViasTEF, "TEFCERRADO", False, txt_cpf.Text, txt_nome_cliente.Text, xObservacao2 & txt_observacao.Text, xDadosProdutos, lLinhasEntreCV, xTextoParaComprovante, xFechamentoIniciado, l_codigo_funcionario, l_nome_funcionario)
                ...
                If lRespostaTEF = True Then
                    ...
                    End If
                Else
                    MsgBox "Selecione outra forma de pagamento!", vbInformation, "Forma de Pagamento Temporariamente N„o Aceita!"
                    cbo_forma_pagamento.SetFocus
                    Exit Sub
                End If
            End If
    ...
    If lCaixaIndividual Then
        If Not AberturaCaixa.LocalizarUltAbertoDataFunc(g_empresa, CDate(msk_data.Text), "NF", 1, TIPO_MOVIMENTO_CAIXA_CONVENIENCIA, l_codigo_funcionario) Then
            If (MsgBox("O Caixa n„o encontra-se aberto!" & Chr(10) & "Deseja abrir agora?", vbQuestion + vbYesNo + vbDefaultButton1, "Abertura de Caixa!")) = vbYes Then
                ...
                xChamaCaixa = True
            Else
                MsgBox "O Caixa atual n„o foi aberto!" & Chr(10) & "N„o ser· possÌvel acessar o caixa sem antes abri-lo?", vbInformation + vbExclamation, "Caixa Inexistente!"
            End If
        Else
            xChamaCaixa = True
        End If
...
Private Sub cmdCancelaVenda_Click()
    If Not lPermiteCancelarPedido Then
        MsgBox "N„o È permitido cancelar venda!", vbOKOnly + vbInformation, "Erro de Integridade"
        Exit Sub
    End If
...
Function IncluiMovimentoCaixa(ByVal pTipoLancamentoPadrao As String) As Boolean
    ...
    ElseIf pTipoLancamentoPadrao = "VENDA DE LUBRIFICANTES" Then
            ...
            If lCaixaIndividual Then
                If MovCaixaPista.LocalizarRegistroEspecialUsu(g_empresa, MovimentoVendaConveniencia.Data, Val(MovimentoVendaConveniencia.Periodo), 1, xComplemento, IntegracaoCaixa.ContaCredito, "C", g_usuario) Then
                    ...
                    If Not MovCaixaPista.Excluir(g_empresa, MovimentoVendaConveniencia.Data, MovCaixaPista.NumeroMovimento) Then
                        MsgBox "N„o foi possÌvel excluir o movimento caixa!", vbOKOnly + vbInformation, "Erro de Integridade"
                    End If
                End If
            Else
        ...
        Else
            MsgBox "N„o existe a integraÁ„o=" & "VENDA DE LUBRIFICANTES" & ".", vbInformation, "Registro Inexistente"
            Exit Function
        End If
    ...
    If IntegracaoCaixa.LocalizarNome(g_empresa, xComplemento) Then
        ...
        End If
    Else
        MsgBox "N„o ser· possÌvel integrar com o caixa!", vbInformation + vbCritical, "Erro de Integridade"
    End If
End Function
...
Private Sub LoopIncluiNotaAbastecimento()
    ...
    If IncluiMovimentoCaixa("NotaAbastecimento") Then
        ...
        With rst
            If .RecordCount > 0 Then
                ...
                Do Until .EOF
                    ...
                    Else
                        MsgBox "N„o foi possÌvel localizar Venda de ConveniÍncia!", vbInformation, "Erro de Integridade!"
                    End If
                    .MoveNext
                Loop
            End If
        ...
        End With
    Else
        MsgBox "N„o foi possÌvel integrar no caixa!", vbInformation, "Erro de Integridade!"
    End If
    Set rst = Nothing
End Sub
Private Sub MontaCupomVideo(ByVal pNumeroCupom As Long, ByVal pData As Date)
    ...
    Do Until MovimentoVendaConveniencia.LocalizarNumeroProximaOrdem(g_empresa, pNumeroCupom, pData, lIlha, lOrigemVenda, xOrdem) = False
        ...
        If i = 1 Then
            ...
            txt_cupom_fiscal.Text = txt_cupom_fiscal.Text + x_string + Chr(13) + Chr(10)
            x_string = "N˙mero do Pedido: " + Format(MovimentoVendaConveniencia.NumeroCupom, "###,000")
            txt_cupom_fiscal.Text = txt_cupom_fiscal.Text + x_string + Chr(13) + Chr(10)
            txt_cupom_fiscal.Text = txt_cupom_fiscal.Text + "------------------------------------------------" + Chr(13) + Chr(10)
            txt_cupom_fiscal.Text = txt_cupom_fiscal.Text + "ITEM   CÛDIGO             DESCRI«√O             " + Chr(13) + Chr(10)
            txt_cupom_fiscal.Text = txt_cupom_fiscal.Text + "      QTDxUNIT√ÅRIO       ST          VALOR( R$) " + Chr(13) + Chr(10)
            txt_cupom_fiscal.Text = txt_cupom_fiscal.Text + "------------------------------------------------" + Chr(13) + Chr(10)
        End If
        x_string = Space(48)
        ...
        Else
            MsgBox "N„o foi possÌvel localizar a alÌquota!", vbInformation, "Erro de Integridade!"
        End If
        ...
        Else
            If Val(MovimentoVendaConveniencia.FormaPagamento) > 0 Then
                ...
                ElseIf MovimentoVendaConveniencia.FormaPagamento = 6 Then
                    Mid(x_string, 1, 21) = "Cart„o TecBan        "
                ...
                '    x_string = Space(48)
                '    Mid(x_string, 1, 14) = "Cheque N˙mero:"
    ...
    If ValidaCampos Then
        If VerificaLiberacaoDigitacao2 Then
            ...
            If lCodigoBarra Then
                xGrava = True
            Else
                If (MsgBox("Deseja imprimir este Ìtem?", vbYesNo + vbDefaultButton1 + vbQuestion, "Imprime Pedido de Compra")) = 6 Then
                    xGrava = True
                End If
            End If
            If xGrava Then
                ...
                If MovimentoVendaConveniencia.Incluir Then
                    ...
                    Call MontaCupomVideo(l_numero_cupom, l_data)
                Else
                    MsgBox "N„o foi possÌvel gravar o pedido de compra.", vbInformation, "Erro de Integridade!"
                End If
            Else
                txt_produto.SetFocus
            End If
...
Private Function GravaDocumentoEletronicoEvento(ByVal pDocumentoEltronicoCabecalho As cMovDocEletronicoCabecalho, ByVal pDescricaoEvento As EVENTO_NFCE) As Boolean
    ...
    Else
        Call CriaLogECF(Date & " " & Time & " GravaDocumentoEletronicoEvento: N„o foi possÌvel incluir o evento da NFCe: " & CStr(pDescricaoEvento) & " xPassoProcesso=" & xPassoProcesso)
        MsgBox "N„o foi possÌvel incluir o evento da NFCe: " & CStr(pDescricaoEvento) & ".", vbInformation, "Erro de Integridade."
    End If
...
FileError:
    ...
    MsgBox "N„o foi possÌvel incluir o evento da NFCe: " & CStr(pDescricaoEvento) & ". ERRO= " & Err.Description, vbCritical, "Erro de Integridade."
...
On Error GoTo trata_erro
    ...
    If Not IntegracaoCaixa.LocalizarNome(g_empresa, "VENDA DE LUBRIFICANTES") Then
        MsgBox "N„o ser· possÌvel integrar com o caixa!", vbCritical, "Erro de Integridade!"
        Call GravaAuditoria(1, Me.name, 25, "N„o ser· integrado no caixa o extorno de produto.")
    Else
        If ExcluiMovimentoCaixa("VENDA DE LUBRIFICANTES") Then
            If MovimentoLubrificante.LocalizarCodigo(g_empresa, MovimentoVendaConveniencia.Data, MovimentoVendaConveniencia.Periodo, lIlha, 1, 2, MovimentoVendaConveniencia.CodigoProduto, MovimentoVendaConveniencia.operador) Then
                ...
                If MovimentoLubrificante.Quantidade = 0 Then
                    ...
                    Else
                        Call GravaAuditoria(1, Me.name, 25, "N„o excluiu venda de produto:" & MovimentoVendaConveniencia.CodigoProduto)
                        Call CriaLogCupom(Time & "SubtraiVendaProduto: N„o excluiu venda de produto:" & MovimentoVendaConveniencia.CodigoProduto & " Data:" & MovimentoVendaConveniencia.Data & " Per:" & MovimentoVendaConveniencia.Periodo & " Ilha:" & MovimentoVendaConveniencia.Ilha & " Tipo Mov:" & MovimentoVendaConveniencia.TipoMovimento & " Operador:" & MovimentoVendaConveniencia.operador)
                        MsgBox "N„o foi possÌvel excluir venda de produtos.", vbCritical, "Erro de Integridade!"
                    End If
                Else
                    If MovimentoLubrificante.Alterar(g_empresa, MovimentoVendaConveniencia.Data, MovimentoVendaConveniencia.Periodo, lIlha, 1, 2, MovimentoVendaConveniencia.CodigoProduto, MovimentoVendaConveniencia.operador) Then
                        SubtraiVendaProdutoCaixa = True
                    Else
                        Call GravaAuditoria(1, Me.name, 25, "N„o alterou venda de produto:" & MovimentoVendaConveniencia.CodigoProduto)
                        Call CriaLogCupom(Time & "SubtraiVendaProduto: N„o alterou venda de produto:" & MovimentoVendaConveniencia.CodigoProduto & " Data:" & MovimentoVendaConveniencia.Data & " Per:" & MovimentoVendaConveniencia.Periodo & " Ilha:" & MovimentoVendaConveniencia.Ilha & " Tipo Mov:" & MovimentoVendaConveniencia.TipoMovimento & " Operador:" & MovimentoVendaConveniencia.operador)
                        MsgBox "N„o foi possÌvel alterar venda de produtos.", vbCritical, "Erro de Integridade!"
                    End If
                End If
            Else
                Call GravaAuditoria(1, Me.name, 25, "N„o localizou venda de produto:" & MovimentoVendaConveniencia.CodigoProduto)
                Call CriaLogCupom(Time & "SubtraiVendaProduto: N„o localizou venda de produto:" & MovimentoVendaConveniencia.CodigoProduto & " Data:" & MovimentoVendaConveniencia.Data & " Per:" & MovimentoVendaConveniencia.Periodo & " Ilha:" & MovimentoVendaConveniencia.Ilha & " Tipo Mov:" & MovimentoVendaConveniencia.TipoMovimento & " Operador:" & MovimentoVendaConveniencia.operador)
                MsgBox "N„o foi possÌvel localizar venda de produtos.", vbCritical, "Erro de Integridade!"
            End If
        Else
            Call GravaAuditoria(1, Me.name, 25, "N„o foi possÌvel estornar venda de produto no caixa.")
            MsgBox "N„o foi possÌvel estornar no caixa!", vbCritical, "Erro de Integridade!"
        End If
    End If
    Exit Function
...
Function TestaEmpresa() As Boolean
    ...
    If xConveniencia = False Then
        MsgBox "Este programa n„o pode ser executado neste computador!", vbInformation, "Erro de ConfiguraÁ„o!"
        Exit Function
    End If
...
Function ValidaEstoque() As Boolean
    ...
    If lBloqueiaSubEstoque = False Then
        ...
        Else
            If Estoque.Quantidade < fValidaValor(txt_quantidade.Text) Then
                MsgBox "N„o È permitido tirar cupom fiscal acima da quantidade em estoque." & Chr(10) & "A quantidade atual no estoque È: " & Format(Estoque.Quantidade, "##,###,##0.00") & ".", vbInformation, "Estoque Insuficiente!"
            Else
                ValidaEstoque = True
            End If
        End If
    Else
        If Not SubEstoque.LocalizarCodigo(g_empresa, CLng(txt_produto.Text), 2) Then
            MsgBox "SubEstoque n„o cadastrado.", vbInformation, "Erro de VerificaÁ„o!"
            txt_produto.SetFocus
            Exit Function
        Else
            If SubEstoque.Quantidade < fValidaValor(txt_quantidade.Text) Then
                MsgBox "N„o È permitido tirar cupom fiscal acima da quantidade em estoque." & Chr(10) & "A quantidade atual no SubEstoque È: " & Format(SubEstoque.Quantidade, "##,###,##0.00") & ".", vbInformation, "Estoque Insuficiente!"
            Else
                ValidaEstoque = True
            End If
        End If
...
Function ValidaCartaoPOS() As Boolean
    ...
    If cbo_forma_pagamento.ItemData(cbo_forma_pagamento.ListIndex) = FORMA_PAGAMENTO_POS Then
        ...
        If RetiraGString(1) = "Retorno-Movimento_Nfce_Conveniencia" Then
            ...
            lNFCe_cAut = RetiraGString(5)               'Numero da AutorizaÁ„o
            lNFCe_tPag = "03"                           '03-Cart„o CÈdito
            If UCase(xNomeBandeira) Like "*D√âBITO*" Or UCase(xNomeBandeira) Like "*DEBITO*" Then
                lNFCe_tPag = "04"                       '04-Cart„o DÈbito
            End If
        ...
        Else
            MsgBox "Favor lanÁar o comprovante de venda do Cart„o Primeiro!", vbInformation, "Dados Incompleto!"
        End If
        g_string = ""
    Else
        ValidaCartaoPOS = True
...
Function ValidaCamposPonto() As Boolean
    ...
    If Val(dtcboFuncionario.BoundText) = 0 Then
        MsgBox "Selecione o funcion·rio.", vbInformation, "AtenÁ„o!"
...
Function ValidaCamposFechamento() As Boolean
    ...
    ElseIf cbo_forma_pagamento.ListIndex = 4 And dtcboCliente.BoundText = "" Then
        MsgBox "Escolha um cliente.", vbInformation, "Dados n„o aceito!"
        dtcboCliente.SetFocus
    ElseIf fValidaValor(txt_valor_desconto.Text) < 0 Then
        MsgBox "O desconto concedido n„o pode ser negativo.", vbInformation, "Dados n„o aceito!"
...
Private Sub dtcboCliente_LostFocus()
    If dtcboCliente.BoundText <> "" Then
        ...
        If Cliente.LocalizarCodigo(CLng(dtcboCliente.BoundText)) Then
            ...
            If Cliente.CGC <> "" Then
                txt_cpf.Text = Cliente.CGC
            Else
                txt_cpf.Text = Cliente.CPF
            End If

            txt_nome_cliente = Cliente.RazaoSocial
            If cbo_forma_pagamento.ItemData(cbo_forma_pagamento.ListIndex) = FORMA_PAGAMENTO_POS Then
                btnEmiteNFCe.SetFocus
            Else
                cmd_ok2.SetFocus
    ...
    If dtcboProduto.BoundText <> "" Then
        ...
        If Produto.LocalizarCodigo(CLng(txt_produto.Text)) Then
            If Estoque.LocalizarCodigo(g_empresa, CLng(txt_produto.Text)) Then
                ...
                End If
            Else
                MsgBox "N„o foi possÌvel localizar Estoque.", vbInformation, "Erro de Integridade!"
                txt_valor_unitario.Text = ""
                txt_valor_unitario.SetFocus
                Exit Sub
            End If
...
Function VerificaRestricaoCancelamento() As Boolean
    ...
    If ConfiguracaoDiversa.LocalizarCodigo(1, "RESTRINGE:CANCELAMENTO DE NFCe") Then
        If ConfiguracaoDiversa.Codigo <= g_nivel_acesso Then
            MsgBox "Este usu·rio n„o est· autorizado a realizar esta operaÁ„o", vbInformation, "OperaÁ„o N„o Autorizada!"
...
Private Sub mnFuncaoADM_Click()
    ...
    If l_flag_cupom_fiscal = "A" Then
        MsgBox "Esta funÁ„o n„o poder· ser executada com cupom aberto." & vbCrLf & "Feche o cupom que encontra-se aberto.", vbInformation + vbOKOnly, "Cupom Fiscal Aberto!"
        Exit Sub
    End If
    ...
    xString = "Selecione a Bandeira do Cart„o Desejado|@|"
    xString = xString & "10|@|"
...
'            End If
    ...
    End Select
    'If MsgBox("OperaÁ„o administrativas TecBan?" & Chr(10) & Chr(10) & "Sim para TecBan" & Chr(10) & "N„o para Outras Bandeiras", vbYesNo + vbDefaultButton2 + vbQuestion, "OperaÁ„o Administrativas") = vbYes Then
    ...
    If Val(txtCliente.Text) > 0 Then
        ...
        If Cliente.LocalizarCodigo(CLng(txtCliente.Text)) Then
            If Cliente.Inativo = True Then
                MsgBox "O cliente " & Trim(Cliente.RazaoSocial) & " est· inativo.", vbInformation, "Cliente Inativo!"
                txtCliente.SetFocus
                Exit Sub
            Else
            ...
            End If
        Else
            MsgBox "Cliente n„o cadastro.", vbInformation, "AtenÁ„o!"
...
Private Sub txt_funcionario_ponto_GotFocus()
    l_mensagem = Space(165) & "Informe o cÛdigo do funcion·rio."
    ...
    If Val(txt_funcionario_ponto.Text) > 0 Then
        If Funcionario.LocalizarCodigo(g_empresa, Val(txt_funcionario_ponto.Text)) Then
            If Funcionario.Situacao = "I" Then
                MsgBox "O funcion·rio " & Trim(Funcionario.Nome) & " est· inativo.", vbInformation, "AtenÁ„o!"
                txt_funcionario_ponto.SetFocus
                Exit Sub
            Else
                ...
                Else
                    MsgBox "Funcion·rio sem cÛdigo do usu·rio no cadastro.", vbInformation, "Erro "
            ...
            End If
        Else
            MsgBox "Funcion·rio n„o cadastrado.", vbInformation, "AtenÁ„o!"
            txt_funcionario_ponto.SetFocus
            Exit Sub
        End If
    End If
...
Private Sub txt_produto_GotFocus()
    l_mensagem = Space(165) & "Informe o cÛdigo do produto.  |  Tecle enter para informar o nome do produto.  |  Tecle F8 para cancelar Ìtem ‡† escolher.  |  Tecle F10 para informar a forma de pagamento.  |  Tecle F12 para cancelar o ˙ltimo pedido de compra.   |    Tecle F3 para Pesquisar Produto."
...
Private Sub txt_produto_KeyDown(KeyCode As Integer, Shift As Integer)
    ...
    'F8 Cancela Ìtem ‡† escolher do pedido de compra
    If KeyCode = 119 Then
        If g_nome_empresa = "J M A PRODUTOS ALIMENT√çCIOS EIRELI EPP" Or g_nome_empresa = "G MARQUES DE AZEVEDO EIRELI ME" Then
            MsgBox "FunÁ„o cancelamento n„o Disponivel!", vbInformation, "OperaÁ„o n„o aceita."
            Exit Sub
        End If

        KeyCode = 0
        If Val(txt_ordem.Text) > 1 Then
            If (MsgBox("Deseja cancelar o ˙ltimo item?", vbYesNo + vbDefaultButton2 + vbQuestion, "Cancela Item")) = 6 Then
            ...
            End If
        Else
            MsgBox "N„o existe Ìtem a ser cancelado!", vbInformation, "OperaÁ„o n„o aceita."
        End If
    End If
    ...
    If KeyCode = 123 Then
        ...
        KeyCode = 0
        If (MsgBox("Deseja cancelar o ˙ltimo pedido de compra?", vbYesNo + vbDefaultButton2 + vbQuestion, "Cancela Pedido de Compra")) = vbYes Then
...
Private Sub txt_produto_LostFocus()
    ...
    If Len(txt_produto.Text) > 10 Then
        If Mid(txt_produto.Text, 1, 1) = "2" Then
            ...
            Else
                MsgBox "Codigo de Barra n„o cadastrado!", vbInformation, "Erro de Leitura"
                txt_produto.Text = ""
                txt_produto.SetFocus
                Exit Sub
            End If
    ...
    If Val(txt_produto.Text) > 0 Then
        If Produto.LocalizarCodigo(CLng(txt_produto.Text)) Then
            ...
            If Produto.Inativo = True Then
                MsgBox "O produto " & Trim(Produto.Nome) & " est· inativo.", vbInformation, "Produto Inativo!"
                txt_produto.SetFocus
                Exit Sub
            Else
                dtcboProduto.BoundText = CLng(txt_produto.Text)
                If Estoque.LocalizarCodigo(g_empresa, CLng(txt_produto.Text)) Then
                    ...
                    End If
                Else
                    MsgBox "N„o foi possÌvel localizar o Estoque.", vbInformation, "Erro de VerificaÁ„o!"
                    txt_valor_unitario.Text = ""
                    txt_valor_unitario.SetFocus
                    Exit Sub
                End If
            ...
            End If
        Else
            MsgBox "Produto n„o cadastrado.", vbInformation, "AtenÁ„o!"
            txt_produto.SetFocus
            Exit Sub
        End If
    Else
...
Private Sub txt_senha_ponto_GotFocus()
    l_mensagem = Space(165) & "Informe a senha do funcion·rio."
...
Private Sub BuscaNumeroCupom()
    ...
    Exit Sub
FileError:
    MsgBox "n„o foi possÌvel criar o novo pedido de compra.", vbCritical, "Erro Grave!"
    Exit Sub
End Sub
...
Private Function BuscaNumeroNfce() As String
    ...
    Exit Function
FileError:
    MsgBox "n„o foi possÌvel criar o nova NFC-e.", vbCritical, "Erro Grave!"
    Exit Function
End Function
...
Private Sub BuscaNumeroDeSerie()
    ...
    If lExisteImpressora Then
        ...
        If g_nome_empresa = "T-Kar Posto Shopping Ltda" And xString = "4708990404338" Then
            Exit Sub
        End If
        MsgBox "N˙mero de SÈrie da Impressora Fiscal ->" & xString & "<-" & Chr(13) & "Empresa ->" & Trim(g_empresa) & "<-", vbInformation, "N˙mero de SÈrie"
        MsgBox "O sistema ser· finalizado", vbCritical, "Erro Interno Fatal"
        End
    End If
    Exit Sub
FileError:
    MsgBox "n„o foi possÌvel verificar o n˙mero de sÈrie.", vbCritical, "Erro Grave!"
    Exit Sub
End Sub
...
'                            If Not IncluiMovimentoCaixa(lDataCupom, lPeriodo, True, "DescontoCartaoCorreios", lValorDescontoConcedido, "", "Cart„o Desconto Correios") Then
'                                Call CriaLogCupom("Erro cmd_DescontoCorreio_Click:Desconto Cartao Correios n„o integrada no caixa.")
'                                MsgBox "n„o foi possÌvel integrar Desconto Cart„o Correios no caixa!", vbInformation, "Erro de Integridade!"
'                            End If
'                        End If
'                    Else
...
'            End If
        ...
        'N√O NECESS√ÅRIO POIS OS DADOS SER√O PREENCHIDOS PELAS INFORMA«’ES DA VENDA QUE FORAM GRAVADAS
...
'        MovDocEletronicoCabecalho.EtapaConcluida = Val(ETAPA_CONCLUIDA.PRE_PROCESSADO)
        ...
        'N√O NECESS√ÅRIO SER√Å PREENCHIDO NO MOMENTO QUE GRAVAR O CABACALHO
        'AtualizaBaseCalculoICMSCabecalho
        
        'se a forma de pagamento for dinheiro chama a funÁ„o para incluir o registro no caixa de pista
        If lGeraCaixaDinheiro = True And MovDocEletronicoCabecalho.FormaPagamento = 1 Then
            If Not IntegracaoCaixa.LocalizarNome(g_empresa, "DINHEIRO") Then
                Call CriaLogCupom("Erro [IniciaProcessoNFCe]:IntegraÁ„o de caixa inexistente. DINHEIRO")
                MsgBox "N„o ser· possÌvel integrar com o caixa!", vbInformation, "Erro de Integridade"
            Else
                If IncluiMovimentoCaixa("DINHEIRO") Then

                Else
                    Call CriaLogCupom("Erro [IniciaProcessoNFCe]:n„o integrada no caixa. DINHEIRO")
                    MsgBox "N„o foi possÌvel integrar no caixa!", vbInformation, "Erro de Integridade!"
                End If
            End If
        End If
        
        'se a forma de pagamento for cheque a vista chama a funÁ„o para incluir o registro no caixa de pista
        If lGeraCaixaChequeAVista = True And MovDocEletronicoCabecalho.FormaPagamento = 2 Then
            If Not IntegracaoCaixa.LocalizarNome(g_empresa, "CHEQUE A VISTA") Then
                Call CriaLogCupom("Erro [IniciaProcessoNFCe]:IntegraÁ„o de caixa inexistente. CHEQUE A VISTA")
                MsgBox "N„o ser· possÌvel integrar com o caixa!", vbInformation, "Erro de Integridade"
            Else
                If IncluiMovimentoCaixa("CHEQUE A VISTA") Then

                Else
                    Call CriaLogCupom("Erro [IniciaProcessoNFCe]:N„o integrada no caixa. CHEQUE A VISTA")
                    MsgBox "N„o foi possÌvel integrar no caixa!", vbInformation, "Erro de Integridade!"
                End If
            End If
        End If
...
'            Call CriaLogCupom("N„o foi possÌvel alterar a forma de pagamento do documento eletrÙnico!")
'            Call CriaLogCupom("Caso o possua mais de 1 item o valor total do cabecalho ficar· incorreto")
'            MsgBox "N„o foi possÌvel alterar a forma de pagamento do documento eletrÙnico!", vbInformation, "Erro de Integridade"
'        End If
...
'            Call CriaLogCupom("N„o foi possÌvel alterar a EtapaConcluÌda do Item do documento eletrÙnico!")
'            MsgBox "N„o foi possÌvel alterar a EtapaConcluÌda do Item do documento eletrÙnico!", vbInformation, "Erro de Integridade"
'        End If
...
'            Call CriaLogCupom("N„o foi possÌvel alterar o IdClienteFornecedor de documento eletrÙnico Cabecalho!")
'            MsgBox "N„o foi possÌvel alterar o IdClienteFornecedor de documento eletrÙnico Cabecalho!", vbInformation, "Erro de Integridade"
'        End If
...
'            Call CriaLogCupom("N„o foi possÌvel alterar o IdClienteFornecedor de documento eletrÙnico Ìçtem!")
'            MsgBox "N„o foi possÌvel alterar o IdClienteFornecedor de documento eletrÙnico Ìçtem!", vbInformation, "Erro de Integridade"
'        End If
        ...
        If fValidaValor(MovDocEletronicoCabecalho.ValorDesconto) > 0 Then
            If Not MovDocEletronicoItem.AlterarDesconto(g_empresa, lDataNFCe, False, True, MODELO_NFCE, lSerieNFCe, lNumeroNFCe, lTotaNFCe, MovDocEletronicoCabecalho.ValorDesconto) Then
                MsgBox "N„o foi possÌvel alterar o desconto de Ìtens do documento eletrÙnico!", vbInformation, "Erro de Integridade"
            End If
        End If
...
'            Call CriaLogCupom("N„o foi possÌvel alterar os totais das tributaÁ√µes do documento eletrÙnico Cabecalho!")
'            Call CriaLogCupom("Dados: " & "Empresa: " & g_empresa & " Data: " & lDataNFCe & " modelo:  " & MODELO_NFCE & "SÈrie: " & lSerieNFCe & " Numero: " & lNumeroNFCe)
'            'MsgBox "N„o foi possÌvel alterar os totais das tributaÁ√µes do documento eletrÙnico Cabecalho!", vbInformation, "Erro de Integridade"
'        End If
...
'                    MsgBox "N„o foi possÌvel alterar cupom para cancelado!", vbInformation, "Erro de Integridade"
'                End If
'            End If
...
'                        MsgBox "N„o foi possÌvel alterar o desconto no item de cupom!", vbInformation, "Erro de Integridade"
'                    End If
'                Else
'                    MsgBox "N„o foi possÌvel alterar o desconto do cupom!", vbInformation, "Erro de Integridade"
'                End If
'            End If
'
'            'se a forma de pagamento for dinheiro chama a funÁ„o para incluir o registro no caixa de pista
...
'                If Not IntegracaoCaixa.LocalizarNome(g_empresa, "DINHEIRO") Then
'                    Call CriaLogCupom("Erro cmdIniciaProcessoNFCe:IntegraÁ„o de caixa inexistente. DINHEIRO")
'                    MsgBox "N„o ser· possÌvel integrar com o caixa!", vbInformation, "Erro de Integridade"
'                Else
...
'
'                    Else
'                        Call CriaLogCupom("Erro cmdIniciaProcessoNFCe:N„o integrada no caixa. DINHEIRO")
'                        MsgBox "N„o foi possÌvel integrar no caixa!", vbInformation, "Erro de Integridade!"
'                    End If
'                End If
'            End If
...
'                If Not IntegracaoCaixa.LocalizarNome(g_empresa, "CHEQUE A VISTA") Then
'                    Call CriaLogCupom("Erro cmdIniciaProcessoNFCe:IntegraÁ„o de caixa inexistente. CHEQUE A VISTA")
'                    MsgBox "N„o ser· possÌvel integrar com o caixa!", vbInformation, "Erro de Integridade"
'                Else
...
'
'                    Else
'                        Call CriaLogCupom("Erro cmdIniciaProcessoNFCe:N„o integrada no caixa. CHEQUE A VISTA")
'                        MsgBox "N„o foi possÌvel integrar no caixa!", vbInformation, "Erro de Integridade!"
'                    End If
'                End If
'            End If
...
'                End If
'            End If
'            'Corrige o problemas dos valores da tributaÁ„o no cabeÁalho estarem indo zeradas
...
'                Call CriaLogCupom("N„o foi possÌvel alterar os totais das tributaÁ√µes do documento eletrÙnico Cabecalho!")
'                Call CriaLogCupom("Dados: " & "Empresa: " & g_empresa & " Data: " & lData & " modelo:  " & MODELO_NFCE & "SÈrie: " & lSerieNFCe & " Numero: " & lNumeroCupom)
'                'MsgBox "N„o foi possÌvel alterar os totais das tributaÁ√µes do documento eletrÙnico Cabecalho!", vbInformation, "Erro de Integridade"
'            End If
'
'        Else
'            Call CriaLogCupom("N„o foi possÌvel alterar a forma de pagamento")
'            Call CriaLogCupom("Caso o possua mais de 1 item o valor total do cabecalho ficar· incorreto")
'            MsgBox "N„o foi possÌvel alterar a forma de pagamento!", vbInformation, "Erro de Integridade"
'        End If
'        If cbo_forma_pagamento.ItemData(cbo_forma_pagamento.ListIndex) = 5 Then
...
'        lDescontoEspecial = 0
'
'        'PONTO DE INSER«√O #NFCE-001 - ALEX - NFCE
...
'        '    MsgBox "Aguarde o final da impress„o!" & Chr(10) & Chr(10) & "Coloque o cheque na impressora fiscal, tecle enter e aguarde.", vbExclamation, "AutenticaÁ„o de Cheque"
'        '    If lExisteImpressora Then
...
Private Sub DefineCartaoTefParaNFCe()
    ...
    If (lCartaoAutorizacao = Empty) Then
        lNFCe_cAut = lNSU ' Como a vari·vel da autorizaÁ„o (POSI«√O 013) est· em branco utilizo o NSU (POSI«√O 012)
    Else
        lNFCe_cAut = lCartaoAutorizacao 'Numero da AutorizaÁ„o
    End If
    
    
    lNFCe_tPag = "03"                                  '03-Cart„o CrÈdito
    If UCase(xNomeBandeira) Like "*D√âBITO*" Or UCase(xNomeBandeira) Like "*DEBITO*" Then
        lNFCe_tPag = "04"                       '04-Cart„o DÈbito
    End If
    lNFCe_TpIntegra = 2                         '1-TEF, 2-POS
    ...
    Else
        ...
        If IncluiMovimentoCaixa("CartaoCredito") Then
            ...
            If Not TaxaAdmCartaoCredito.LocalizarCodigo(g_empresa, CartaoCredito.Codigo) Then
                ...
                MsgBox "Taxa de Adm de Cart„o de crÈdito n„o cadastrada.", vbInformation, "Erro de Integridade!"
            End If
...
'            End If
            ...
            If Not MovCartaoCredito.Incluir Then
                MsgBox "N„o foi possÌvel incluir Cart„o de CrÈdito", vbInformation, "Erro de Integridade!"
            End If
        Else
            MsgBox "N„o foi possÌvel integrar no caixa!", vbInformation, "Erro de Integridade!"
        End If
        ...
        Do Until xArquivo.AtEndOfStream
            ...
            If Val(Mid(xString, 1, 3)) > 10 Or xDiferenciarCieloRedecard = False Then
                ...
                If Mid(xString, 1, 7) = "018-000" Then
                    ...
                    xOperacao = "CREDITO"
                End If
                'Detecta a Administradora de Cart„o
                If xNomeAdm = "" Then
...
'                        Exit Do
                ...
                'IMPLEMENTA«√O EXCLUSIVA PARA "MARTINS E BISPO" E "*POSTO SOLEX*"
                ...
                'Detecta se È DÈbito ou CrÈdito
                If xOperacao = "" Then
                    If xString Like "*CREDITO*" Or xString Like "*CR√âDITO*" Then
                        xOperacao = "CREDITO"
                        If xNomeBandeira <> "" Then
                            Exit Do
                        End If
                    End If
                    If xString Like "*DEBITO*" Or xString Like "*D√âBITO*" Or xString Like "*ELECTRON*" Then
                        xOperacao = "DEBITO"
                        If xNomeBandeira <> "" Then
                            Exit Do
                        End If
        ...
        'xOperacao = ""
        'Se for xNomeBandeiraLido = "MASTERCARD"  entao ser· "CREDITO"
        'Se for xNomeBandeiraLido = "MAESTRO"     entao ser· "DEDITO"
        If xNomeBandeira = "REDECARD" And xOperacao = "" Then
       ...
       'Teste cartao: ao chegar neste ponto mudar o valor da variavel g_nome_empresa para "*POSTO T13*"
        ...
        If lCodigoCartao > 0 Then
            ...
            'cÛpia para Testar Autorizacao e NSU
            'Call xArqTxt.CopyFile(xNomeArquivo, xNomeArquivoCopia, True)
            'Deleta Arquivo "c:\vb5\sgp\data\teste.txt"
            Call xArqTxt.DeleteFile(xNomeArquivo, True)
        Else
            Call GravaAuditoria(1, Me.name, 26, "Cart„o N„o Integrado: " & xNomeBandeira & " OperaÁ„o: " & xOperacao & " Valor: " & fValidaValor(Me.lbl_valor_compra.Caption) & " Linha: " & xNumLinha)
...
'            Call EnviaMensagemEmail(g_empresa, g_nome_empresa, "Cartao Nao Integrado!", xMensagem, True, gNumeroEmailInicial)
            'tira cÛpia do arquivo "c:\vb5\sgp\data\teste.txt"
...
FileError:
    Call GravaAuditoria(1, Me.name, 26, "Cart„o N„o Integrado: " & Error & " Valor: " & fValidaValor(Me.lbl_valor_compra.Caption))
End Function
...
Private Sub BuscaNsuCartaoCredito(ByVal pNomeAdm As String, ByVal pNomeBandeira As String, ByVal pNomeArquivo As String)
    ...
    If xArqTxt.FileExists(pNomeArquivo) Then
        ...
        ' PARA VER SE … CARTAO DOS "CORREIOS GOIAS"
...
Private Sub AguardaProcessamentoNFCe(ByVal pNSU As Long, ByVal pNumeroCupomVenda As Long, ByVal pDataVenda As Date, ByVal pIlhaVenda As Integer, ByVal pOrigemVenda As String)
    ...
    Do Until DateDiff("s", xHoraInicial, Time) >= xSegundosAAguardar
        ...
        If MovSolicitacaoFuncaoNFe.LocalizarNSU(g_empresa, pNSU) Then
            If MovSolicitacaoFuncaoNFe.HoraAnalise_MovSolicitacaoFuncaoNFe = CDate("00:00:00") Then
                'caso a solicitaÁ„o n„o esteja em analise ainda, verifica se petromovel est· ativo
    ...
    If xProcessamentoConcluido = True Then
        If MovSolicitacaoFuncaoNFe.HoraAprovacao_MovSolicitacaoFuncaoNFe <> CDate("00:00:00") Then
            ...
            MsgBox "NFCe AUTORIZADA!" & vbCrLf & "Mensagem: " & xMensagemNFCe, vbInformation, "Processamento ConcluÌdo!"
        ...
        ElseIf MovSolicitacaoFuncaoNFe.HoraCancelamentoHost_MovSolicitacaoFuncaoNFe <> CDate("00:00:00") Then
            MsgBox "NFCe N√O foi Autorizada!" & vbCrLf & "Mensagem: " & MovSolicitacaoFuncaoNFe.Mensagem_MovSolicitacaoFuncaoNFe, vbCritical, "ERRO ao Processar NFCe!"
        Else
            MsgBox "N„o ser· possÌvel definir o processamento da NFCe.", vbCritical, "Erro de Integridade!"
        End If
    Else
        MsgBox "Tempo de solicitaÁ„o de Processamento de NFCe excedido.", vbCritical, "Tempo Excedido!"
    End If
End Sub
Private Function VerificarAtivarPetromovelAuto(ByVal pComunicarComBanco As Boolean) As Boolean
    ...
    If ComunicaPetromovelAutoBD = False Then
        Call CriaLogCupom("[VerificarAtivarPetromovelAuto] PetromovelAuto est· Inativo.")
        'If (MsgBox("N„o foi possÌvel comunicar com o progama PetromovelAuto." & vbCrLf & vbCrLf & "Se este programa n„o for aberto, " & vbCrLf & "as funcionalidades da NFCe n„o ser„o executadas." & vbCrLf & vbCrLf & "Deseja abrir programa de emiss„o de NFCe?", vbQuestion + vbYesNo + vbDefaultButton1, "Deseja Abrir Programa PetromovelAuto?") = vbYes) Then
            Call CriaLogCupom("[VerificarAtivarPetromovelAuto] O SGP ir· ativar o PetromovelAuto automaticamente")
            
            'VerificarAtivarPetromovelAuto = LoopAbrePetromovelAuto
            If LoopAbrePetromovelAuto(pComunicarComBanco) Then
                VerificarAtivarPetromovelAuto = True
            Else
                MsgBox "N„o foi possÌvel ativar PetromovelAuto!" & vbCrLf & "Contacte o suporte tÈcnico.", vbCritical, "PetromovelAuto est· inativo"
                VerificarAtivarPetromovelAuto = False
            End If
        'Else
          'Call CriaLogCupom("[VerificarAtivarPetromovelAuto] Operador optou por N√O ativar o PetromovelAuto automaticamente")
        'End If
    Else
        VerificarAtivarPetromovelAuto = True
    End If
...
Private Function LoopAbrePetromovelAuto(ByVal pExecutarComunicacaoBanco As Boolean) As Boolean
    ...
    Do Until xSaiLoop = True
        ...
        Else
            MsgBox "PetromovelAuto n„o encontrado", vbCritical, "PetromovelAuto n„o configurado"
            xSaiLoop = True
        End If
        ...
        If pExecutarComunicacaoBanco Then
            ...
            Else
                'If (MsgBox("Deseja tentar abrir programa o PetromovelAuto novamente?", vbQuestion + vbYesNo + vbDefaultButton1, "Erro ao Abrir Programa PetromovelAuto!") = vbNo) Then
                    'Call GravaAuditoria(1, Me.name, 26, "Usu·rio desistiu de abrir PetromovelAuto")
                    Call GravaAuditoria(1, Me.name, 26, "N„o foi possÌvel ativar PetromovelAuto")
                    xSaiLoop = True
                'End If
            End If
        Else
...
Private Sub AtualizaDadosNFCeDaVenda(ByVal pNumeroCupomVenda As Long, ByVal pDataVenda As Date, ByVal pIlhaVenda As Integer, ByVal pOrigemVenda As String)
    ...
    If MovimentoVendaConveniencia.LocalizarCodigo(g_empresa, pNumeroCupomVenda, pDataVenda, pIlhaVenda, pOrigemVenda, 1) Then
        ...
        If Not MovimentoVendaConveniencia.AlterarDadosNFCe(MovimentoVendaConveniencia.Empresa, MovimentoVendaConveniencia.NumeroCupom, MovimentoVendaConveniencia.Data, MovimentoVendaConveniencia.Ilha, MovimentoVendaConveniencia.OrigemVenda) Then
            MsgBox "N„o foi possÌvel vincular a NFCe ‡ Venda.", vbCritical, "Erro de Integridade!"
        End If
        
    Else
        MsgBox "N„o foi possÌvel localizar a Venda.", vbCritical, "Erro de Integridade!"
    End If
End Sub
...
Private Function ExisteCaixaIndividualAberto(ByVal pData As Date) As Boolean
    ...
    If Not AberturaCaixa.LocalizarUltAbertoDataFunc(g_empresa, pData, "NF", 1, TIPO_MOVIMENTO_CAIXA_CONVENIENCIA, l_codigo_funcionario) Then
        'Informa perÌodo do caixa a ser aberto
        xString = InputBox("Informe n˙mero do perÌodo que deseja abrir.", "PerÌodo ‡ Abrir!", "")
        If Val(xString) = 0 Or Val(xString) > 4 Then
           MsgBox "O perÌodo informado n„o È v·lido.", vbOKOnly + vbInformation, "PerÌodo Inv·lido!"
           txt_senha_ponto.Text = ""
           txt_senha_ponto.SetFocus
           cmd_senha_Click
           Exit Function
        ...
        'verifica se existe caixa no perÌodo informado
        ...
        If AberturaCaixa.LocalizarCodigo(g_empresa, pData, "NF", xPeriodo, 1, l_codigo_funcionario, TIPO_MOVIMENTO_CAIXA_CONVENIENCIA) Then
            MsgBox "J· existe um caixa no perÌodo informado.", vbOKOnly + vbInformation, "PerÌodo Inv·lido!"
            Exit Function
        End If
        If (MsgBox("O Caixa n„o encontra-se aberto!" & Chr(10) & "Deseja abrir agora?", vbQuestion + vbYesNo + vbDefaultButton1, "Abertura de Caixa!")) = vbYes Then
    ...
    Else
        If AberturaCaixa.DataFechamento = "00:00:00" Then
            ExisteCaixaIndividualAberto = True
        Else
            MsgBox "Este funcion·rio est· com o caixa de hoje fechado." & vbCrLf & "Data do Fechamento=" & Format(AberturaCaixa.DataFechamento, "dd/MM/yyyy") & vbCrLf & "Hora do Fechamento=" & Format(AberturaCaixa.HoraFechamento, "HH:mm:ss"), vbOKOnly + vbInformation, "OperaÁ„o Negada!"
...
'           Mensagem = lProcessadorNFCE.ProcessaSolicitacaoFuncaoNFCe(SolicitacaoFuncaoNFe.NSU, SolicitacaoFuncaoNFe.CodigoEstabelecimento, GERADOR_NFCE_OOBJ)
            ...
            gStringChamada = gStringChamada & xRealizarImpressao & "|@|" 'se È pra realizar impress„o
            ...
            gStringChamada = gStringChamada & MovDocEletronicoCabecalho.DataEmissao & "|@|" 'Data Emiss„o
                ...
                If ConfiguracaoDiversa.Verdadeiro = True Then
                    ...
                    'If VerificarAtivarPetromovelAuto Then
                        If Not GravaSolicitacaoProcessamentoNFCe(MovSolicitacaoFuncaoNFe.NumeroNFe_MovSolicitacaoFuncaoNFe, gStringChamada) Then
                            MsgBox "N„o foi possÌvel gravar a SolicitaÁ„o do processamento para NFC-e!", vbCritical, "Erro de Integridade"
                        Else
...
trata_erro:
    ...
    MsgBox "N„o foi possÌvel gerar NFC-e. " & vbCrLf & ErroNFCE, vbCritical, "Erro Grave!"
    Exit Sub
...
Private Function GravaSolicitacaoProcessamentoNFCe(ByVal pNumeroNFCe As String, ByVal pStringChamadaProcessamento As String) As Boolean
    ...
    xMovSolicitacaoFuncaoNFe.NSU_MovSolicitacaoFuncaoNFe = 0 'No momento da inserÁ„o È feita a busca para obter o proximo registro
    ...
    xMovSolicitacaoFuncaoNFe.SerieNFe_MovSolicitacaoFuncaoNFe = lSerieNFCe 'Verficar se pode ser utilizado este n˙mero
    ...
    Exit Function
TrataError:
    Call CriaLogSGP("[GravaSolicitacaoProcessamentoNFCe]", "Erro ao tentar gravar solicitaÁ„o do processamento da NFCe - " & Err.Description, "pStringChamadaProcessamento=" & pStringChamadaProcessamento)
    MsgBox "N„o foi possÌvel incluir registro de SolicitaÁ„o do processamento para NFC-e!", vbCritical, "Erro de Integridade"
End Function
...
Private Function AtualizaTabelaSolicitacaoNFCe(ByVal pTipoOperacao As String, ByVal pChaveAcessoNFe As String, ByVal pTexto As String, ByVal pNumeroDaNota As Long, ByVal pNumeroLote As String) As Boolean
    ...
    MovSolicitacaoFuncaoNFe.NSU_MovSolicitacaoFuncaoNFe = 0 'No momento da inserÁ„o È feita a busca para obter o proximo registro
    ...
    MovSolicitacaoFuncaoNFe.SerieNFe_MovSolicitacaoFuncaoNFe = lSerieNFCe 'Verficar se pode ser utilizado este n˙mero
...
Private Function LoopIncluiRegistroSolicitacaoNFe() As Boolean
    ...
    LoopIncluiRegistroSolicitacaoNFe = False
        ...
        If LoopIncluiRegistroSolicitacaoNFe = False Then
            MsgBox "N„o foi possÌvel incluir registro de SolicitaÁ„o de FunÁ„o NFC-e!", vbCritical, "Erro de Integridade"
        End If
End Function
    ...
    CriaLogCupom ("[MontaTextoItensSolicitacaoNFCE] - QUANTIDADE DE ITENS: " & pRsDadosParaNFCe.RecordCount)
           Do Until pRsDadosParaNFCe.EOF
                ...
                xOrdem = xOrdem + 1
                    ...
                    'Tratamento para produtos vendidos por balanÁa que utilizam o campo cÛdigo de barra da etiqueta da balanÁa. EX.: P„o
                    ...
                    xStringNfce = xStringNfce & "843-" & Format(xOrdem, "000") & " = " & "1" & "|@|" & vbCrLf 'tpNF (1-SaÌda)
                    'cst icms
                    ...
                    'Codigo CEST
                    xStringNfce = xStringNfce & "857-" & Format(xOrdem, "000") & " = " & pRsDadosParaNFCe("CEST").Value & "|@|" & vbCrLf '- OBRIGATORIO CASO O TIPO DE TRIBUTA«√O SEJA SUBSTITUI«√O
                    
                    xStringNfce = xStringNfce & "858-" & Format(xOrdem, "000") & " = 0" & "|@|" & vbCrLf ' & RetornaEncerranteInicial(xEncerranteFinal, pRsDadosParaNFCe("Quantidade_MovDEItem").Value) & "|@|" & vbCrLf    '- OBRIGATORIO CASO O TIPO DE TRIBUTA«√O SEJA SUBSTITUI«√O
                    
                    'ENCERRANTE FINAL 'EST√Å SENDO GRAVADO NO CAMPO DE TELEFONE DA TABELA MOVIMENTO_CUPOOM_FISCAL
                    xStringNfce = xStringNfce & "859-" & Format(xOrdem, "000") & " = 0" & "|@|" & vbCrLf ' & xEncerranteFinal & "|@|" & vbCrLf
                    
                    'Bomba EST√Å SENDO GRAVADO NO CAMPO DE NUMERO DO CHEQUE (POSI«’ES 1 e 2) DA TABELA MOVIMENTO_CUPOOM_FISCAL - ALTERADO AP”S CRIA«√O DA TABELA DE DOCUMENTO ELETR√îNICO
                    ...
                    'Bico EST√Å SENDO GRAVADO NO CAMPO DE NUMERO DO CHEQUE (POSI«’ES 3 e 4) DA TABELA MOVIMENTO_CUPOOM_FISCAL
                    ...
                    'tanque EST√Å SENDO GRAVADO NO CAMPO DE NUMERO DO CHEQUE (POSI«’ES 5 e 6) DA TABELA MOVIMENTO_CUPOOM_FISCAL
...
Private Function MontaTextoCabecalhoSolicitacaoNFCE(ByVal pRsDadosParaNFCe As ADODB.Recordset, ByVal pTipoServico As String) As String
    ...
    'N√O NECESS√ÅRIO PARA NFCE MANTIDO APENAS PARA CONSERVAR PADR√O
    xStringNfce = xStringNfce & "001-000 = " & Format(0, "0000000000") & "|@|" & vbCrLf  'OBTER DADOS REAIS - M√âTODO PARA GERA CONTROLE DE SOLICITA«√O
    ...
    xStringNfce = xStringNfce & "045-000 = " & "1" & "|@|" & vbCrLf 'Local de Destino da operaÁ„o: 1-Interna, 2-Interestadual, 3-Exterior
    xStringNfce = xStringNfce & "046-000 = " & "1" & "|@|" & vbCrLf 'FINALIDADE DA NFE

    
    'NUMERA«√O EST√Å FORA DA SEQUENCIA POIS INICIALMENTE FOI UTILIZADA A ESTRUTURA EXISTENTE DA SOLICITA«√O DE NFE
    'ALGUMAS NUMERA«’ES FORAM REMOVIDAS POR N√O TEREM UTILIDADE NA NFCE
    'QUALQUER ALTERA«√O NESTAS NUMERA«’ES IMPACTAM O FUNCIONAMENTO DA EMISS√O NFCE PELA DLL
...
'---- DADOS DO PAGAMENTO -----
    'Aqui somente Cart„o DÈbito e Cart„o CrÈdito
    If lNFCe_tPag <> "" Then
        xStringNfce = xStringNfce & "113-001 = " & lNFCe_tPag & "|@|" & vbCrLf 'Forma de Pagamento
        
        xStringNfce = xStringNfce & "114-001 = " & lNFCe_TpIntegra & "|@|" & vbCrLf 'Tipo de integraÁ„o do Pagamento 1=Pagamento integrado com o sistema 2=equipamento POS
        
        xStringNfce = xStringNfce & "115-001 = " & lNFCe_CNPJCartao & "|@|" & vbCrLf 'CNPJ OPERADORA DO CART√O
    
        xStringNfce = xStringNfce & "116-001 = " & FormatNumber(lNFCe_vPag, 2) & "|@|" & vbCrLf
    
        xStringNfce = xStringNfce & "117-001 = " & lNFCe_tBand & "|@|" & vbCrLf 'BANDEIRA DO CART√O
        
        xStringNfce = xStringNfce & "118-001 = " & lNFCe_cAut & "|@|" & vbCrLf 'NUMERO AUTORIZA«√O DO CART√O (OBRIGATÛRIO SE INFORMAR O CNPJ DA OPERADORA)
    ...
    Else
        ...
        '2-Cheque ‡ Vista, 3-Cheque PrÈ-Datado
        ...
        ElseIf pRsDadosParaNFCe("FormaPagamento_MovDECabecalho").Value = 5 Or pRsDadosParaNFCe("FormaPagamento_MovDECabecalho").Value = 17 Then
            xFormaPagamento = "05" '05-CrÈdito Loja
        Else
        ...
        xStringNfce = xStringNfce & "114-001 = " & "|@|" & vbCrLf 'Tipo de integraÁ„o do Pagamento 1=Pagamento integrado com o sistema 2=equipamento POS
        
        xStringNfce = xStringNfce & "115-001 = " & "|@|" & vbCrLf 'CNPJ OPERADORA DO CART√O
    
        xStringNfce = xStringNfce & "116-001 = " & FormatNumber(pRsDadosParaNFCe("ValorTotal_MovDECabecalho").Value, 2) & "|@|" & vbCrLf
    
        xStringNfce = xStringNfce & "117-001 = " & "|@|" & vbCrLf 'BANDEIRA DO CART√O
        
        xStringNfce = xStringNfce & "118-001 = " & "|@|" & vbCrLf 'NUMERO AUTORIZA«√O DO CART√O (OBRIGATÛRIO SE INFORMAR O CNPJ DA OPERADORA)
    ...
    'LOGICA FOI IMPLEMENTADA NO M√âTODO MontaTextoInformacoesComplementaresNFCe
'    If lDescontoPostoAki = True And lValorDescontoConcedido > 0 Then
'        xStringNfce = xStringNfce & "135-000 = " & MontaTextoInformacoesComplementaresNFCe & "Desconto pelo Aplicativo PostoAki" & "\n" & "|@|" & vbCrLf 'InfCpl - InformaÁ√µes complementares
'    Else
'        xStringNfce = xStringNfce & "135-000 = " & MontaTextoInformacoesComplementaresNFCe & "|@|" & vbCrLf 'InfCpl - InformaÁ√µes complementares
'    End If
...
'---- 'OBTER DADOS REAIS DO 210 AO 223 dados do cliente ---
    ...
    xStringNfce = xStringNfce & "216-000 = 1058" & "|@|" & vbCrLf 'Codigo PaÌs
    ...
    xStringNfce = xStringNfce & "220-000 = " & xInscricaoEstadualCliente & "|@|" & vbCrLf  'inscriÁ„o estadual
    ...
    '1-Contribuinte , 2-ISENTO, 9-N„o Contribuinte
...
Private Function ObtenhaDadosParaNFCEDocumentoEletronico(ByVal pNumeroNFCe As Long, ByVal pDataEmissao As Date) As ADODB.Recordset
    ...
    'O campo Telefone est· sendo preenchido com Encerrante Final para utilizaÁ„o na NFCE
    'O campo Numero do Cheque est· sendo preenchido com valores concatenados da bomba, Bico e Tanque
...
Private Function LocalizarNCM(ByVal pTabela As Integer, ByVal pCodigo As String) As Boolean
    ...
    If Trim(pCodigo) = "" Then
        MsgBox "O produto " & Trim(Produto.Nome) & vbCrLf & "Est· cadastrado sem NCM.", vbInformation, "Produto Sem NCM!"
        Exit Function
    End If
    If Not PercentualImposto.LocalizarCodigo(pTabela, pCodigo) Then
        MsgBox "O produto " & Trim(Produto.Nome) & vbCrLf & "De NCM:" & Trim(pCodigo) & vbCrLf & "Est· sem NCM cadastrado.", vbInformation, "NCM Inexistente!"
        Exit Function
    End If
    LocalizarNCM = True
End Function
...
'            MsgBox "O perÌodo n„o foi selecionado automaticamente!" & vbCrLf & "Clique no bot„o SENHA e tente novamente.", vbInformation + vbOKOnly, "Erro Desconhecido!"
'            Exit Function
'        End If
    ...
    If Not rsVendaConveniencia.EOF Then
        ...
        Do Until rsVendaConveniencia.EOF
            ...
            If Not GravaDocumentoEletronicoItem(rsVendaConveniencia, xOrdem) Then
                MsgBox "N„o foi possÌvel incluir item do documento eletrÙnico. Item: " & xOrdem, vbOKOnly, "Erro de integridade"
                Exit Function
            End If
    ...
    Else
         MsgBox "N„o foi possÌvel incluir cabeÁalho do documento eletrÙnico", vbOKOnly, "Erro de integridade"
         ImportaVendaConveniencia = False
    End If
...
FileError:
    Call CriaLogCupom("ERRO: Ao tentar importar venda de conveniÍncia para NFCe" & Err.Description)
    Exit Function
...
Private Function GravaDocumentoEletronicoItem(ByVal pRsVendaConveniencia As ADODB.Recordset, pOrdem As Integer) As Boolean  'ALEX - DOCELETRONICO
    ...
    MovDocEletronicoItem.ValorBcIpi = 0 'fValidaValor2(txt_valor_total.Text) ''VERIFICAR SE REALEMTE … ESSE
    MovDocEletronicoItem.AliquotaIpi = 0  ''OBTER ALIQUOTA
    MovDocEletronicoItem.ValorIPI = 0 'VERIFICAR DE ONDE OBTER
    MovDocEletronicoItem.ApuracaoIpiMensal = False 'VERIFICAR SE REALEMTE … ESSE
...
'        CriaLogCupom "NFCE Venda Automatica = true (BICO EM ABERTO =" & lAutomacaoBicoEmAcerto & " )" & " Empresa: " & g_empresa & " Data AutomaÁ„o= " & lAutomacaoDataEmAcerto & " Hora AutomaÁ„o: " & lAutomacaoHoraEmAcerto & " Bico AutomaÁ„o: " & lAutomacaoBicoEmAcerto
'
...
'        Else
'           CriaLogCupom "-- BOMBA N√O LOCALIZADA --"
'        End If
'
'    End If
    ...
    'ME PARECE DESNECESS√ÅRIO AGORA - ALEX
...
FileError:
    ...
    Call CriaLogCupom("ERRO: Ao gravar Item do documento eletrÙnico - " & xString)
    Exit Function
End Function
...
Private Function PreencheDadosDocumentoEletronicoCabecalho(ByVal rsVendaConveniencia As ADODB.Recordset) As Boolean
    ...
    'Calcula totais do cabeÁalho atravÈs do itens j· adicionados
